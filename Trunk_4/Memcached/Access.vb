...
<Obsolete("2013-02-28: Dejar de usar esta clase porque va a desaparecer", False)>
Public Class Access
    ...
    Public Shared Function GetUsuario(ByVal idSAB As Integer, ByVal cnSAB As String) As String()
        Dim u = OracleDirectAccess.Seleccionar("SELECT * FROM USUARIOS WHERE ID=:ID", cnSAB,
    ...
    Public Shared Function GetNombrePais(ByVal CodigoPais As Integer, ByVal strcn As String) As String
        Dim u = OracleDirectAccess.SeleccionarEscalar(Of String)("SELECT nompai FROM xbat.copais WHERE codpai=:codpai", strcn,
    ...
    Public Shared Function GetOrganigrama(ByVal cnEpsilon As String, ByVal IdDep As String) As String()
        ...
        Dim parameter As New SqlClient.SqlParameter("@ID_DEP", SqlDbType.VarChar, 5, ParameterDirection.Input) With {
            .Value = IdDep
        }
    ...
    Public Shared Function GetNivelesProfesion(ByVal cnEpsilon As String, ByVal nombreProfesion As String) As List(Of String())
        ...
        Dim p As New SqlClient.SqlParameter("@d_nivel", SqlDbType.Char, 60, ParameterDirection.Input) With {
            .Value = nombreProfesion
        }
        Return SQLServerDirectAccess.Seleccionar(q, cnEpsilon, p)
    End Function
    ''' <summary>
    ''' Devuelve una lista con los niveles de Batz (1. maila,2. maila,...)
    ''' </summary>
    ''' <param name="cnEpsilon"></param>
    ''' <returns></returns>
    ''' <remarks></remarks>
