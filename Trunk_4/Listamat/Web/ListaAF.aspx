<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ListaAF.aspx.vb" Inherits="Web.ListaAF" MasterPageFile="~/Site1.Master" 
...
<asp:Content ContentPlaceHolderID="cphContenido" runat="server">
    <div class="alingMiddle">
        ...
        <div id="d1" runat="server" class="div1">
            <a href="<%= "ListaAFMarcas.aspx?tipolista="+ request("tipolista")+"&ord="+ ddlof.selectedvalue + "&op=" + ddlop.selectedvalue %>" >
            ...
            <a href="<%= "ListaAFImprimir.aspx?tipolista="+ request("tipolista")+"&ord="+ ddlof.selectedvalue + "&op=" + ddlop.selectedvalue %>">
                <img src="App_Themes/Theme1/Images/imprimirLM.png" alt="Vista imprimible" title="Vista imprimible, incluye marcas lanzadas" />
            </a>
            <asp:ImageButton ID="LocalizedImageButton1" runat="server" text="Ordenar marcas"
        ...
        <HeaderTemplate>
            <table class="table1">
                <thead>
                    <tr>
                        <th>
                            <asp:LinkButton runat="server" Text="Lanz." OnClick="SeleccionarLanzamientos"></asp:LinkButton>
                        </th>
                        <th>
                            <%=h.traducir("Marca")%>
                        </th>
