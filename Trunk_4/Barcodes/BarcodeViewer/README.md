# BARCODE VIEWER
## 1. Objetivo:
Escaneo de códigos QR de los albaranes en compras

## 2. Descripción
Escanea el código QR de albarán y lo compara con la información de base de datos, guardando las lecturas en BD.
...
> I invite, you pay. Fin the la quote
>> Second quote