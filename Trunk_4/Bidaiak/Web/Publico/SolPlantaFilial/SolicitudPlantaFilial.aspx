<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="SolicitudPlantaFilial.aspx.vb" Inherits="WebRaiz.SolicitudPlantaFilial" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cp" runat="server">
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
             <div class="panel-group" id="divAccordion">
                <div class="panel panel-primary">                    
                    ...
                    <div class="panel-collapse collapse in" id="divCollapse">                           
                            ...
                            <asp:RadioButton runat="server" ID="rbtPorFechas" GroupName="Opciones" Text="Seleccione el mes y año de las solicitudes de planta filial que quiere ver" />    
                            ...
                            <asp:RadioButton runat="server" ID="rbtSinAprobar" RepeatDirection="Horizontal" GroupName="Opciones" Text="Ver solicitudes sin aprobar" CellPadding="30" CellSpacing="30"></asp:RadioButton>
           ...
           <asp:GridView runat="server" ID="gvSolicitudes" AutoGenerateColumns="false" AllowPaging="false" CssClass="table table-striped table-hover" GridLines="None" PageSize="20">
	            <PagerStyle CssClass="bs-pagination" HorizontalAlign="Center" />
                <PagerSettings PageButtonCount="5" />
	            <EmptyDataTemplate><asp:Label runat="server" Text="No existe ninguna solicitud en la fecha seleccionada"></asp:Label></EmptyDataTemplate>
	            <Columns>                               
                   <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="gridview-header-center">
                    ...
                    <asp:TemplateField>
			            ...
			            <ItemTemplate><asp:Label runat="server" ID="lblPlanta"></asp:Label></ItemTemplate>
		            </asp:TemplateField> 
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="gridview-header-center">
