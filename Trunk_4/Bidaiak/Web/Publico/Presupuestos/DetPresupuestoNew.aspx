<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="DetPresupuestoNew.aspx.vb" Inherits="WebRaiz.DetPresupuestoNew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cp" runat="server">
    ...
    <div class="panel panel-primary" runat="server" id="divAvion">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-sm-2"><asp:Label runat="server" ID="labelATarifaObj" Text="Objetivo"></asp:Label></div>
                <div class="col-sm-4"><b><asp:Label runat="server" ID="lblATarifaObj" style="font-size:18px;"></asp:Label>&nbsp;€</b></div>
                <div class="col-sm-2"><asp:Label runat="server" ID="labelATarifaReal" Text="Real"></asp:Label></div>
                <div class="col-sm-4"><b><asp:Label runat="server" ID="lblATarifaReal" style="font-size:18px"></asp:Label>&nbsp;€</b></div>
            </div>                                                   
        </div>
    </div>
    <div class="panel panel-primary" runat="server" id="divHotel">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-sm-2"><asp:Label runat="server" ID="labelHDias" Text="Num dias"></asp:Label></div>
                <div class="col-sm-2"><b><asp:Label runat="server" ID="lblHDias" style="font-size:18px"></asp:Label></b></div>                 
            </div>
            <div class="row">
                <div class="col-sm-2"><asp:Label runat="server" ID="labelHTarifaObj" Text="Objetivo"></asp:Label></div>
                <div class="col-sm-4"><b><asp:Label runat="server" ID="lblHTarifaObj" style="font-size:18px;"></asp:Label>&nbsp;€</b></div>
                <div class="col-sm-2"><asp:Label runat="server" ID="labelHTarifaReal" Text="Real"></asp:Label></div>
                <div class="col-sm-4"><b><asp:Label runat="server" ID="lblHTarifaReal" style="font-size:18px"></asp:Label>&nbsp;€</b></div>
            </div>                                                   
        </div>
    </div> 
    <div class="panel panel-primary" runat="server" id="divCocheAlq">
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-sm-2"><b><asp:Label runat="server" ID="lblCNumDias" style="font-size:18px"></asp:Label></b></div>                 
            </div>
            <div class="row">
                <div class="col-sm-2"><asp:Label runat="server" ID="labelCTarifaObj" Text="Objetivo"></asp:Label></div>
                <div class="col-sm-4"><b><asp:Label runat="server" ID="lblCTarifaObj" style="font-size:18px;"></asp:Label>&nbsp;€</b></div>
                <div class="col-sm-2"><asp:Label runat="server" ID="labelCTarifaReal" Text="Real"></asp:Label></div>
                <div class="col-sm-4"><b><asp:Label runat="server" ID="lblCTarifaReal" style="font-size:18px"></asp:Label>&nbsp;€</b></div>
            </div> 
        </div>
    </div>
