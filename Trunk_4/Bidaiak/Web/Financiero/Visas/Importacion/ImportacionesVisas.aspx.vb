Public Class ImportacionesVisas
    Inherits PageBase
...
#Region "Carga de datos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            Master.SetTitle = "Importaciones de Visas"
    ...
    Private Sub ComprobarEjecuciones()
        Try
            ...
            Dim oEjecucion As BLL.BidaiakBLL.Ejecucion = bidaiakBLL.loadEjecucion(BLL.BidaiakBLL.TipoEjecucion.Visas, Master.IdPlantaGestion)
            If (oEjecucion Is Nothing) Then  'No hay ninguna ejecucion incompleta
                pnlNoPendiente.Visible = True
                resumen.iniciar()
            Else
                If (oEjecucion.IdUser = Master.Ticket.IdUser) Then  'El usuario tiene iniciada una ejecucion
                    pnlPendienteUsuario.Visible = True
                    lblPendiente.Text = itzultzaileWeb.Itzuli("Tiene iniciada una ejecucion de importacion de visas") & " -> Año: " & oEjecucion.Anno & " y mes:" & TraducirMes(oEjecucion.Mes)
                    btnContinuar.CommandArgument = oEjecucion.Anno & "_" & oEjecucion.Mes
...
#Region "Eventos"
    ...
    Private Sub resumen_SubirFichero(año As Integer, mes As Integer) Handles resumen.SubirFichero
        Response.Redirect("ImpVisas.aspx?anno=" & año & "&mes=" & mes)
    End Sub
