<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="PreAsientoContVisas.ascx.vb" Inherits="WebRaiz.PreAsientoContVisas" %>
...
<fieldset style="width:900px">
    <br /><asp:Label runat="server" Text="Se va a visualizar el asiento contable generado para las visas" CssClass="labelDetalle"></asp:Label><br /><br />          
    <asp:Table runat="server" ID="tAsientos" CellPadding="0" CellSpacing="0" CssClass="GridView2" Width="900" />    
    <asp:Table runat="server" ID="tAsientosCuotas" CellPadding="0" CellSpacing="0" CssClass="GridView2" Width="900" />    
    <asp:Table runat="server" ID="tAsientoExcepcion" CellPadding="0" CellSpacing="0" CssClass="GridView2" Width="900" />
