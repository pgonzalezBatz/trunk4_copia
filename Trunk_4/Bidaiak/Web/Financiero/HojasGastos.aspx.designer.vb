...
Partial Public Class HojasGastos
    ...
    '''<summary>
    '''Control txtIdViajeHojaF.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents txtIdViajeHojaF As Global.System.Web.UI.WebControls.TextBox
    
    '''<summary>
    '''Control ftbIdViajeHoja.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents ftbIdViajeHoja As Global.AjaxControlToolkit.FilteredTextBoxExtender
    ...
    '''<summary>
    '''Control gvHojasGastos.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents gvHojasGastos As Global.System.Web.UI.WebControls.GridView
