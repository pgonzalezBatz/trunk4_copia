<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="ValHojasGastos.aspx.vb" Inherits="WebRaiz.ValHojasGastos" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cp" runat="server">    
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
                ...
                <div class="panel panel-primary">                    
                    ...
                    <div class="panel-collapse collapse in" id="divCollapse">                           
                         <div class="panel-body lines">                        
                            <asp:RadioButton runat="server" ID="rbtPorFechas" GroupName="Opciones" Text="Seleccione el mes y año del que quiere ver las hojas de gastos a validar" />    
                            ...
                            <asp:RadioButton runat="server" ID="rbtSinValidar" RepeatDirection="Horizontal" GroupName="Opciones" Text="Ver hojas sin validar" CellPadding="30" CellSpacing="30"></asp:RadioButton>
            ...
            <asp:GridView runat="server" ID="gvHojas" AutoGenerateColumns="false" AllowPaging="true" CssClass="table table-striped table-hover" GridLines="None" PageSize="20">
	            <PagerStyle CssClass="bs-pagination" HorizontalAlign="Center" />
                <PagerSettings PageButtonCount="5" />
	            <EmptyDataTemplate><asp:Label runat="server" Text="No existe ninguna hoja de gastos a validar entre las fechas seleccionadas"></asp:Label></EmptyDataTemplate>
	            <Columns>            
                    <asp:TemplateField>
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="gridview-header-center">
                        <HeaderTemplate><asp:Label runat="server" text="FechaEnvio"></asp:Label></HeaderTemplate>
			            <ItemTemplate><asp:Label runat="server" ID="lblFechaEnvio"></asp:Label></ItemTemplate>
		            </asp:TemplateField>            
		            <asp:TemplateField>
                        <HeaderTemplate><asp:Label runat="server" text="Nº hoja"></asp:Label></HeaderTemplate>
			            <ItemTemplate><asp:Label runat="server" ID="lblCodigo"></asp:Label></ItemTemplate>
		            </asp:TemplateField> 
		           <asp:TemplateField  ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="gridview-header-center">
