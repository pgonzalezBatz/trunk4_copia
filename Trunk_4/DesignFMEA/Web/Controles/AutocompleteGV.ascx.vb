...
#Region "Propiedades"
    ...
    ''' <summary>
    ''' Nombre de la factory del resultado del grid que se almacenara en el textbox al seleccionar un registro
    ''' </summary>
    ''' <value></value>
    ''' <returns></returns>    
    Public Property FactoryName As String
        Get
            Return ViewState("idF")
        End Get
        Set(ByVal value As String)
            ViewState("idF") = value
        End Set
    ...
    ''' <summary>
    ''' Devuelve el id de la planta del item seleccionado
    ''' </summary>
    ''' <value></value>
    ''' <returns></returns>
    Public ReadOnly Property SelectedFactory As String
        Get
            If (hfIdFactory.Value = String.Empty) Then
                Return String.Empty
            Else
                Return hfIdFactory.Value
            End If
        End Get
    End Property
    ...
    Public Sub Limpiar()
        ...
        hfIdFactory.Value = String.Empty
    End Sub

    ''' <summary>
    ''' Evento que se lanza cuando se hace click en un elemento
    ''' </summary>    
    Public Event ItemSeleccionado(ByVal id As Integer, ByVal idFactory As Integer)
...
#Region "Registro del script"
    ...
    Protected Sub Page_PreRender(ByVal sender As Object, ByVal e As EventArgs) Handles Me.PreRender
        ...
        Dim script As String = "init('" & txtInput.ClientID & "', '" & hfValue.ClientID & "', '" & helper.ClientID & "','" & RutaPaginaBusqueda & "','" & PostBack.ToString & "','" & postBackControlId & "','" & divImgGV.ClientID & "','" & GridviewClass & "','" & IdName & "','" & ValueName & "','" & MinSearchLength & "','" & MaxDivHeight & "','" & Opcion & "','','','" & hfIdFactory.ClientID & "','" & FactoryName & "');"
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>    
    Private Sub imgBuscar_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs) Handles imgBuscar.Click
    ...
    Private Sub btnFire_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnFire.Click
        RaiseEvent ItemSeleccionado(SelectedId, SelectedFactory)
    End Sub
