<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="PanelCargandoDatos.ascx.vb" Inherits="Nominas.PanelCargandoDatos" %>
	...
	<asp:UpdateProgress ID="UpdateProg1" DisplayAfter="0" runat="server">
		<ProgressTemplate>
			<div style="position: relative; top: 30%; text-align: center;">
				<asp:Image runat="server" ImageUrl="~/App_Themes/Tema1/Images/Loadin.gif" AlternateText="cargandoDatos" ToolTip="cargandoDatos" meta:resourcekey="Image1Resource1" />
				<br />
