@modeltype VMMovimientoRecogida
@Code
...
<h3>
    @h.traducir("Listado de Movimientos y Recogidas pendientes")
<span class="label label-default">
    <span class="glyphicon glyphicon-info-sign"></span>
    Movimientos Agrupados</span>
</h3>
<hr />
<div class="row">
    <div class="col-xs-3">
    ...
    <div class="col-xs-3">
        <a class="btn btn-info" href="@Url.Action("ListMovimientosRecogidasSinAsignar", h.ToRouteValues(Request.QueryString, Nothing))">
            <span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>
            @h.traducir("Ver Marcas Individuales")
        </a>
    </div>
</div>
<br />
...
<form action="@Url.Action("AgruparMovimiento")" method="post">
    ...
    Else
        ...
        @<table class="table">
            ...
            @Html.DisplayFor(Function(m) m.LstMovimientoProveedorFecha, New With {.grouped = True})
        </table>
    End If
    <input type="submit" class="btn btn-primary" value="@h.traducir("Agrupar")" />
</form>
<form action="@Url.Action("CrearViajeRecogida")" method="post">

    @If Model.LstRecogida Is Nothing Then
        @h.traducir("No se han encontrado recogidas pendientes")
    Else
        @<table class="table">
            <thead>
                <tr>
    ...
    <input type="submit" class="btn btn-primary" value="@h.traducir("Crear Viaje Con Recogidas")" />
</form>
