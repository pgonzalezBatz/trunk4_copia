...
<h3>@h.traducir("Listado de Movimientos y Recogidas pendientes")
...
<div class="row">
    ...
    <div class="col-xs-3">
        <a class="btn btn-info" href="@Url.Action("ListMovimientosRecogidasSinAsignarAgrupado", h.ToRouteValues(Request.QueryString, Nothing))">
...
<form action="@Url.Action("CrearViajeRecogida")" method="post">
    ...
    Else
        @<table class="table">
            ...
            @Html.DisplayFor(Function(m) m.LstRecogida, New With {.InsideTable = True})
        </table>End If
