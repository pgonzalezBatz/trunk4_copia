<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MPLogin.Master" CodeBehind="CrearRoles.aspx.vb" Inherits="Web.CrearRoles" %>
                  ...
                  <div class="form-inline row">
                           ...
                           <asp:TextBox ID="txtResponsable" runat="server"  Width="40%" class="form-control required" required="required" />
                            ...
                            <act:AutoCompleteExtender ID="AutoCompleteExtender2" ServiceMethod="CargarResponsable"
                                ...
                                TargetControlID="txtResponsable" UseContextKey="true" ServicePath="~/WS/CE_ws.asmx" CompletionSetCount="0"
                            ...
                            <asp:HiddenField ID="hfResponsable" runat="server" />
                               ...
                               <asp:DropDownList class="btn btn-default dropdown-toggle" type="button" runat="server" ID="ddlUni" data-toggle="dropdown" required="required">
<%--                                    <asp:ListItem Text="" Value="0" />
                                    <asp:ListItem Text="BATZ SOLAIRE MAROC" Value="1" />
                                    <asp:ListItem Text="BATZ ARALUCE" Value="2" />
                                    <asp:ListItem Text="BATZ IGORRE" Value="3" />
                                    <asp:ListItem Text="MBTOOLING" Value="4" />
                                    <asp:ListItem Text="MBT RIOJA" Value="5" />
                                      <asp:ListItem Text="BATZ KUNSHAN" Value="6" />
                                   <asp:ListItem Text="BATZ MEXICANA" Value="7" />
                                   <asp:ListItem Text="BATZ CHEQUIA" Value="8" />
                                   <asp:ListItem Text="MUS" Value="9" />
                                   <asp:ListItem Text="BATZ ALEMANIA" Value="10" />
                                   <asp:ListItem Text="BATZ ZAMUDIO" Value="11" />
                                   <asp:ListItem Text="BATZ PALMA DEL RIO" Value="12" />
                                   <asp:ListItem Text="BATZ BRASIL" Value="13" />
                                   <asp:ListItem Text="BATZ CHENGDU" Value="14" />
                                   <asp:ListItem Text="BATZ USA" Value="15" />
                                   <asp:ListItem Text="MBLUSITANA" Value="16" />
                                   <asp:ListItem Text="MB SISTEMAS" Value="17" />
                                   <asp:ListItem Text="MATRICI" Value="18" />
                                   <asp:ListItem Text="BATZ GUANGZHOU" Value="19" />
                                   <asp:ListItem Text="BATZ SOLAR RSA" Value="20" />
                                   <asp:ListItem Text="BATZ ENERGY" Value="21" />
                                   <asp:ListItem Text="BATZ SERVICIOS SOLARES" Value="22" />--%>
