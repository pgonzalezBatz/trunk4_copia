...
<head>
    ...
    <title>CreateSubFamily</title>
</head>
<body>
    @Using (Html.BeginForm("CreateSubfamily", "Default"))
        ...
        @<div class="form-horizontal">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                 ...
                 <div class="col-md-10">
                     @Html.DropDownListFor(Function(model) model.ParentId, New SelectList(DAL.GetFamilyAll(), "Id", "Name", "SELECT ONE:"), "SELECT ONE:", htmlAttributes:=New With {.class = "form-control", .onchange = "FamiliaChange(this)"})
             ...
             <div class="form-group">
                 ...
                 <div class="col-md-10">
                     @*@Html.DropDownListFor(Function(model) model.GrandparentId, New SelectList(DAL.GetComodityAll(), "Id", "Name", New Comodity With {.Name = "SELECT ONE:"}), "SELECT ONE:", htmlAttributes:=New With {.class = "form-control myDisabledClass", .onchange = "ComodityChange(this)", .disabled = "disabled"})*@
                     @*@Html.DropDownListFor(Function(model) model.GrandparentId, New SelectList(DAL.GetComodityAll(), "Id", "Name", New Comodity With {.Name = "SELECT ONE:"}), "SELECT ONE:", htmlAttributes:=New With {.class = "form-control myDisabledClass", .onmousedown = "(function(e) {e.preventDefault();})(event, this)"})*@
                     @Html.DropDownListFor(Function(model) model.GrandparentId, New SelectList(DAL.GetComodityAll(), "Id", "Name", New Comodity With {.Name = "SELECT ONE:"}), "SELECT ONE:", htmlAttributes:=New With {.class = "form-control myDisabledClass", .onchange = "ComodityChange(this)"})
