        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="@Url.Action("Index", "busqueda")" Class="nav-link">@h.traducir("Busqueda")</a>
                    </li>
                    <li>
                        <a href="@Url.Action("Index", "proveedor")" Class="nav-link">@h.traducir("Acceso a Proveedor")</a>
                    </li>
                    @if IsSectionDefined("chunkmenuproveedor") Then
                        @RenderSection("chunkmenuproveedor")
                    End If
                    
                </ul>
                <ul class="nav navbar-nav navbar-right">
                    @If ViewData("nombreproveedor") IsNot Nothing Then
                        @<li>
    <p Class="navbar-text">
        @ViewData("nombreproveedor")
    </p>
</li>
                    End If
                    <li>
