<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/MPCR.Master" CodeBehind="CCGastosMOD.aspx.vb" Inherits="CostesReales.CCGastosMOD" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <asp:Panel ID="pnlTitulo" runat="server">
            <asp:Label ID="Label8" runat="server" Text="Cuentas de Gastos MOD" class="lbl lbl-primary"></asp:Label>
        </asp:Panel>
    </div>
    <br />
    <div class="container">
        <asp:Panel ID="pnlCCGastoMOD" runat="server">     
            <asp:GridView ID="grdGastosMOD" runat="server" AutoGenerateColumns="False" AllowPaging="True">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Gasto_MOD">
                        <EditItemTemplate>
                            <asp:DropDownList ID="ddlGastoMOD" runat="server"></asp:DropDownList>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="Label2" runat="server" Text='<%# Bind("Gasto_MOD") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>                    
        ...
        <asp:Panel ID="pnlNuevo" runat="server">
            <div class="form-group">
                ...
                <label for="textGastoMOD">Gasto MOD</label>
                <asp:DropDownList ID="ddlGastoMOD" runat="server" class="form-control" Width="300px"></asp:DropDownList>       
