Public Class RepartosMOI
    ...
    Protected Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        RepartoMOIDAL.Nuevo(departamento, id + 1)
    ...
    Protected Sub grdDepartamentos_RowUpdating(sender As Object, e As GridViewUpdateEventArgs) Handles grdDepartamentos.RowUpdating
        ...
        Dim departamentoId As Integer = Memcached.SQLServerDirectAccess.SeleccionarEscalar(Of Integer)(id, Master.Cx)
        RepartoMOIDAL.Actualizar(departamentoId, departamento)
