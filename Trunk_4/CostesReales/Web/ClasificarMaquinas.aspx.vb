Public Class ClasificarMaquinas
    ...
    Private Sub cargarGrid()
        ...
        datos = ClasificarMaquinaBLL.Obtener()
    ...
    Protected Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        Dim proceso_id As Integer = Memcached.SQLServerDirectAccess.SeleccionarEscalar(Of Integer)(procesoSeleccionadoId, ConfigurationManager.ConnectionStrings("BI_CR_Igorre").ConnectionString)
        Dim planta_id As Integer = Memcached.SQLServerDirectAccess.SeleccionarEscalar(Of Integer)(plantaSeleccionadaId, ConfigurationManager.ConnectionStrings("BI_CR_Igorre").ConnectionString)
        ClasificarMaquinaDAL.Nuevo(maquina, descripcion, proceso_id, planta_id, kwh)
    ...
    Protected Sub grdMaquinaClasificada_RowUpdating(sender As Object, e As GridViewUpdateEventArgs) Handles grdMaquinaClasificada.RowUpdating
        ...
        pnlNuevo.Visible = False
        Dim maquina As String = CType(grdMaquinaClasificada.Rows(e.RowIndex).Cells(1).Controls(1), TextBox).Text
        ...
        ClasificarMaquinaDAL.Actualizar(maquina, descripcion, proceso, planta)
    ...
    Protected Sub grdMaquinaClasificada_RowDeleting(sender As Object, e As GridViewDeleteEventArgs) Handles grdMaquinaClasificada.RowDeleting
        ...
        ClasificarMaquinaDAL.Eliminar(maquina)
    ...
    Private Sub cargarComboProcesos(cmbProcesos As Object)
        ...
        Dim dt As DataTable = ClasificarMaquinaBLL.ObtenerComboProcesos()
    ...
    Private Sub cargarComboPlantas(cmbPlantas As Object)
        ...
        Dim dt As DataTable = ClasificarMaquinaBLL.ObtenerComboPlantas()
        Dim ddr As DataRow = dt.NewRow()
