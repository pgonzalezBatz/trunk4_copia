...
#Region "Registro del script"
    ...
    ''' <summary>
    ''' Para poder registrar el js dando igual en que nivel este el control
    ''' </summary>
    ''' <param name="sender"></param>
    ''' <param name="e"></param>    
    Private Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ScriptManager.RegisterClientScriptInclude(Me, Me.GetType, "script", ResolveUrl("~/Js/jQuery/autocompleteGV.js"))
    End Sub
    ...
    Protected Sub Page_PreRender(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreRender
        ...
        Dim script As String = "init('" & txtInput.ClientID & "', '" & hfValue.ClientID & "', '" & helper.ClientID & "','" & RutaPaginaBusqueda & "','" & PostBack.ToString & "','" & postBackControlId & "','" & divImgGV.ClientID & "','" & GridviewClass & "','" & IdName & "','" & ValueName & "','" & MinSearchLength & "','" & MaxDivHeight & "','" & Opcion & "');"
