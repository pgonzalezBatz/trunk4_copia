<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Kaplan_plantas.Master" CodeBehind="CrearRoles.aspx.vb" Inherits="KaplanNew.CrearRoles" %>
                           ...
                           <asp:TextBox ID="txtResponsable" runat="server"  Width="40%" class="form-control required" required="required" />
                            ...
                            <asp:HiddenField ID="hfResponsable" runat="server" />
                               ...
                               <asp:DropDownList class="btn btn-default dropdown-toggle" type="button" runat="server" ID="ddlUni" data-toggle="dropdown">
                                    ...
                                    <asp:ListItem Text="Control de Acceso" Value="3" />
                                    <asp:ListItem Text="Financiero" Value="4" />
                                    <asp:ListItem Text="RRHH" Value="5" />
                                    <asp:ListItem Text="Servicio Médico" Value="22" />
                                      <asp:ListItem Text="Prevención" Value="21" />
