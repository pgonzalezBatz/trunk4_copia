<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Kaplan_plantas.Master" CodeBehind="CrearStepsComponent.aspx.vb" Inherits="KaplanNew.CrearStepsComponent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cuerpoPrincipal" runat="server">
    ...
    <div class="container-fluid" style="background-color: #ebebeb;">
        <div class="navbar-header">
            <a class="navbar-brand" href="#"><span class="glyphicon glyphicon-globe"></span>&nbsp;<asp:Label ID="Label3" runat="server" Text="StepsComponent" /></a>
        </div>
    </div>
    ...
    <div class="container ">
        ...
        <asp:MultiView ID="mView" runat="server" ActiveViewIndex="0">
            ...
            <asp:View ID="viewListado" runat="server">
                ...
                <div class="row">
                    <div class="col-xs-3">
                        <asp:Label ID="Label1" runat="server" Text="StepComponent" />

                        <asp:TextBox class="form-control" type="text" ID="txtEmpresa" runat="server" AutoPostBack="True" />
                        <act:AutoCompleteExtender ID="aceAlmacen" ServiceMethod="CargarEmpresas2C"
                ...
                <asp:GridView ID="gvType" runat="Server" AutoGenerateColumns="False" CssClass="table table-striped" AllowPaging="true"  PageSize="10"
                    ...
                    <Columns>
                     ...
                     <asp:TemplateField HeaderText="Cod" >
                        ...
                        <asp:TemplateField HeaderText="StepComponent" >
                                     <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Component" ItemStyle-Width="35%">
                            <ItemTemplate>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-lg-offset-2">
                            ...
                            <div class="row">
                                <div class="col-xs-4">
                                    <asp:Label runat="server" ID="ex1e" Text="StepsComponent" />
                            ...
                            <asp:Label visible="false" runat="server" ID="lblAplicacionC" Text="Obsoleto" />
                                                ...
                                                <asp:Label runat="server" ID="Label2" Text="StepsComponent" />: 
                            ...
                            <asp:Label runat="server" ID="Label6" Text="Component" />:  
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-lg-offset-2">
                           ...
                           <asp:Label runat="server" ID="lblemail" Text="Component" />:  
