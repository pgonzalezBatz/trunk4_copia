<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Kaplan_plantas.Master" CodeBehind="CrearComponents.aspx.vb" Inherits="KaplanNew.CrearComponents" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cuerpoPrincipal" runat="server">
    ...
    <div class="container-fluid" style="background-color: #ebebeb;">
        <div class="navbar-header">
            <a class="navbar-brand" href="#"><span class="glyphicon glyphicon-globe"></span>&nbsp;<asp:Label ID="Label3" runat="server" Text="TIPO CHARACTERISTICS" /></a>
        </div>
    </div>
    ...
    <div class="container ">
        ...
        <asp:MultiView ID="mView" runat="server" ActiveViewIndex="0">
            ...
            <asp:View ID="viewListado" runat="server">
                ...
                <div class="row">
                    <div class="col-xs-3">
                        <asp:Label ID="Label1" runat="server" Text="Tipo Characteristics" />

                        <asp:TextBox class="form-control" type="text" ID="txtEmpresa" runat="server" AutoPostBack="True" />
                        <act:AutoCompleteExtender ID="aceAlmacen" ServiceMethod="CargarEmpresasComponents"
          ...
          <%--                      <div class="col-xs-3">
                            ...
                            <asp:Label visible="false" runat="server" ID="lblAplicacionC" Text="Obsolete" />
                                                ...
                                                <asp:Label Visible="false" runat="server" ID="Label2" Text="Proceso" /> 

                                    <asp:DropDownList Visible="false"  ID="DdlPreventiva3" runat="server" class="form-control">
                                    </asp:DropDownList>

                                 <asp:Label  visible="false" runat="server" ID="Label4" Text="Obsoleto" />
