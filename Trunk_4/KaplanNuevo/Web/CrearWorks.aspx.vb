    ...
    Protected Sub BindDataView()
        Try
            ...
            If hfEmpresa.Value <> "" Then
                listaType = oDocBLL.CargarListaEmpresastextoWork(PageBase.plantaAdmin, hfEmpresa.Value)
            Else
                listaType = oDocBLL.CargarListaEmpresasWork(PageBase.plantaAdmin)
            End If
...
#End Region
    ...
    Private Sub CargarDocumentos()
        ...
        lista = oDocBLL.CargarListaEmpresasWork(PageBase.plantaAdmin)
    End Sub
    ...
    Protected Sub gvType_RowCommand(ByVal sender As Object, ByVal e As GridViewCommandEventArgs) Handles gvType.RowCommand
        Try
            ...
            If e.CommandName = "Desactivar" Then
                ...
                If (oDocumentosBLL.ModificarEmpWork(TipoTra)) Then

                    Master.MensajeInfo = ItzultzaileWeb.Itzuli("WORK disabled").ToUpper
                    BindDataView()
                Else
            ...
            If e.CommandName = "Activar" Then
                ...
                If (oDocumentosBLL.ModificarEmpWork(TipoTra)) Then
                    ...
                    Master.MensajeInfo = ItzultzaileWeb.Itzuli("WORK activated").ToUpper
                    BindDataView()
                Else
    ...
    Private Sub ConfiguracionProduct(ByVal idDocumento As Integer, Optional ByVal idType As Integer = 0, Optional ByVal idTransmissionMode As Integer = 0)
        Try
            ...
            If idDocumento = 0 Then
                ...
                LimpiarCampos()
            Else
                lista = oDocBLL.CargarTiposEmpresaWork(idDocumento, PageBase.plantaAdmin)
    ...
    Protected Sub btnGuardarNuevaReferencia_Click(sender As Object, e As EventArgs) Handles btnGuardarNuevaSolicitud.Click
        Try
            ...
            If flag_Modificar.Value = "0" Then 'creo que no pasa por aqui. esta opción es de modificación
                ...
                If (oDocumentosBLL.GuardarEmpWork(tipo2)) Then 'sin commit no actualiza emp para insert emd
                ...
                End If
            Else
                If (oDocumentosBLL.ModificarEmpWork(tipo2, CInt(flag_Modificar.Value))) Then
    ...
    Protected Sub btnGuardarNuevaReferencia2_Click(sender As Object, e As EventArgs) Handles GrabarVista2.Click
        Try
            ...
            If (oDocumentosBLL.GuardarEmpWork(tipo2)) Then 'sin commit no actualiza emp para insert emd
                    ...
                    Master.MensajeInfo = ItzultzaileWeb.Itzuli("Work") & " " & txtNombre.Text & " " & ItzultzaileWeb.Itzuli("Saved")
