<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Kaplan_plantas.Master" CodeBehind="CrearWorks.aspx.vb" Inherits="KaplanNew.CrearWorks" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cuerpoPrincipal" runat="server">
    ...
    <div class="container-fluid" style="background-color: #ebebeb;">
        <div class="navbar-header">
            <a class="navbar-brand" href="#"><span class="glyphicon glyphicon-globe"></span>&nbsp;<asp:Label ID="Label3" runat="server" Text="WORKS" /></a>
        </div>
    </div>
    ...
    <div class="container ">
        ...
        <asp:MultiView ID="mView" runat="server" ActiveViewIndex="0">
            ...
            <asp:View ID="viewListado" runat="server">
                ...
                <div class="row">
                    <div class="col-xs-3">
                        <asp:Label ID="Label1" runat="server" Text="Work" />

                        <asp:TextBox class="form-control" type="text" ID="txtEmpresa" runat="server" AutoPostBack="True" />
                        <act:AutoCompleteExtender ID="aceAlmacen" ServiceMethod="CargarEmpresasWork"
