<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Kaplan_plantas.Master" CodeBehind="Componente.aspx.vb" Inherits="KaplanNew.Componente" %>
            ...
            <asp:View ID="viewListado" runat="server">
                ...
                <div class="row">
                  ...
                  <asp:TextBox class="form-control" type="text" ID="txtDescref" runat="server" />
                      ...
                      <div class="col-xs-2">
                             <br />
               <asp:LinkButton ID="lbEditarRef" class="btn  bg-info" ToolTip="Asociar Operación" runat="server" Text="Asociar Operación" CommandName="Operacion2"   />
                        </div>
                </div>
