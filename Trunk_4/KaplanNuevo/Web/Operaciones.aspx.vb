    ...
    Protected Sub BindDataView()
        Try
            ...
            If hfwork.Value <> "" And hfstep.Value <> "" Then
                ...
                listaType2 = oDocBLL.CargarListaAsociaciones(PageBase.plantaAdmin, hfReferencia.Value, hfcomponente.Value, DdlWork.SelectedValue, DdlSteps.SelectedValue)
    ...
    Protected Sub gvType2_RowCommand(ByVal sender As Object, ByVal e As GridViewCommandEventArgs) Handles gvType2.RowCommand
        Try
            ...
            If e.CommandName = "Activar2" Then 'esto va a ser condiciones
                ...
                Dim TipoTra As New KaplanLib.ELL.Asociacion With {.Id = Iddoc, .Condicion1 = campo1.Text, .Condicion2 = campo2.Text, .Condicion3 = campo3.Text, .Condicion4 = campo4.Text, .Condicion5 = campo5.Text, .Condicion6 = campo6.Text}
                'debo coger los datos y meterlos en el pop, para luego guradarlos
