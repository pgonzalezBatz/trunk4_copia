<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Kaplan_plantas.Master" CodeBehind="CrearStepsWork.aspx.vb" Inherits="KaplanNew.CrearStepsWork" %>
    ...
    <div class="container ">
        ...
        <asp:MultiView ID="mView" runat="server" ActiveViewIndex="0">
            ...
            <asp:View ID="viewListado" runat="server">
                ...
                <div class="row">
                    <div class="col-xs-3">
                        <asp:Label ID="Label1" runat="server" Text="STEPSWORK" />
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-lg-offset-2">
                            ...
                            <div class="row">
                                <div class="col-xs-4">
                                    <asp:Label runat="server" ID="ex1e" Text="Nombre" />
