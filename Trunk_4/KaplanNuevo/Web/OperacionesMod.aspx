<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Kaplan_plantas.Master" CodeBehind="OperacionesMod.aspx.vb" Inherits="KaplanNew.OperacionesMod" %>
            ...
            <asp:View ID="view1" runat="server">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-lg-offset-2">
                            ...
                            <div class="row">
                                <div class="col-xs-4">
                                    <asp:Label runat="server" ID="ex1e" Text="Componente" />
               ...
               <asp:Button ID="btnGuardarNuevaSolicitud" runat="server" class="btn btn-primary" OnClick="btnGuardarNuevaReferencia_Click" Text="Grabar Todo" UseSubmitBehavior="true" ValidationGroup="CamposVacios" />
                        ...
                        <asp:Button ID="btnCalculo" runat="server" OnClick="calculo_Click" Text="Asignar Modo Fallo y Causas" class="btn btn-primary" UseSubmitBehavior="true" />
                                    ...
                                    <asp:DropDownList ID="DdlWork" runat="server" class="form-control" AutoPostBack="false" >
                                    </asp:DropDownList>
                    
                                                <asp:Label runat="server" ID="Label2" Text="Step" />: 

                                    <asp:DropDownList ID="DdlSteps" runat="server" class="form-control" AutoPostBack="false"  >
                                    </asp:DropDownList>
...
<br />
            ...
            <EditItemTemplate>
                ...
                <div class="col-xs-4">
                       ...
                       <asp:Label runat="server" ID="Label18xa" Text="Fallo Tipo 1" />:  
                                 ...
                                 <asp:TextBox ID="TrabajoSTDa" Text='<%# Eval("condicion1")%>' runat="server" class="form-control"  />
                             </div>
                           <div class="col-xs-4">
                       ...
                       <asp:Label runat="server" ID="Label19xa" Text="Fallo Tipo 2" />:  
                         ...
                         <asp:TextBox ID="Parametroa"   Text='<%# Eval("condicion2")%>' runat="server" class="form-control"  />
                               </div>
                       
                            <div class="col-xs-4">
                           <asp:Label  runat="server" ID="Label20xa" Text="Fallo Tipo 3" />:  
                 <asp:TextBox ID="txtEspecificaciona"  Text='<%# Eval("condicion3")%>'  runat="server" class="form-control"  />
                 ...
                 <asp:TextBox ID="txtClasea"  runat="server" class="form-control"  Text='<%# Eval("condicion4")%>'  />
        ...
        <asp:Label  runat="server" ID="Label22xa" Text="Fallo Tipo 5" />:  
                 <asp:TextBox ID="txtMaximo2a"  runat="server" class="form-control"  Text='<%# Eval("condicion5")%>'  />

         </div>
                            <div class="col-xs-4">

               <asp:Label  runat="server" ID="Label24xa" Text="Fallo Tipo 6" />:  
                 <asp:TextBox ID="txtMinimo2a"  runat="server" class="form-control"  Text='<%# Eval("condicion6")%>'  />
                ...
                <asp:GridView ID="gvType3" runat="Server" AutoGenerateColumns="False" AllowPaging="true" CssClass="table table-striped"
                    ...
                    <Columns>
                      ...
                      <asp:TemplateField HeaderText="" ControlStyle-Font-Size="Small" ItemStyle-Font-Size=" Small ">
                        ...
                        <asp:TemplateField HeaderText="TrabajoSTD" ControlStyle-Font-Size="Small" ItemStyle-Font-Size=" Small ">
                            <ItemTemplate>
...
<br />
                        ...
                        <asp:HiddenField ID="hfcomponente" runat="server" />
                                <asp:HiddenField ID="hfcomponenteID" runat="server" />
                        <asp:HiddenField ID="hfReferencia" runat="server" />
                           ...
                           <asp:HiddenField ID="hfcont" runat="server" />
                                 <asp:HiddenField ID="hfhijos" runat="server" />
