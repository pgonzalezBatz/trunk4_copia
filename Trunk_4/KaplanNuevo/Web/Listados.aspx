<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Kaplan_plantas.Master" CodeBehind="Listados.aspx.vb" Inherits="KaplanNew.Listados" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cuerpoPrincipal" runat="server">
    ...
    <div class="container">
        ...
        <asp:MultiView ID="mView" runat="server" ActiveViewIndex="0">
            ...
            <asp:View ID="viewListado" runat="server">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        ...
                        <asp:Label ID="MessageLabelxx" Text="Referencia: " runat="server" />
                ...
                <asp:GridView ID="gvType" runat="Server" AutoGenerateColumns="False" AllowPaging="true" CssClass="table table-striped"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Referencia" >
                            <ItemTemplate>
                                <asp:Label ID="lblDescripcion6desc" Text='<%# Eval("desc_ref")%>' runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>
                     ...
                     <asp:TemplateField HeaderText="componente" >
                       ...
                       <asp:TemplateField HeaderText="componente" >
                            <ItemTemplate>
                                <asp:Label ID="lblDescripcion3desc" Text='<%# Eval("desc_comp")%>' runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Process" >
                            <ItemTemplate>
                                <asp:Label ID="lblDescripcion33" Text='<%# Eval("proceso")%>' runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Desc Process Planta" >
                            <ItemTemplate>
                                <asp:Label ID="lblDescripcion3300" Text='<%# Eval("Desc_Process_Planta")%>' runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Desc Process Cliente" >
                            <ItemTemplate>
                                <asp:Label ID="lblDescripcion3311" Text='<%# Eval("Desc_Process_Cliente")%>' runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Desc Process User" >
                            <ItemTemplate>
                                <asp:Label ID="lblDescripcion3322" Text='<%# Eval("Desc_Process_User")%>' runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="Step">
                            <ItemTemplate>
                                <asp:Label ID="lblDescripcion533" Text='<%# Eval("steps")%>' runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Work" >
                            <ItemTemplate>
                                <asp:Label ID="lblDescripcion2" Text='<%# Eval("desc_work")%>' runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>
                           ...
                           <act:ConfirmButtonExtender ID="cbeEliminar2" runat="server" DisplayModalPopupID="mpeEliminar2"
                                ...
                                <asp:Panel ID="pnlConfirmDelete" runat="server" CssClass="modalPopup" Style="display: none">
                                    ...
                                    <div class="body"   style="text-align: left; margin-left: 135px;">
                                        <br />
                                        <asp:Label ID="lblHijos" runat="server" Text='<%# Eval("elementos")%>' />
                       ...
                       <asp:TemplateField HeaderText="Caracteristica" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                            <ItemTemplate>

                                <asp:LinkButton runat="server" ID="lblDescripcionw" Text="Caracteristica"  title="Caracteristica" />
                           <act:ConfirmButtonExtender ID="cbeEliminar2w" runat="server" DisplayModalPopupID="mpeEliminar2w"
                                ...
                                <act:ModalPopupExtender ID="mpeEliminar2w" runat="server" PopupControlID="pnlConfirmDeletew" TargetControlID="lblDescripcionw" 
                                  ...
                                  <asp:Panel ID="pnlConfirmDeletew" runat="server" CssClass="modalPopup"  style="display: flex;  justify-content: center; overflow-y: scroll; max-height:85%; max-width:85%; width: 1100px;  margin-top: 1px; margin-bottom:50px;">
                                    ...
                                    <div class="header">
                                        <asp:Label ID="lblConfirmacionw" runat="server" Text="Caracteristica" />
                                    </div>
                                    <div class="body"   style=" display: flex;  justify-content: center; margin-right: auto; margin-left: auto;">
                                     
                                        <asp:Label ID="lblHijosw" runat="server" Text='<%# Eval("caracteristica")%>' />
            ...
            <asp:TemplateField HeaderText="Modo Fallo" >
                            <ItemTemplate>
                                <asp:Label ID="lblDescripcionw2" Text='<%# Eval("ModoFallo")%>' runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>


                                    <asp:TemplateField HeaderText="Causas" >
                            <ItemTemplate>
                                <asp:Label ID="lblDescripcionw2C" Text='<%# Eval("Causas")%>' runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>


                                    <asp:TemplateField HeaderText="Efectos(3)" >
                            <ItemTemplate>
                                <asp:Label ID="lblDescripcionw2E" Text='<%# Eval("Efectos")%>' runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>
<%--
...
--%>
                       ...
                       <asp:TemplateField HeaderText="Atributos(n)" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                ...
                                <act:ModalPopupExtender ID="mpeEliminar2q" runat="server" PopupControlID="pnlConfirmDeleteq" TargetControlID="lblDescripcionq"
                                  ...
                                  <asp:Panel ID="pnlConfirmDeleteq" runat="server" CssClass="modalPopup"  style=" display: flex;  justify-content: center; overflow-y: scroll; max-height:85%; max-width:85%; width: 1100px;  margin-top: 1px; margin-bottom:50px;">
                                    ...
                                    <div class="body"   style=" display: flex;  justify-content: center; margin-right: auto; margin-left: auto;">
                                        ...
                                        <asp:Label ID="lblHijosq" runat="server" Text='<%# Eval("Atributo")%>' />
                                ...
                                <act:ModalPopupExtender ID="mpeEliminar2z" runat="server" PopupControlID="pnlConfirmDeletez" TargetControlID="lblDescripcionz" 
                                  ...
                                  <asp:Panel ID="pnlConfirmDeletez" runat="server" CssClass="modalPopup"  style="display: flex;  justify-content: center; overflow-y: scroll; max-height:85%; max-width:85%; width: 1100px;  margin-top: 1px; margin-bottom:50px;">
                                    ...
                                    <div class="body"   style=" display: flex;  justify-content: center; margin-right: auto; margin-left: auto;">
                                        ...
                                        <asp:Label ID="lblHijosz" runat="server" Text='<%# Eval("Descripcion")%>' />
                     ...
                     <asp:TemplateField HeaderText="Desc_work_Larga" >
                            <ItemTemplate>
                                <asp:Label ID="lblDescripcion3311q" Text='<%# Eval("Desc_work_Larga")%>' runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>

                     <asp:TemplateField HeaderText="Desc_step_Larga" >
                            <ItemTemplate>
                                <asp:Label ID="lblDescripcion3311qq" Text='<%# Eval("Desc_step_Larga")%>' runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>

                     <asp:TemplateField HeaderText="Severity" >
                            <ItemTemplate>
                                <asp:Label ID="lblDescripcion3311qqq" Text='<%# Eval("Severity")%>' runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Control_Pre" >
                            <ItemTemplate>
                                <asp:Label ID="lblDescripcion3311gg" Text='<%# Eval("Control_Pre")%>' runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>

                                                <asp:TemplateField HeaderText="Control_Pre_Valor" >
                            <ItemTemplate>
                                <asp:Label ID="lblDescripcion3311ggg" Text='<%# Eval("Control_Pre_Valor")%>' runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>

                                                 <asp:TemplateField HeaderText="Control_Det" >
                            <ItemTemplate>
                                <asp:Label ID="lblDescripcion3311ggggh" Text='<%# Eval("Control_Det")%>' runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>

                         <asp:TemplateField HeaderText="Calificacion" >
                            <ItemTemplate>
                                <asp:Label ID="lblDescripcion3311gggg" Text='<%# Eval("Calificacion")%>' runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Borrar" visible="false">
                            <ItemTemplate>
