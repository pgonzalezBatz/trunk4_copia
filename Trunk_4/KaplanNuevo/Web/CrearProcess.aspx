<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Kaplan_plantas.Master" CodeBehind="CrearProcess.aspx.vb" Inherits="KaplanNew.CrearProcess" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cuerpoPrincipal" runat="server">
    ...
    <div class="container-fluid" style="background-color: #ebebeb;">
        <div class="navbar-header">
            <a class="navbar-brand" href="#"><span class="glyphicon glyphicon-globe"></span>&nbsp;<asp:Label ID="Label3" runat="server" Text="PROCESSES" /></a>
        </div>
    </div>
    ...
    <div class="container ">
        ...
        <asp:MultiView ID="mView" runat="server" ActiveViewIndex="0">
            ...
            <asp:View ID="viewListado" runat="server">
                ...
                <div class="row">
                    <div class="col-xs-3">
                        <asp:Label ID="Label1" runat="server" Text="Process" />

                        <asp:TextBox class="form-control" type="text" ID="txtEmpresa" runat="server" AutoPostBack="True" />
                        <act:AutoCompleteExtender ID="aceAlmacen" ServiceMethod="CargarEmpresasProcess"
                ...
                <asp:GridView ID="gvType" runat="Server" AutoGenerateColumns="False" CssClass="table table-striped" AllowPaging="true"  PageSize="10"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Name" ItemStyle-Width="70%">
                            <ItemTemplate>
                                <asp:LinkButton ID="lblDescripcion" Text='<%# Eval("Nombre")%>' Font-Underline="true" runat="server" ToolTip="Modificar Datos" CommandName="Edit" />
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Modify data">
                            <ItemTemplate>
                                <asp:LinkButton ID="lbEditar" runat="server" Text="Modify data" class="btn  bg-info" ToolTip="Modificar Datos" CommandName="Edit" />
                            </ItemTemplate>
          ...
          <%--                      <div class="col-xs-3">
                                    ...
                                    <asp:Label runat="server" ID="Descripcion" Text="Descripcion" />
                                    <asp:TextBox type="text" class="form-control" ID="CifEmp" runat="server" ReadOnly="True" />
                                </div>--%>

                            </div>
                            <br />
                            <asp:Label runat="server" ID="lblNombre" Text="Descripción Planta" />:

                            <asp:TextBox type="text" class="form-control" ID="CifEmp" runat="server"/>

                           <asp:Label   runat="server" ID="Label12" Text="Descripción Cliente" />
                            <asp:TextBox type="text"  ID="txtNotificar" runat="server" class="form-control" />


                  <asp:Label  runat="server" ID="Label2" Text="Descripción Usuario Final" /> 

                            <asp:TextBox type="text"   ID="txtFax" runat="server" class="form-control" />
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-lg-offset-2">
                            ...
                            <asp:RequiredFieldValidator ID="rfvCIF" runat="server" Text="*" ErrorMessage="Inserta el Nombre" ControlToValidate="txtCIF" ValidationGroup="CamposVacios" Display="None" />



                            <asp:Label runat="server" ID="Label23" Text="Descripción Planta" />:

                            <asp:TextBox ID="txtCIF" class="form-control required" runat="server" />


                                <asp:Label   runat="server" ID="Label5ww" Text="Descripción Cliente" />
                            <asp:TextBox type="text"  ID="TextBox1" runat="server" class="form-control" />


                  <asp:Label  runat="server" ID="Label6www" Text="Descripción Usuario Final" /> 

                            <asp:TextBox type="text"   ID="TextBox2" runat="server" class="form-control" />




                           <asp:Label Visible="false"  runat="server" ID="lblemail" Text="Proceso" />
