    ...
    Protected Sub BindDataView()
        Try
            ...
            If hfEmpresa.Value <> "" Then
                listaType = oDocBLL.CargarListaEmpresastextoResulting(PageBase.plantaAdmin, hfEmpresa.Value)
            Else
                listaType = oDocBLL.CargarListaEmpresasResulting(PageBase.plantaAdmin)
            End If
...
#End Region
    ...
    Private Sub CargarDocumentos()
        ...
        lista = oDocBLL.CargarListaEmpresasResulting(PageBase.plantaAdmin)
    End Sub
    ...
    Protected Sub gvType_RowCommand(ByVal sender As Object, ByVal e As GridViewCommandEventArgs) Handles gvType.RowCommand
        Try
            ...
            If e.CommandName = "Desactivar" Then
                ...
                If (oDocumentosBLL.UpdateEmpResulting(TipoTra)) Then

                    Master.MensajeInfo = ItzultzaileWeb.Itzuli("Resulting disabled").ToUpper
                    BindDataView()
                Else
            ...
            If e.CommandName = "Activar" Then
                ...
                If (oDocumentosBLL.UpdateEmpResulting(TipoTra)) Then
                    ...
                    Master.MensajeInfo = ItzultzaileWeb.Itzuli("Resulting activated").ToUpper
                    BindDataView()
                Else
    ...
    Private Sub ConfiguracionProduct(ByVal idDocumento As Integer, Optional ByVal idType As Integer = 0, Optional ByVal idTransmissionMode As Integer = 0)
        Try
            ...
            If idDocumento = 0 Then
                ...
                LimpiarCampos()
            Else
                lista = oDocBLL.CargarTiposEmpresaResulting(idDocumento, PageBase.plantaAdmin)
    ...
    Protected Sub btnGuardarNuevaReferencia_Click(sender As Object, e As EventArgs) Handles btnGuardarNuevaSolicitud.Click
        Try
            ...
            If flag_Modificar.Value = "0" Then 'creo que no pasa por aqui. esta opción es de modificación
                ...
                If (oDocumentosBLL.GuardarResulting(tipo2)) Then 'sin commit no actualiza emp para insert emd
                ...
                End If
            Else
                If (oDocumentosBLL.ModificarResulting(tipo2, CInt(flag_Modificar.Value))) Then
    ...
    Protected Sub btnGuardarNuevaReferencia2_Click(sender As Object, e As EventArgs) Handles GrabarVista2.Click
        Try
            ...
            If (oDocumentosBLL.GuardarResulting(tipo2)) Then 'sin commit no actualiza emp para insert emd
                    ...
                    Master.MensajeInfo = ItzultzaileWeb.Itzuli("Resulting") & " " & txtNombre.Text & " " & ItzultzaileWeb.Itzuli("Saved")
