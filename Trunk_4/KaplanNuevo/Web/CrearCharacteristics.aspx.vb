...
Public Class CrearCharacteristics
    Inherits PageBase
    ...
    Protected Sub BindDataView()
        Try
            ...
            If hfEmpresa.Value <> "" Then
                listaType = oDocBLL.CargarListaEmpresastextoCharacteristics(PageBase.plantaAdmin, hfEmpresa.Value)
            Else
                listaType = oDocBLL.CargarListaEmpresasCharacteristic(PageBase.plantaAdmin)
            End If
...
#End Region
    ...
    Private Sub CargarDocumentos()
        ...
        lista = oDocBLL.CargarListaEmpresasCharacteristic(PageBase.plantaAdmin)
    End Sub
    ...
    Protected Sub gvType_RowCommand(ByVal sender As Object, ByVal e As GridViewCommandEventArgs) Handles gvType.RowCommand
        Try
            ...
            If e.CommandName = "Desactivar" Then
                ...
                If (oDocumentosBLL.UpdateEmpChar(TipoTra)) Then
    ...
    Private Sub ConfiguracionProduct(ByVal idDocumento As Integer, Optional ByVal idType As Integer = 0, Optional ByVal idTransmissionMode As Integer = 0)
        Try
            ...
            If idDocumento = 0 Then
                ...
                'LimpiarCampos()
            Else
                lista = oDocBLL.CargarTiposEmpresaChar(idDocumento, PageBase.plantaAdmin)
                ...
                txtSimbolo.Text = lista(0).textolibre2
                txtClientes.Text = lista(0).textolibre
    ...
    Protected Sub btnGuardarNuevaReferencia_Click(sender As Object, e As EventArgs) Handles btnGuardarNuevaSolicitud.Click
        Try
            ...
            Dim tipo As New KaplanLib.ELL.Empresas With {.Planta = PageBase.plantaAdmin, .Nif = HdnCIF.Value, .Nombre = HdnNombre.Value, .FecSolEnv = dateFechaSol, .FecEnv = dateFechaEnv, .FecRec = dateFechaRec, .preventiva = 0, .telefono = "", .email = "", .subcontrata = DdlSubcontrata.SelectedValue, .contacto = "", .notificar = txtSimbolo.Text.ToLower}  '.Autonomo = DdlAutonomo.SelectedValue,
            Dim tipo2 As New KaplanLib.ELL.Kaplan With {
                    ...
                    .Obsoleto = DdlSubcontrata.SelectedValue, 'obsoleto
                         ...
                         .Nombre = NomEmp.Text,
                         .textolibre = txtClientes.Text,
                         .textolibre2 = Left(txtSimbolo.Text, 1)
                    }
            ...
            If flag_Modificar.Value = "0" Then 'creo que no pasa por aqui. esta opción es de modificación
                ...
                If (oDocumentosBLL.GuardarChar(tipo2)) Then 'sin commit no actualiza emp para insert emd
                ...
                End If
            Else
                If (oDocumentosBLL.ModificarChar(tipo2, CInt(flag_Modificar.Value))) Then
    ...
    Protected Sub btnGuardarNuevaReferencia2_Click(sender As Object, e As EventArgs) Handles GrabarVista2.Click
        Try
            ...
            If (oDocumentosBLL.GuardarChar(tipo2)) Then 'sin commit no actualiza emp para insert emd
                    ...
                    Master.MensajeInfo = ItzultzaileWeb.Itzuli("Characteristic") & " " & txtNombre.Text & " " & ItzultzaileWeb.Itzuli("Saved")
