...
Public Class CrearStepsResulting
    Inherits PageBase
    ...
    Protected Sub BindDataView()
        Try
            ...
            If hfEmpresa.Value <> "" Then
                listaType = oDocBLL.CargarListaEmpresastexto2R(PageBase.plantaAdmin, hfEmpresa.Value)
            Else
                listaType = oDocBLL.CargarListaStepsR()
            End If
            ...
            For i = 0 To listaType.Count - 1
                ...
                listaType3 = oDocBLL.loadListEmpresas4R(listaType(i).Work) 'listaType(0).DocEnv
        ...
        Try
            ...
            If Not (Page.IsPostBack) Then
                ...
                If s = "1" Then
                    ...
                    listaPRE2 = oDocBLL.CargarListaEmpresasResulting(PageBase.plantaAdmin)
    ...
    Protected Sub gvType_RowCommand(ByVal sender As Object, ByVal e As GridViewCommandEventArgs) Handles gvType.RowCommand
        Try
            ...
            If e.CommandName = "Desactivar" Then
                ...
                If (oDocumentosBLL.ModificarEmp2R(TipoTra)) Then
    ...
    Private Sub ConfiguracionProduct(ByVal idDocumento As Integer, Optional ByVal idType As Integer = 0, Optional ByVal idTransmissionMode As Integer = 0)
        Try
            ...
            If idDocumento = 0 Then
                ...
                LimpiarCampos()
            Else
                lista = oDocBLL.CargarTiposstepsworkR(idDocumento, PageBase.plantaAdmin)
    ...
    Protected Sub btnGuardarNuevaReferencia_Click(sender As Object, e As EventArgs) Handles btnGuardarNuevaSolicitud.Click
        Try
            ...
            If flag_Modificar.Value = "0" Then 'creo que no pasa por aqui. esta opción es de modificación
                ...
                If (oDocumentosBLL.GuardarEmp2R(tipo2)) Then 'sin commit no actualiza emp para insert emd
            ...
            Else
                ...
                If (oDocumentosBLL.ModificarEmp2R(tipo2, CInt(flag_Modificar.Value))) Then
