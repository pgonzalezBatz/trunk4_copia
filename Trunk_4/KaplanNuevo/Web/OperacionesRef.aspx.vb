...
#Region "METODOS"
    ...
    Protected Sub BindDataView()
        Try
            ...
            hfcomponente.Value = hfReferencia.Value
            ...
            While dr.Read
                ...
                'If componente = hfReferencia.Value Then
            ...
            If hfwork.Value <> "" And hfstep.Value <> "" Then
                ...
                listaType2 = oDocBLL.CargarListaAsociaciones(PageBase.plantaAdmin, hfReferencia.Value, hfReferencia.Value, DdlWork.SelectedValue, DdlSteps.SelectedValue)
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Dim oDocBLL As New KaplanLib.BLL.DocumentosBLL
            'buscar el id del step por el nombre, luego en vez de DdlWork.SelectedValue, DdlSteps.SelectedValue, seran los valores hfwork.Value hfstep.Value

            hfTipoC.Value = TipoC.SelectedValue
            hfClaseC.Value = ClaseC.SelectedValue


            If DdlSteps.SelectedIndex > 0 Then
                ...
                'Idsteps = Idst(0).Id
                Idsteps = DdlSteps.SelectedValue
            ...
            hfwork.Value = Request.QueryString("idWork")
            hfstep.Value = Request.QueryString("idStep")
            mView.ActiveViewIndex = 1
            'ComprobarAcceso()

            If DdlSteps.SelectedIndex > 0 Then
                'poner el proceso que le pertenece
                'Dim listaWorks As List(Of KaplanLib.ELL.Kaplan)
                'listaWorks = oDocBLL.loadListEmpresas3(DdlSteps.SelectedValue)
                'DdlWork.SelectedValue = listaWorks(0).Proceso
            Else


                DdlSteps.Items.Clear()
                DdlSteps.Items.Add(liPreventivavacio)
            ...
            If DdlWork.SelectedIndex > 0 Then
            Else


                DdlWork.Items.Clear()
                DdlWork.Items.Add(liPreventivavacio)
            ...
            If Not (Page.IsPostBack) Then
                ...
                ''''    For Each Acaracteristic In ATipoC
                ''''        Dim Aliresponsable2 As New ListItem(Acaracteristic.Nombre, Acaracteristic.Id)
                ''''        TipoC.Items.Add(Aliresponsable2)
                ...
                ''''Dim ATipoC2 As List(Of KaplanLib.ELL.Kaplan)
                ''''ATipoC2 = oDocBLL.CargarTiposChar()
                ...
                'DdlCaracterist.SelectedIndex = listaCar(0).Id
                'TxtCaracteristicas.Text = DdlCaracterist.SelectedValue
    ...
    Protected Sub ddlTheDropDownList_Init(sender As Object, e As EventArgs)
        ...
        If listaSim.Count > 0 Then
            ddl.SelectedValue = listaSim(0).Id
        End If
    ...
    Protected Sub gvType2_RowCommand(ByVal sender As Object, ByVal e As GridViewCommandEventArgs) Handles gvType2.RowCommand
        Try
            ...
            If e.CommandName = "Activar" Then
                ...
                If (oDocumentosBLL.ModificarEmp2Char(TipoTra)) Then
                    gvType2.EditIndex = -1
            ...
            If e.CommandName = "Activar2" Then 'esto va a ser condiciones
                ...
                campo1.Text = "mal no debe ser el 0"
            ...
            If e.CommandName = "Desactivar" Then
                ...
                If (oDocumentosBLL.GuardarOpe3Borrar(TipoTra)) Then
    ...
    Protected Sub gvType3_RowCommand(ByVal sender As Object, ByVal e As GridViewCommandEventArgs) Handles gvType3.RowCommand
        Try
            ...
            If e.CommandName = "Activar" Then
                ...
                Dim TipoTra As New KaplanLib.ELL.Asociacion With {.Id = Iddoc, .TrabajoSTD = campo1, .Parametro = campo2, .Caracteristica = campo3, .Caracteristica2 = campo4, .Max = campo5, .Min = campo6}
                'debo coger los datos y meterlos en el pop, para luego guradarlos

                If (oDocumentosBLL.ModificarEmp2CharATR(TipoTra)) Then
    ...
    Private Sub ConfiguracionProduct(ByVal idDocumento As Integer, Optional ByVal idType As Integer = 0, Optional ByVal idTransmissionMode As Integer = 0)
        Try
            ...
            Else
                lista = oDocBLL.loadListStepsChar2t(DdlWork.SelectedValue, idDocumento, 0)
                ...
                If lista.Count > 0 Then
                    ...
                    'listaPRE = oDocBLL.CargarListaEmpresas2(DdlWork.SelectedValue)
                    ...
                    '    DdlSteps.SelectedValue = lista(0).Steps
                    'Else
                    ...
                    '    DdlWork.SelectedValue = lista(0).Work
                    'Else
    ...
    Protected Sub btnGuardarNuevaReferencia_Click(sender As Object, e As EventArgs) Handles btnGuardarNuevaSolicitud.Click
        Try
            ...
            If DdlSteps.SelectedValue = 0 Or DdlWork.SelectedValue = 0 Then
                Master.MensajeError = "Selecciona Proceso y Step"
                Exit Sub
            End If
            ...
            While dr.Read
                ...
                End If
                padre = If(dr("T2BGNR") Is Nothing OrElse dr("T2BGNR") Is DBNull.Value, "sin padre", dr("T2BGNR"))
                If padre = hfReferencia.Value Then
            ...
            tipo2.cont = PageBase.plantaAdmin
            ...
            For i = 0 To gvType2.Rows.Count - 1
                ...
                item2.Condicion1 = campo1.Text
                item2.Condicion2 = campo2.Text
            ...
            For i = 0 To gvType2.Rows.Count - 1
                ...
                tipo2.Condicion1 = listaTypeCond(i).Condicion1
                tipo2.Condicion2 = listaTypeCond(i).Condicion2
            ...
            For i = 0 To gvType3.Rows.Count - 1
                ...
                oDocumentosBLL.GuardarOpeAtri(tipo2)
            Next
    ...
    Protected Sub calculo_Click(sender As Object, e As EventArgs) Handles btnCalculo.Click
        Try 'voy a avisar que grabe, no hago poner el codigo de btnGuardarNuevaSolicitud y ademas redirect
            ...
            Response.Redirect("~/CalculoRef.aspx?idRef=" & hfReferencia.Value & "&idComp=" & hfcomponente.Value, False)
        Catch ex As Exception
            Master.MensajeError = ItzultzaileWeb.Itzuli("Error")
        End Try
    End Sub
    ...
    Protected Sub btnQuitarSeleccionadosx_Click(sender As Object, e As EventArgs) Handles btnQuitarSeleccionadosx.Click
        ...
        Try
            ...
            lista2 = oDocBLL.CargarTiposEmpresa(DdlSteps.SelectedValue, 0)

            Dim lista As List(Of KaplanLib.ELL.Kaplan)
            lista = oDocBLL.CargarTiposEmpresaStep(DdlSteps.SelectedValue, lista2(0).Proceso)
            ...
            End If
            Dim tipo2 As New KaplanLib.ELL.Asociacion With {
                        .Process = lista2(0).Proceso, ' es = DdlWork.SelectedValue,
                        .Work = lista2(0).Work,
                        .Steps = DdlSteps.SelectedValue,
                        .referencia = hfReferencia.Value,
                        .componente = hfcomponente.Value,
            ...
            oDocumentosBLL.GuardarOpe2(tipo2)
    ...
    Private Sub DdlSteps_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DdlSteps.SelectedIndexChanged
        Dim oDocBLL As New KaplanLib.BLL.DocumentosBLL
        'lo primero saber cual es el cont en asociaciones, sera pagebase.plantaadmin
        Dim listaCont As List(Of KaplanLib.ELL.Asociacion)
        listaCont = oDocBLL.CargarListaAsociaciones0(hfReferencia.Value, hfcomponente.Value, DdlWork.SelectedValue, DdlSteps.SelectedValue)
        If listaCont.Count > 0 Then
            PageBase.plantaAdmin = listaCont(0).cont + 1
        Else
        ...
        Dim lista As List(Of KaplanLib.ELL.Kaplan)
        lista = oDocBLL.CargarTiposEmpresaStep2(DdlSteps.SelectedValue, DdlWork.SelectedValue)  'lista2(0).Proceso
        For i = 0 To lista.Count - 1

            Dim tipo2 As New KaplanLib.ELL.Asociacion With {
                        .Process = DdlWork.SelectedValue, 'lista2(0).Proceso, ' es = 
                        .Work = 0, ' lista2(0).Work,
                        .Steps = DdlSteps.SelectedValue,
                        .referencia = hfReferencia.Value,
                        .componente = hfcomponente.Value,
                        .TipoC = lista(i).TipoC,
                        .ClaseC = lista(i).ClaseC,
                   .Caracteristica2 = lista(i).Caracteristica2,
                   .Max = lista(i).Max,
                       .Min = lista(i).Min,
                           .TrabajoSTD = lista(i).TrabajoSTD,
                               .Parametro = lista(i).Parametro,
                .Caracteristica = lista(i).Caracteristica
                        }
            If i = 0 Then
                oDocumentosBLL.GuardarOpe2Borrar(tipo2)
            End If
            oDocumentosBLL.GuardarOpe2(tipo2)
    ...
    Protected Sub BindDataView2()
        Try
            ...
            If DdlWork.SelectedValue <> "" And DdlSteps.SelectedValue <> "" Then
                listaType = oDocBLL.loadListStepsChart(DdlWork.SelectedValue, DdlSteps.SelectedValue, 0)
            Else
                listaType = oDocBLL.loadListStepsChart(0, 0, 0)
            End If
            For i = 0 To listaType.Count - 1
    ...
    Protected Sub BindDataView3()
        Try
            ...
            Dim listaType As List(Of KaplanLib.ELL.Asociacion)
            If DdlWork.SelectedValue <> "" And DdlSteps.SelectedValue <> "" Then
                listaType = oDocBLL.loadListStepsChar2t(DdlWork.SelectedValue, DdlSteps.SelectedValue, 0)
            Else
                listaType = oDocBLL.loadListStepsChar2t(0, 0, 0)
            End If
            For i = 0 To listaType.Count - 1
                listaType(i).Max = listaType(i).Max / 1000
                listaType(i).Min = listaType(i).Min / 1000
    ...
    Private Sub DdlWork_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DdlWork.SelectedIndexChanged
