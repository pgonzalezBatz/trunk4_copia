...
#Region "Consultas"
        ...
        Public Function loadTrabajadores(ByVal empresa As String) As List(Of ELL.Trabajadores)
            'Dim param1 As SqlClient.SqlParameter
            Dim query As String = "select tra001, tra013, tra002, tra003, tra008 from adok_tra where tra004 = " & empresa

            Return Memcached.SQLServerDirectAccess.seleccionar(Of ELL.Trabajadores)(Function(r As SqlClient.SqlDataReader) _
                  New ELL.Trabajadores With {.responsable = CInt(r("tra008")), .nDNI = SabLib.BLL.Utils.stringNull(r("tra001")), .tDNI = SabLib.BLL.Utils.stringNull(r("tra013")), .Nombre = SabLib.BLL.Utils.stringNull(r("tra002")), .Apellidos = SabLib.BLL.Utils.stringNull(r("tra003"))}, query, CadenaConexionSQL)
        ...
        Public Function loadListEmpresasSAS(ByVal plantaAdmin As Integer) As List(Of ELL.Empresas)
            ...
            'Dim query As String = " select id,nombre from gcprovee " ' where nomprov like '%" & consulta & "%' or nomprov like '%" & UCase(consulta) & "%'"

            'Return Memcached.OracleDirectAccess.seleccionar(Of ELL.Empresas)(Function(r As OracleDataReader) _
            '                   New ELL.Empresas With {.Id = CInt(r("id")), .Nombre = SabLib.BLL.Utils.stringNull(r("nombre"))}, query, CadenaConexionSAS)
        ...
        '    Dim query As String = " SELECT TI000 FROM fpertic WHERE (ti150 = '" & dni & "') and ti000=3 "
        ...
        Public Function loadIzaroTrabajador2(ByVal plantaAdmin As Integer, ByVal cod As Integer) As List(Of String())
            ...
            Dim query As String = " SELECT ta010 FROM fcpwtar WHERE ta000 = 3 and ta020 = " & cod
        ...
        Public Function ta010IzaroTra(ByVal plantaAdmin As Integer, ByVal cod As Integer) As List(Of String())
            ...
            Dim query As String = " SELECT ta010 FROM fcpwtar WHERE (ta020 = " & cod & ")  and ta000 = 3 "
        ...
        Public Function updateIzaroTra(ByVal tipoTarjetaIzaro As ELL.TarjetaIZARO) As Boolean
            ...
            Try
                ...
                strSql = " update fpertic set ti140=:responsable, ti300=:empresa         where ti010=:qTrabajador and ti000=3 "
                ...
                lParameters2.Add(New OracleParameter("empresa", OracleDbType.Varchar2, 50, tipoTarjetaIzaro.Empresa.ToString, ParameterDirection.Input))
                ...
                'Else
                strSql = "UPDATE USUARIOS SET fechabaja=:FecFin, idempresas=:empresa, iddepartamento=:departamento WHERE CODPERSONA=:qTrabajador "   'iddepartamento=:departamento
                'End If
                ...
                lParameters5.Add(New OracleParameter("empresa", OracleDbType.Varchar2, 50, CInt(tipoTarjetaIzaro.apellidos), ParameterDirection.Input))
                ...
                lParameters5.Add(New OracleParameter("departamento", OracleDbType.Varchar2, 22, tipoTarjetaIzaro.departamento, ParameterDirection.Input))
        ...
        Public Function CargarDocumentosCer(ByVal plantaAdmin As Integer, ByVal texto As String) As List(Of ELL.Documentos)
            If plantaAdmin = 230 Then
                plantaAdmin = 1
            End If
            'Dim query As String = "Select doc000, doc001, doc002, doc003, doc004, doc005, doc006, doc007, doc008, doc009, doc010, doc012, DOC013, doc014, doc015, doc016, doc017  FROM adok_doc  WHERE DOC000=" & idDoc & " and doc012=3 And doc099= " & plantaAdmin & " order by doc012, doc000 "

            'Return Memcached.OracleDirectAccess.seleccionar(Of ELL.Documentos)(Function(r As OracleDataReader) _
            '                 New ELL.Documentos With {.area = SabLib.BLL.Utils.integerNull(r("doc017")), .ETT = SabLib.BLL.Utils.integerNull(r("doc010")), .activo = SabLib.BLL.Utils.integerNull(r("doc015")), .ubicacion = SabLib.BLL.Utils.stringNull(r("doc016")), .tipotrabajo = SabLib.BLL.Utils.integerNull(r("doc014")), .Id = CInt(r("doc000")), .Nombre = SabLib.BLL.Utils.stringNull(r("doc001")), .Abrev = SabLib.BLL.Utils.stringNull(r("doc002")), .Periodo = SabLib.BLL.Utils.integerNull(r("doc003")), .Obligatorio = SabLib.BLL.Utils.integerNull(r("doc004")), .Trabajador = SabLib.BLL.Utils.integerNull(r("doc005")), .comentario = SabLib.BLL.Utils.stringNull(r("doc006")), .Responsable = SabLib.BLL.Utils.integerNull(r("doc007")), .Plantilla = SabLib.BLL.Utils.integerNull(r("doc009")), .Margen = SabLib.BLL.Utils.integerNull(r("doc008")), .EsDocumento = SabLib.BLL.Utils.integerNull(r("doc012")), .listacorreos = SabLib.BLL.Utils.stringNull(r("doc013"))}, query, CadenaConexion)

            Dim query As String = "Select doc000, doc001, doc002, doc011  FROM adok_doc  WHERE doc099= " & plantaAdmin & "  and (doc011 is null or doc011 <> 1)   and UPPER(doc001) like UPPER('%" & texto & "%') Order by doc001 "

            Return Memcached.OracleDirectAccess.seleccionar(Of ELL.Documentos)(Function(r As OracleDataReader) _
                               New ELL.Documentos With {.Id = CInt(r("doc000")), .Nombre = SabLib.BLL.Utils.stringNull(r("doc001")), .activo = SabLib.BLL.Utils.integerNull(r("doc011"))}, query, CadenaConexion)
        ...
        Public Function CargarRol(ByVal idUser As Integer, ByVal plantaAdmin As Integer) As List(Of ELL.Rol)
            ...
            Dim query As String = "Select rol001, rol002 FROM adok_roles  WHERE rol000=" & idUser & " And rol099= " & plantaAdmin
        ...
        Public Function CargarTiposEmpresa(ByVal idEmpresas As Integer, ByVal plantaAdmin As Integer) As List(Of ELL.Empresas)
            ...
            Dim query As String = "Select emp000, emp001, emp002, emp003, emp004, emp005, emp006, emp007, emp008, emp009, emp010, emp011, emp012, emp013, emp014, emp015, emp016, emp017, emp018, emp019, emp020, emp021,emp022, emp023  FROM adok_emp  WHERE emp000=" & idEmpresas & " And emp099= " & plantaAdmin
        ...
        Public Function loadListEmpDoc(ByVal plantaAdmin As Integer) As List(Of ELL.Documentos)
            If plantaAdmin = 230 Then
                plantaAdmin = 1
            End If
            Dim query As String = "Select doc000, doc001, doc002, doc003, doc004, doc005, doc006, doc007, doc008, doc009, doc012  FROM adok_doc  WHERE doc005 = 0 and (doc011 is null or doc011 = 0) and doc099= " & plantaAdmin & " order by doc012, doc000 "
        ...
        Public Function loadListTra(ByVal plantaAdmin As Integer) As List(Of ELL.Trabajadores)
            ...
            '    plantaAdmin = 1
            'End If
            Dim query As String = "Select tra000, tra001, tra013, tra002, tra003, tra004, tra005, tra006, tra007, tra008, tra012  FROM adok_tra  WHERE tra099= " & plantaAdmin & " order by tra003"
        ...
        Public Function loadListTraActivos(ByVal plantaAdmin As Integer) As List(Of ELL.Trabajadores)
            ...
            Dim query As String = "Select tra000, tra001, tra013, tra002, tra003, tra004, tra005, tra006, tra007, tra008, tra012  FROM adok_tra  WHERE tra099= " & plantaAdmin & " and (tra012 is null or tra012 <> 1)    order by tra003"
        ...
        Public Function loadListTraActivosMail(ByVal plantaAdmin As Integer) As List(Of ELL.Trabajadores)
            Dim query As String = "Select tra000, tra001, tra013, tra002, tra003, tra004, tra005, tra006, tra007, tra008, tra012  FROM adok_tra  WHERE tra099= " & plantaAdmin & " and (tra012 is null or tra012 <> 1) and (tra006 < to_date('01/01/2018','dd/MM/yyyy')) and (tra006 < to_date('02/01/1900','dd/MM/yyyy') or tra006 is null or tra006 > sysdate)    order by tra003"
        ...
        Public Function loadListTraActivosNoCad(ByVal plantaAdmin As Integer) As List(Of ELL.Trabajadores)
            ...
            '    plantaAdmin = 1
            'End If
            Dim query As String = "Select tra000, tra001, tra013, tra002, tra003, tra004, tra005, tra006, tra007, tra008, tra012  FROM adok_tra  WHERE tra099= " & plantaAdmin & " and (tra012 is null or tra012 <> 1)  and (tra006 < to_date('02/01/1900','dd/MM/yyyy') or tra006 is null or tra006 > sysdate)  order by tra003"
        ...
        Public Function loadListTraDoc(ByVal plantaAdmin As Integer, ByVal codtra As Integer, ByVal coddoc As Integer) As List(Of ELL.TrabajadoresDoc)
            ...
            Dim query As String = "Select trd013, trd002, trd004,  trd006,  trd007  FROM adok_trd  WHERE trd099= " & plantaAdmin & " and (trd014 is null or trd014 > sysdate)  AND trd000 = " & codtra & " AND trd001 = " & coddoc

            Return Memcached.OracleDirectAccess.seleccionar(Of ELL.TrabajadoresDoc)(Function(r As OracleDataReader) _
                             New ELL.TrabajadoresDoc With {.tiposCarne = SabLib.BLL.Utils.stringNull(r("TRD013")), .correcto = CInt(r("trd002")), .FecIni = SabLib.BLL.Utils.dateTimeNull(r("trd004")), .ubicacion = SabLib.BLL.Utils.stringNull(r("TRD006")), .periodicidad = SabLib.BLL.Utils.integerNull(r("trd007"))}, query, CadenaConexion)
        ...
        Public Function loadListTraDocAsignados(ByVal plantaAdmin As Integer, ByVal codtra As Integer) As List(Of ELL.TrabajadoresDoc)
            ...
            Dim query As String = "Select adok_doc.doc000, adok_doc.doc001, adok_doc.doc002, adok_doc.doc003, adok_doc.doc004, adok_doc.doc005, adok_doc.doc006, adok_doc.doc007, adok_doc.doc008, adok_doc.doc009, adok_doc.doc012, adok_doc.doc013, adok_trd.trd002, adok_trd.trd003, adok_trd.trd004, adok_trd.trd005, adok_trd.trd006, adok_trd.trd007, adok_trd.trd009, adok_trd.trd011, adok_trd.trd013 FROM adok_doc, adok_trd  WHERE adok_trd.trd001 = adok_doc.doc000 And adok_doc.doc011 = 0 And  adok_trd.trd099 = " & plantaAdmin & " And adok_trd.trd000 = " & codtra & " And trd010 Is  null And (trd014 Is null Or trd014 > sysdate)  "
        ...
        Public Function loadListTraDocObligatorio2(ByVal plantaAdmin As Integer) As List(Of ELL.EmpresasDoc)
            ...
            Dim query As String = "Select doc000, doc003 from adok_doc where doc012=4 And doc014=0 And doc099 = " & plantaAdmin
        ...
        End Function
        Public Function loadListMatriz(ByVal plantaAdmin As Integer) As List(Of ELL.TrabajadoresDoc)
            ...
            Return Memcached.OracleDirectAccess.seleccionar(Of ELL.TrabajadoresDoc)(Function(r As OracleDataReader) _
                             New ELL.TrabajadoresDoc With {.coddoc = SabLib.BLL.Utils.integerNull(r("doc000")), .Comentario = SabLib.BLL.Utils.stringNull(r("trd000")) & ";" & SabLib.BLL.Utils.stringNull(r("doc000")), .Nombre = SabLib.BLL.Utils.stringNull(r("tra003")) & ", " & SabLib.BLL.Utils.stringNull(r("tra002")), .codtra = SabLib.BLL.Utils.stringNull(r("trd000")), .Abrev = SabLib.BLL.Utils.stringNull(r("doc002")), .obligatorio = SabLib.BLL.Utils.integerNull(r("doc004")), .Margen = SabLib.BLL.Utils.integerNull(r("doc008")), .plantilla = SabLib.BLL.Utils.integerNull(r("doc009")), .EsDocumento = SabLib.BLL.Utils.integerNull(r("doc012")), .ubicacion = SabLib.BLL.Utils.stringNull(r("trd006")), .correcto = SabLib.BLL.Utils.integerNull(r("trd002")), .periodicidad = SabLib.BLL.Utils.integerNull(r("trd007")), .FecRec = SabLib.BLL.Utils.dateTimeNull(r("trd003")), .FecCad = SabLib.BLL.Utils.dateTimeNull(r("trd005")), .FecIni = SabLib.BLL.Utils.dateTimeNull(r("trd004")), .Aptitud = SabLib.BLL.Utils.integerNull(r("trd009")), .ubicacionfisica = SabLib.BLL.Utils.stringNull(r("trd011")), .Listacorreos = SabLib.BLL.Utils.stringNull(r("doc013"))}, query, CadenaConexion)
        ...
        Public Function loadListMatrizDoc(ByVal plantaAdmin As Integer) As List(Of ELL.Documentos)
            If plantaAdmin = 230 Then
                plantaAdmin = 1
            End If
            Dim query As String = "Select doc000 from adok_doc where  doc011 = 0    And doc018 > 0 order by doc000 asc "
            Return Memcached.OracleDirectAccess.seleccionar(Of ELL.Documentos)(Function(r As OracleDataReader) _
                             New ELL.Documentos With {.Id = SabLib.BLL.Utils.stringNull(r("doc000"))}, query, CadenaConexion)
        ...
        Public Function loadListEmpresasActivas(ByVal plantaAdmin As Integer) As List(Of ELL.Empresas)
            If plantaAdmin = 230 Then
                plantaAdmin = 1
            End If
            Dim query As String = "Select emp000, emp001, emp002, emp003, emp004, emp005, emp006, emp007, emp008, emp009, emp018  FROM adok_emp  WHERE emp018 = 0 And emp099= " & plantaAdmin & " Order by emp018 ASC, emp002 asc "
        ...
        Public Function loadListEmpresasActivasConTra(ByVal plantaAdmin As Integer) As List(Of ELL.Empresas)
            ...
            query = query & " (Select tra000, emp000, emp001, emp002, emp003, emp004, emp005, emp006, emp007, emp008, emp009, emp018  FROM adok_emp, adok_tra  WHERE (tra012 Is null Or tra012 <> 1)  And emp099= " & plantaAdmin & "  And (tra006 < to_date('02/01/1900','dd/MM/yyyy') or tra006 is null or tra006 > sysdate)  and tra004=emp000 And emp018 = 0 And emp099= 1 Order by emp018 ASC, emp002 asc ) order by emp002 asc "
        ...
        Public Function loadListEmpresasTexto(ByVal plantaAdmin As Integer, ByVal texto As String) As List(Of ELL.Empresas)
            If plantaAdmin = 230 Then
                plantaAdmin = 1
            End If
            Dim query As String = "Select emp000, emp001, emp002, emp018  FROM adok_emp  WHERE emp099= " & plantaAdmin & " and UPPER(emp002) like UPPER('%" & texto & "%') Order by emp002 "
        ...
        Public Function loadListEmpresasTextoActivas(ByVal plantaAdmin As Integer, ByVal texto As String) As List(Of ELL.Empresas)
            If plantaAdmin = 230 Then
                plantaAdmin = 1
            End If
            Dim query As String = "Select emp000, emp001, emp002, emp018  FROM adok_emp  WHERE emp018 = 0 and emp099= " & plantaAdmin & " and UPPER(emp002) like UPPER('%" & texto & "%') Order by emp002 "
            Return Memcached.OracleDirectAccess.seleccionar(Of ELL.Empresas)(Function(r As OracleDataReader) _
                               New ELL.Empresas With {.Id = CInt(r("emp000")), .Nif = SabLib.BLL.Utils.stringNull(r("emp001")), .Nombre = SabLib.BLL.Utils.stringNull(r("emp002")), .activo = SabLib.BLL.Utils.integerNull(r("emp018"))}, query, CadenaConexion)
        ...
        Public Function loadListTrabajadoresTexto(ByVal plantaAdmin As Integer, ByVal texto As String) As List(Of ELL.Trabajadores)
            ...
            Dim query As String = "Select tra000, tra001, tra013, tra002, tra003  FROM adok_tra  WHERE tra099= " & plantaAdmin & " and (tra012 is null or tra012 <> 1) and (   UPPER(tra003) like UPPER('%" & texto & "%')" & " or UPPER(tra002) like ('%" & texto.ToUpper & "%')" & " ) Order by tra003 "
        ...
        Public Function loadListTrabajadoresTextoNoCad(ByVal plantaAdmin As Integer, ByVal texto As String) As List(Of ELL.Trabajadores)
            ...
            Dim query As String = "Select tra000, tra001, tra013, tra002, tra003  FROM adok_tra  WHERE tra099= " & plantaAdmin & " and (tra012 is null or tra012 <> 1) and (tra006 < to_date('02/01/1900','dd/MM/yyyy') or tra006 is null or tra006 > sysdate)  and (   UPPER(tra003) like UPPER('%" & texto & "%')" & " or UPPER(tra002) like ('%" & texto.ToUpper & "%')" & " ) Order by tra003 "
            ' Dim query As String = "Select tra000, tra001, tra013, tra002, tra003  FROM adok_tra  WHERE tra099= " & plantaAdmin & "  and (   UPPER(tra003) like UPPER('%" & texto & "%')" & " or UPPER(tra002) like UPPER('%" & texto & "%')" & " ) Order by tra003 "
        ...
        End Function
        Public Function loadListTraTextoTotal(ByVal plantaAdmin As Integer, ByVal texto As String) As List(Of ELL.Trabajadores)
            'If plantaAdmin = 230 Then
            '    plantaAdmin = 1
            'End If
        ...
        Public Function loadListTraTexto(ByVal plantaAdmin As Integer, ByVal texto As String) As List(Of ELL.Trabajadores)
            ...
            'este si solo activos Dim query As String = "Select tra000, tra001, tra013, tra002, tra003  FROM adok_tra  WHERE tra099= " & plantaAdmin & " and (tra012 is null or tra012 = 0) and (   UPPER(tra003) like UPPER('%" & texto & "%')" & " or UPPER(tra002) like UPPER('%" & texto & "%')" & " ) Order by tra003 "
            Dim query As String = "Select tra000, tra001, tra013, tra002, tra003  FROM adok_tra  WHERE tra099= " & plantaAdmin & "  and (   UPPER(tra003) like UPPER('%" & texto & "%')" & " or UPPER(tra002) like UPPER('%" & texto & "%')" & " ) and tra006 > sysdate Order by tra003 "
        ...
        Public Function loadListEmpresasTextoXBATNombre(ByVal plantaAdmin As Integer, ByVal texto As String) As List(Of ELL.Empresas)
            ...
            Dim query As String = "select nombre as nomprov, cif from empresas where nombre like '%" & texto & "%' or nombre like '%" & UCase(texto) & "%' and (fechabaja > sysdate or fechabaja is null) and idtroqueleria is not null  and idplanta = " & plantaAdmin & " order by nomprov "
        ...
        Public Function loadListTrabajadoresTexto(ByVal plantaAdmin As Integer, ByVal nombre As String, ByVal apellidos As String) As List(Of ELL.Trabajadores)
            ...
            '    plantaAdmin = 1
            'End If
            Dim query As String = "Select tra000, tra001, tra013,tra004, tra006, tra008, tra002, tra003, tra012  FROM adok_tra  WHERE tra099= " & plantaAdmin & " and UPPER(tra002) like UPPER('%" & Trim(nombre) & "%') And UPPER(tra003) Like UPPER('" & Trim(apellidos) & "') Order by tra003 "
        ...
        Public Function loadListTrabajadoresTextoActivos(ByVal plantaAdmin As Integer, ByVal nombre As String, ByVal apellidos As String) As List(Of ELL.Trabajadores)
            ...
            '    plantaAdmin = 1
            'End If
            Dim query As String = "Select tra000, tra001, tra013, tra002, tra003, tra012  FROM adok_tra  WHERE tra099= " & plantaAdmin & " and (tra012 is null or tra012 <> 1) and UPPER(tra002) like UPPER('%" & Trim(nombre) & "%') And UPPER(tra003) Like UPPER('%" & Trim(apellidos) & "%') Order by tra003 "
        ...
        Public Function loadListTrabajadoresClaveEmp(ByVal plantaAdmin As Integer, ByVal empresa As Integer) As List(Of ELL.Trabajadores)
            ...
            'Else
            query = "Select tra017, tra000, tra001, tra013, tra002, tra003, tra004, tra005, tra006, tra007, tra008, tra012  FROM adok_tra  WHERE tra099= " & plantaAdmin & "  and TRA004 = " & empresa & " order by  tra003 asc"  'and (tra012 is null or tra012 <> 1)  
            'End If

            Return Memcached.OracleDirectAccess.seleccionar(Of ELL.Trabajadores)(Function(r As OracleDataReader) _
                               New ELL.Trabajadores With {.congelado = SabLib.BLL.Utils.integerNull(r("tra017")), .Id = CInt(r("tra000")), .FecFin = SabLib.BLL.Utils.dateTimeNull(r("tra006")), .nDNI = SabLib.BLL.Utils.stringNull(r("tra001")), .tDNI = SabLib.BLL.Utils.stringNull(r("tra013")), .Nombre = SabLib.BLL.Utils.stringNull(r("tra003")) & ", " & SabLib.BLL.Utils.stringNull(r("tra002")), .Empresa = SabLib.BLL.Utils.integerNull(r("tra004")), .activo = SabLib.BLL.Utils.integerNull(r("tra012"))}, query, CadenaConexion)
        ...
        Public Function loadListTrabajadoresClaveEmpSub(ByVal plantaAdmin As Integer, ByVal empresa As String) As List(Of ELL.Trabajadores)
            ...
            'End If
            Dim query As String
            query = "Select tra017, tra000, tra001, tra013, tra002, tra003, tra004, tra005, tra006, tra007, tra008, tra012  FROM adok_tra  WHERE tra099= " & plantaAdmin & " and  TRA004 in (" & empresa & ") order by tra004 asc, tra012 asc, tra003 asc"  'and (tra012 is null or tra012 = 1) 
        ...
        Public Function loadListTrabajadoresClaveEmpTODOS(ByVal plantaAdmin As Integer, ByVal empresa As Integer) As List(Of ELL.Trabajadores)
            ...
            '    query = "Select tra000, tra001, tra013, tra002, tra003, tra004, tra005, tra006, tra007, tra008, tra012  FROM adok_tra  WHERE tra099= " & plantaAdmin & " order by tra012 asc, tra003 asc"  'and (tra012 is null or tra012 = 1) 
            'Else
            query = "Select decode(tra012,0,0,1,3,0) as orden, tra000, tra001, tra013, tra002, tra003, tra004, tra005, tra006, tra007, tra008, tra012  FROM adok_tra  WHERE tra099= " & plantaAdmin & "   and TRA004 = " & empresa & " order by orden asc, tra003 asc"  'and (tra012 is null or tra012 = 1) 
            'End If
        ...
        Public Function loadListTrabajadoresClaveEmpEstado(ByVal plantaAdmin As Integer, ByVal empresa As Integer) As List(Of ELL.Trabajadores)
            ...
            Dim query As String = "Select tra000, tra001, tra013, tra002, tra003, tra004, tra005, tra006, tra007, tra008, tra012  FROM adok_tra  WHERE tra099= " & plantaAdmin & " and (tra012 is null or tra012 <> 1)  and (tra006 < to_date('02/01/1900','dd/MM/yyyy') or tra006 is null or tra006 > sysdate) and TRA004 = " & empresa & " order by  tra003 asc"  ' 
        ...
        Public Function loadListTrabajadoresClaveTraActivos(ByVal plantaAdmin As Integer, ByVal clave As Integer) As List(Of ELL.Trabajadores)
            ...
            '    plantaAdmin = 1
            'End If
            Dim query As String = "Select tra000, tra001, tra013,tra014, tra015, tra002, tra003, tra004, tra005, tra006, tra007, tra008,  tra010,  tra011, tra012, emp021  FROM adok_tra, adok_emp  WHERE adok_tra.tra004 = adok_emp.emp000   and tra099= " & plantaAdmin & " and tra000 = " & clave & " order by tra003 asc"
        ...
        Public Function loadResponsablesNombreMail(ByVal cod As Integer, ByVal plantaAdmin As Integer) As List(Of ELL.Responsables)
            ...
            'Dim query As String = "  Select  email as mail FROM usuarios  WHERE  idempresas = " & cod & " and (fechabaja is null or fechabaja > sysdate) and usuario_empresa = 1 order by email " 'esto hace que coja el de extranet
            Dim query As String = "  Select iddepartamento, apellido1, nombre, email as mail, CODPERSONA  FROM usuarios  WHERE  id = " & cod & "  order by email " 'esto hace que coja el de extranet

            Return Memcached.OracleDirectAccess.seleccionar(Of ELL.Responsables)(Function(r As OracleDataReader) _
                             New ELL.Responsables With {.Abrev = SabLib.BLL.Utils.stringNull(r("iddepartamento")), .Mail = SabLib.BLL.Utils.stringNull(r("mail")), .Id = SabLib.BLL.Utils.integerNull(r("CODPERSONA")), .Nombre = SabLib.BLL.Utils.stringNull(r("apellido1")) & ", " & SabLib.BLL.Utils.stringNull(r("nombre"))}, query, CadenaConexionSAB)
        ...
        Public Function loadListRol(ByVal plantaAdmin As Integer) As List(Of ELL.Rol)
            ...
            Dim query As String = "Select rol000, rol001, decode(rol001, 2, 'Administrador', 3, 'Control de Acceso', 4, 'Financiero', 5, 'RRHH', 22,'Servicio Médico',21, 'Prevención', '')  as nombrerol, rol002  FROM adok_roles  WHERE rol099 = " & plantaAdmin & " order by rol000 desc"
...
:Abrev,  :Periodo, :Obligatorio, :Trabajador, :comentario, :Responsable, :Margen , :Plantilla, 0, :EsDocumento, :listacorreos, :tipotrabajo, :textoSolicitud, :ETT, :area)"
        ...
        Public Function SaveEmp(ByVal docu As ELL.Empresas) As Boolean
            ...
            Try
                query = "INSERT INTO adok_emp (emp099,  emp001, emp002, emp018, emp019, emp022, emp014, emp015) VALUES(:planta,  :cif,  :nombre, 0, :subcontrata, :codigo, :contacto, :telefono)"

                lParameters1.Add(New OracleParameter("planta", OracleDbType.Int32, docu.Planta, ParameterDirection.Input))
                'es autogenerado el de adok el de SAB va a emp011:
                lParameters1.Add(New OracleParameter("codigo", OracleDbType.Int32, 6, docu.empSAB, ParameterDirection.Input))
                lParameters1.Add(New OracleParameter("subcontrata", OracleDbType.Varchar2, docu.subcontrata, ParameterDirection.Input))
                ...
                lParameters1.Add(New OracleParameter("contacto", OracleDbType.Varchar2, 100, Trim(docu.contacto), ParameterDirection.Input))
                lParameters1.Add(New OracleParameter("telefono", OracleDbType.Varchar2, 100, Trim(docu.telefono), ParameterDirection.Input))
        ...
        Public Function SaveUserSABExiste(ByVal docu As ELL.Empresas) As List(Of String())
            ...
            Try
                ...
                NOMBREUSUARIO = Trim(arrNombre(1))
                arrNombre = Split(Trim(arrNombre(0)), " ")
                If arrNombre.Length > 1 Then
                    APELLIDO2 = arrNombre(1)
                End If

                '      query = "INSERT INTO USUARIOS (fechaalta, fechabaja, dni, idplanta, idempresas,  PWD, idculturas, email, NOMBREUSUARIO, usuario_empresa) VALUES(:FecIni, :FecFin, :DNI, :planta, :id, '70504C06',  'es-ES', :email, :email, 0)"
                query = "INSERT INTO USUARIOS (codpersona, fechaalta, fechabaja, dni, idplanta, idempresas,  PWD, idculturas,  NOMBREUSUARIO, usuario_empresa, NOMBRE, APELLIDO1,APELLIDO2,IDDEPARTAMENTO) VALUES(:codpersona, :FecIni, :FecFin, :DNI, :planta, :id, '70504C06',  'es-ES', :NOMBREUSUARIO,  0,:NOMBRE,:APELLIDO1,:APELLIDO2, :IDDEPARTAMENTO)"

                lParameters1.Add(New OracleParameter("codpersona", OracleDbType.Int32, docu.empSAB, ParameterDirection.Input))
                lParameters1.Add(New OracleParameter("planta", OracleDbType.Int32, docu.Planta, ParameterDirection.Input))
                lParameters1.Add(New OracleParameter("id", OracleDbType.Int32, docu.Id, ParameterDirection.Input))
                lParameters1.Add(New OracleParameter("IDDEPARTAMENTO", OracleDbType.Varchar2, 100, docu.medio2, ParameterDirection.Input))
                lParameters1.Add(New OracleParameter("NOMBRE", OracleDbType.Varchar2, 100, Trim(NOMBREUSUARIO), ParameterDirection.Input))
                lParameters1.Add(New OracleParameter("APELLIDO1", OracleDbType.Varchar2, 100, arrNombre(0), ParameterDirection.Input))
                lParameters1.Add(New OracleParameter("APELLIDO2", OracleDbType.Varchar2, 100, APELLIDO2, ParameterDirection.Input))
                lParameters1.Add(New OracleParameter("NOMBREUSUARIO", OracleDbType.Varchar2, 100, "", ParameterDirection.Input))
                'lParameters1.Add(New OracleParameter("email", OracleDbType.Varchar2, 100, Trim(docu.email), ParameterDirection.Input))
        ...
        Public Function SaveUserSABExisteModificar(ByVal docu As ELL.Empresas) As List(Of String())
            ...
            Try
                '      query = "INSERT INTO USUARIOS (fechaalta, fechabaja, dni, idplanta, idempresas,  PWD, idculturas, email, NOMBREUSUARIO, usuario_empresa) VALUES(:FecIni, :FecFin, :DNI, :planta, :id, '70504C06',  'es-ES', :email, :email, 0)"
                query = "UPDATE USUARIOS SET codpersona=:codpersona, fechaalta=:FecIni, fechabaja=:FecFin,   idempresas=:id,  PWD='70504C06', idculturas='es-ES', email=:email  WHERE idplanta=:planta and dni=:dni "
        ...
        Public Function SaveTra(ByVal docu As ELL.Trabajadores) As Boolean
            ...
            Try
                query = "INSERT INTO adok_tra (tra010, tra017, tra099,  tra001, tra013, tra002, tra003, tra004,  tra012, tra008, tra014, tra005, tra006, tra015, tra011, tra007) VALUES(:depto, :congelado, :planta,  :nDNI, :tDNI, :nombre, :apellidos, :Empresa, 0, :responsable, :Solicitud, :FecIni, :FecFin, :Autonomo, :puesto, :funcion)"

                If docu.FecFin = Date.MaxValue Then
                    docu.FecFin = CDate("31/12/" & Now.Year.ToString)
                End If

                lParameters1.Add(New OracleParameter("depto", OracleDbType.Varchar2, 150, Trim(docu.puesto2), ParameterDirection.Input))
                lParameters1.Add(New OracleParameter("congelado", OracleDbType.Int32, docu.congelado, ParameterDirection.Input))
                lParameters1.Add(New OracleParameter("planta", OracleDbType.Int32, docu.Planta, ParameterDirection.Input))
                'es autogenerado       lParameters1.Add(New OracleParameter("codigo", OracleDbType.Int32, 6, docu.Id, ParameterDirection.Input))
                lParameters1.Add(New OracleParameter("nDNI", OracleDbType.Varchar2, 12, Trim(docu.nDNI).ToUpper, ParameterDirection.Input))
                ...
                lParameters1.Add(New OracleParameter("Solicitud", OracleDbType.Varchar2, 150, Trim(docu.solicitud), ParameterDirection.Input))
        ...
        Public Function UpdateTra(ByVal docu As ELL.Trabajadores, ByVal codigo As Int32) As Boolean
            ...
            Try
                ...
                strSql = "UPDATE adok_tra SET tra010=:depto, tra017=:congelado, tra001=:ndni,  tra013=:tdni, tra002=:Nombre, tra003=:Apellidos, tra004=:Empresa, tra005=:FecIni, tra006=:FecFin, tra015=:Autonomo, tra011=:puesto, tra007=:funcion, tra008=:responsable, tra014=:solicitud  WHERE tra000=:codigo And tra099= :planta "
                ...
                Dim lParameters1 As New List(Of OracleParameter)
                lParameters1.Add(New OracleParameter("depto", OracleDbType.Varchar2, 150, docu.puesto2, ParameterDirection.Input))
                lParameters1.Add(New OracleParameter("congelado", OracleDbType.Int32, 1, docu.congelado, ParameterDirection.Input))
        ...
        Public Function BorrarDorlet(ByVal docu As ELL.Dorlet, ByVal codigo As Int32) As Boolean
            Dim resultado As Boolean = False
            Try

                Dim strSql As String = String.Empty

                strSql = "DELETE adok_dorlet  WHERE  ID_DORLET=:codigo And PLANTA= :planta  AND TARJETA_DORLET=:tarjeta"
        ...
        Public Function DeleteRol(ByVal planta As Int32, ByVal codigo As Int32) As Boolean
            ...
            Try
                ...
                query = "DELETE FROM adok_roles WHERE rol099 = " & planta & " and rol000 = " & codigo
        ...
        Public Function UpdateTraDoc(ByVal docu As ELL.TrabajadoresDoc, ByVal chequeado As Int32, ByVal nombre As String) As Boolean
            ...
            Try
                ...
                If chequeado = 3 Then 'actualizamos resto de campos
                    query = "UPDATE adok_trd SET trd013=:tiposCarne, trd011=:autor,   trd003 =:FecRec , trd009 =:Aptitud , trd002 =:estado , trd007 =:periodicidad, trd005 =:FecCad, trd004 =:FecIni, trd012 =:Comentario   WHERE trd099= :planta and trd000=:codtra And trd001=:coddoc "
        ...
        Public Function UpdateTraSol(ByVal docu As ELL.TrabajadoresDoc, ByVal chequeado As Int32, ByVal responsable As Int32) As Boolean
            ...
            Try
                If chequeado = 1 Then
                    'si esta congelado no se inserta
                    'If docu.congelado <> 1 Then
                ...
                If chequeado = 0 Then
                    ...
                    If fechaCad < fechaCadPed Then
                        query = "UPDATE adok_tra SET tra012 = 0, tra006=:fecha, tra008=:responsable where tra099= " & docu.Planta & " AND tra000 = " & docu.codtra
                    ...
                    If no_grabar = 0 Then
                        solicitudes = solicitudes & ";" & docu.coddoc.ToString & ";" ' & docu.Comentario & ";" & fechaCadPed
                        query = "UPDATE adok_tra SET tra014=:solicitudes, tra012 = 0 where tra099= " & docu.Planta & " AND tra000 = " & docu.codtra
        ...
        Public Function UpdateDOSTra(ByVal docu As ELL.Trabajadores) As Boolean
            ...
            Try
                ...
                'actualizamos campo tra012 por desactivar = 1
                query = "UPDATE adok_trd_hist SET trd006 = '' WHERE trd099= :planta and trd008=:id"
        ...
        Public Function LeerTraDoc(ByVal docu As ELL.TrabajadoresDoc) As List(Of ELL.TrabajadoresDoc)
            ...
            Try
                ...
                Dim query As String = "SELECT trd001, trd002, trd003, trd004, trd005, trd006, trd007, trd009, trd011, trd012 FROM adok_trd  WHERE trd001=" & docu.coddoc & " and (trd014 is null or trd014 > sysdate)  and trd000=" & docu.codtra & " And trd099= " & docu.Planta
        ...
        Public Function LeerTraDocHis(ByVal docu As ELL.TrabajadoresDoc) As List(Of ELL.TrabajadoresDoc)
            ...
            Try
                ...
                Dim query As String = " Select  trd006, MAX(trD008) as maxtrD008 FROM adok_trd_hist  WHERE trd002 = 2 and trd001=" & docu.coddoc & " and (trd014 is null or trd014 > sysdate)  and trd000=" & docu.codtra & " And trd099= " & docu.Planta & " and trd006 IS NOT NULL  GROUP BY trd006  order by trd006 desc"
        ...
        Public Function LeerTraDocHisClave(ByVal docu As ELL.TrabajadoresDoc) As List(Of ELL.TrabajadoresDoc)
            ...
            Try
                'mirarlo
                Dim query As String = "SELECT distinct  trd005, trd001, trd002, trd003, trd004, trd006, trd007, trD008, trd011 FROM adok_trd_hist  WHERE trd008=" & docu.clave & " and (trd014 is null or trd014 > sysdate)  and trd006 IS NOT NULL ORDER BY trD008 DESC"
        ...
        Public Function existe(ByVal ID As String) As Integer
            ...
            Try
                Dim query As String = "SELECT COUNT(*) FROM ADOK_ROLES WHERE rol000=:id"
