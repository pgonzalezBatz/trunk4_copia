...
Partial Class KeyBoardForm
    Inherits AvisoModal.NoActivate.NoActivateWindow
    ...
    Private Sub InitializeComponent()
        Me.keyButtonUp = New AvisoModal.KeyButton()
        Me.keyButtonRControl = New AvisoModal.KeyButton()
        Me.keyButtonProcess = New AvisoModal.KeyButton()
        Me.keyButtonOpenBrackets = New AvisoModal.KeyButton()
        Me.keyButtonF10 = New AvisoModal.KeyButton()
        Me.keyButtonD0 = New AvisoModal.KeyButton()
        Me.keyButtonRight = New AvisoModal.KeyButton()
        Me.keyButtonRShift = New AvisoModal.KeyButton()
        Me.keyButtonReturn = New AvisoModal.KeyButton()
        Me.keyButtonDelete = New AvisoModal.KeyButton()
        Me.keyButtonScrollLock = New AvisoModal.KeyButton()
        Me.keyButtonPause = New AvisoModal.KeyButton()
        Me.keyButtonPageDown = New AvisoModal.KeyButton()
        Me.keyButtonPageUp = New AvisoModal.KeyButton()
        Me.keyButtonPrintScreen = New AvisoModal.KeyButton()
        Me.keyButtonInsert = New AvisoModal.KeyButton()
        Me.keyButtonEnd = New AvisoModal.KeyButton()
        Me.keyButtonHome = New AvisoModal.KeyButton()
        Me.keyButtonBack = New AvisoModal.KeyButton()
        Me.keyButtonDown = New AvisoModal.KeyButton()
        Me.keyButtonOemPipe = New AvisoModal.KeyButton()
        Me.keyButtonPlus = New AvisoModal.KeyButton()
        Me.keyButtonLeft = New AvisoModal.KeyButton()
        Me.keyButtonCloseBrackets = New AvisoModal.KeyButton()
        Me.keyButtonMinus = New AvisoModal.KeyButton()
        Me.keyButtonApps = New AvisoModal.KeyButton()
        Me.keyButtonQuestion = New AvisoModal.KeyButton()
        Me.keyButtonSemicolon = New AvisoModal.KeyButton()
        Me.keyButtonP = New AvisoModal.KeyButton()
        Me.keyButtonF9 = New AvisoModal.KeyButton()
        Me.keyButtonD9 = New AvisoModal.KeyButton()
        Me.keyButtonRAlt = New AvisoModal.KeyButton()
        Me.keyButtonPeriod = New AvisoModal.KeyButton()
        Me.keyButtonL = New AvisoModal.KeyButton()
        Me.keyButtonO = New AvisoModal.KeyButton()
        Me.keyButtonSubtract = New AvisoModal.KeyButton()
        Me.keyButtonMultiply = New AvisoModal.KeyButton()
        Me.keyButtonDivide = New AvisoModal.KeyButton()
        Me.keyButtonF8 = New AvisoModal.KeyButton()
        Me.keyButtonD8 = New AvisoModal.KeyButton()
        Me.keyButtonComma = New AvisoModal.KeyButton()
        Me.keyButtonK = New AvisoModal.KeyButton()
        Me.keyButtonI = New AvisoModal.KeyButton()
        Me.keyButtonAdd = New AvisoModal.KeyButton()
        Me.keyButtonNumberPad3 = New AvisoModal.KeyButton()
        Me.keyButtonNumberPad6 = New AvisoModal.KeyButton()
        Me.keyButtonNumberPad9 = New AvisoModal.KeyButton()
        Me.keyButtonF7 = New AvisoModal.KeyButton()
        Me.keyButtonD7 = New AvisoModal.KeyButton()
        Me.keyButtonM = New AvisoModal.KeyButton()
        Me.keyButtonJ = New AvisoModal.KeyButton()
        Me.keyButtonU = New AvisoModal.KeyButton()
        Me.keyButtonNumLock = New AvisoModal.KeyButton()
        Me.keyButtonDecimal = New AvisoModal.KeyButton()
        Me.keyButtonNumberPad2 = New AvisoModal.KeyButton()
        Me.keyButtonNumberPad5 = New AvisoModal.KeyButton()
        Me.keyButtonNumberPad8 = New AvisoModal.KeyButton()
        Me.keyButtonF6 = New AvisoModal.KeyButton()
        Me.keyButtonD6 = New AvisoModal.KeyButton()
        Me.keyButtonN = New AvisoModal.KeyButton()
        Me.keyButtonH = New AvisoModal.KeyButton()
        Me.keyButtonY = New AvisoModal.KeyButton()
        Me.keyButtonNumReturn = New AvisoModal.KeyButton()
        Me.keyButtonNumberPad0 = New AvisoModal.KeyButton()
        Me.keyButtonNumberPad1 = New AvisoModal.KeyButton()
        Me.keyButtonNumberPad4 = New AvisoModal.KeyButton()
        Me.keyButtonNumberPad7 = New AvisoModal.KeyButton()
        Me.keyButtonF5 = New AvisoModal.KeyButton()
        Me.keyButtonD5 = New AvisoModal.KeyButton()
        Me.keyButtonB = New AvisoModal.KeyButton()
        Me.keyButtonG = New AvisoModal.KeyButton()
        Me.keyButtonT = New AvisoModal.KeyButton()
        Me.keyButtonF4 = New AvisoModal.KeyButton()
        Me.keyButtonD4 = New AvisoModal.KeyButton()
        Me.keyButtonV = New AvisoModal.KeyButton()
        Me.keyButtonF = New AvisoModal.KeyButton()
        Me.keyButtonR = New AvisoModal.KeyButton()
        Me.keyButtonF3 = New AvisoModal.KeyButton()
        Me.keyButtonD3 = New AvisoModal.KeyButton()
        Me.keyButtonSpace = New AvisoModal.KeyButton()
        Me.keyButtonC = New AvisoModal.KeyButton()
        Me.keyButtonD = New AvisoModal.KeyButton()
        Me.keyButtonE = New AvisoModal.KeyButton()
        Me.keyButtonF12 = New AvisoModal.KeyButton()
        Me.keyButtonF2 = New AvisoModal.KeyButton()
        Me.keyButtonD2 = New AvisoModal.KeyButton()
        Me.keyButtonLAlt = New AvisoModal.KeyButton()
        Me.keyButtonX = New AvisoModal.KeyButton()
        Me.keyButtonS = New AvisoModal.KeyButton()
        Me.keyButtonW = New AvisoModal.KeyButton()
        Me.keyButtonF11 = New AvisoModal.KeyButton()
        Me.keyButtonF1 = New AvisoModal.KeyButton()
        Me.keyButtonD1 = New AvisoModal.KeyButton()
        Me.keyButtonWin = New AvisoModal.KeyButton()
        Me.keyButtonZ = New AvisoModal.KeyButton()
        Me.keyButtonA = New AvisoModal.KeyButton()
        Me.keyButtonQ = New AvisoModal.KeyButton()
        Me.keyButtonTilde = New AvisoModal.KeyButton()
        Me.keyButtonLControl = New AvisoModal.KeyButton()
        Me.keyButtonLShift = New AvisoModal.KeyButton()
        Me.keyButtonCapsLock = New AvisoModal.KeyButton()
        Me.keyButtonTab = New AvisoModal.KeyButton()
        Me.keyButtonEscape = New AvisoModal.KeyButton()
    ...
    End Sub
    Private WithEvents keyButtonUp As AvisoModal.KeyButton
    Private WithEvents keyButtonRControl As AvisoModal.KeyButton
    Private WithEvents keyButtonProcess As AvisoModal.KeyButton
    Private WithEvents keyButtonOpenBrackets As AvisoModal.KeyButton
    Private WithEvents keyButtonF10 As AvisoModal.KeyButton
    Private WithEvents keyButtonD0 As AvisoModal.KeyButton
    Private WithEvents keyButtonRight As AvisoModal.KeyButton
    Private WithEvents keyButtonRShift As AvisoModal.KeyButton
    Private WithEvents keyButtonReturn As AvisoModal.KeyButton
    Private WithEvents keyButtonDelete As AvisoModal.KeyButton
    Private WithEvents keyButtonScrollLock As AvisoModal.KeyButton
    Private WithEvents keyButtonPause As AvisoModal.KeyButton
    Private WithEvents keyButtonPageDown As AvisoModal.KeyButton
    Private WithEvents keyButtonPageUp As AvisoModal.KeyButton
    Private WithEvents keyButtonPrintScreen As AvisoModal.KeyButton
    Private WithEvents keyButtonInsert As AvisoModal.KeyButton
    Private WithEvents keyButtonEnd As AvisoModal.KeyButton
    Private WithEvents keyButtonHome As AvisoModal.KeyButton
    Private WithEvents keyButtonBack As AvisoModal.KeyButton
    Private WithEvents keyButtonDown As AvisoModal.KeyButton
    Private WithEvents keyButtonOemPipe As AvisoModal.KeyButton
    Private WithEvents keyButtonPlus As AvisoModal.KeyButton
    Private WithEvents keyButtonLeft As AvisoModal.KeyButton
    Private WithEvents keyButtonCloseBrackets As AvisoModal.KeyButton
    Private WithEvents keyButtonMinus As AvisoModal.KeyButton
    Private WithEvents keyButtonApps As AvisoModal.KeyButton
    Private WithEvents keyButtonQuestion As AvisoModal.KeyButton
    Private WithEvents keyButtonSemicolon As AvisoModal.KeyButton
    Private WithEvents keyButtonP As AvisoModal.KeyButton
    Private WithEvents keyButtonF9 As AvisoModal.KeyButton
    Private WithEvents keyButtonD9 As AvisoModal.KeyButton
    Private WithEvents keyButtonRAlt As AvisoModal.KeyButton
    Private WithEvents keyButtonPeriod As AvisoModal.KeyButton
    Private WithEvents keyButtonL As AvisoModal.KeyButton
    Private WithEvents keyButtonO As AvisoModal.KeyButton
    Private WithEvents keyButtonSubtract As AvisoModal.KeyButton
    Private WithEvents keyButtonMultiply As AvisoModal.KeyButton
    Private WithEvents keyButtonDivide As AvisoModal.KeyButton
    Private WithEvents keyButtonF8 As AvisoModal.KeyButton
    Private WithEvents keyButtonD8 As AvisoModal.KeyButton
    Private WithEvents keyButtonComma As AvisoModal.KeyButton
    Private WithEvents keyButtonK As AvisoModal.KeyButton
    Private WithEvents keyButtonI As AvisoModal.KeyButton
    Private WithEvents keyButtonAdd As AvisoModal.KeyButton
    Private WithEvents keyButtonNumberPad3 As AvisoModal.KeyButton
    Private WithEvents keyButtonNumberPad6 As AvisoModal.KeyButton
    Private WithEvents keyButtonNumberPad9 As AvisoModal.KeyButton
    Private WithEvents keyButtonF7 As AvisoModal.KeyButton
    Private WithEvents keyButtonD7 As AvisoModal.KeyButton
    Private WithEvents keyButtonM As AvisoModal.KeyButton
    Private WithEvents keyButtonJ As AvisoModal.KeyButton
    Private WithEvents keyButtonU As AvisoModal.KeyButton
    Private WithEvents keyButtonNumLock As AvisoModal.KeyButton
    Private WithEvents keyButtonDecimal As AvisoModal.KeyButton
    Private WithEvents keyButtonNumberPad2 As AvisoModal.KeyButton
    Private WithEvents keyButtonNumberPad5 As AvisoModal.KeyButton
    Private WithEvents keyButtonNumberPad8 As AvisoModal.KeyButton
    Private WithEvents keyButtonF6 As AvisoModal.KeyButton
    Private WithEvents keyButtonD6 As AvisoModal.KeyButton
    Private WithEvents keyButtonN As AvisoModal.KeyButton
    Private WithEvents keyButtonH As AvisoModal.KeyButton
    Private WithEvents keyButtonY As AvisoModal.KeyButton
    Private WithEvents keyButtonNumReturn As AvisoModal.KeyButton
    Private WithEvents keyButtonNumberPad0 As AvisoModal.KeyButton
    Private WithEvents keyButtonNumberPad1 As AvisoModal.KeyButton
    Private WithEvents keyButtonNumberPad4 As AvisoModal.KeyButton
    Private WithEvents keyButtonNumberPad7 As AvisoModal.KeyButton
    Private WithEvents keyButtonF5 As AvisoModal.KeyButton
    Private WithEvents keyButtonD5 As AvisoModal.KeyButton
    Private WithEvents keyButtonB As AvisoModal.KeyButton
    Private WithEvents keyButtonG As AvisoModal.KeyButton
    Private WithEvents keyButtonT As AvisoModal.KeyButton
    Private WithEvents keyButtonF4 As AvisoModal.KeyButton
    Private WithEvents keyButtonD4 As AvisoModal.KeyButton
    Private WithEvents keyButtonV As AvisoModal.KeyButton
    Private WithEvents keyButtonF As AvisoModal.KeyButton
    Private WithEvents keyButtonR As AvisoModal.KeyButton
    Private WithEvents keyButtonF3 As AvisoModal.KeyButton
    Private WithEvents keyButtonD3 As AvisoModal.KeyButton
    Private WithEvents keyButtonSpace As AvisoModal.KeyButton
    Private WithEvents keyButtonC As AvisoModal.KeyButton
    Private WithEvents keyButtonD As AvisoModal.KeyButton
    Private WithEvents keyButtonE As AvisoModal.KeyButton
    Private WithEvents keyButtonF12 As AvisoModal.KeyButton
    Private WithEvents keyButtonF2 As AvisoModal.KeyButton
    Private WithEvents keyButtonD2 As AvisoModal.KeyButton
    Private WithEvents keyButtonLAlt As AvisoModal.KeyButton
    Private WithEvents keyButtonX As AvisoModal.KeyButton
    Private WithEvents keyButtonS As AvisoModal.KeyButton
    Private WithEvents keyButtonW As AvisoModal.KeyButton
    Private WithEvents keyButtonF11 As AvisoModal.KeyButton
    Private WithEvents keyButtonF1 As AvisoModal.KeyButton
    Private WithEvents keyButtonD1 As AvisoModal.KeyButton
    Private WithEvents keyButtonWin As AvisoModal.KeyButton
    Private WithEvents keyButtonZ As AvisoModal.KeyButton
    Private WithEvents keyButtonA As AvisoModal.KeyButton
    Private WithEvents keyButtonQ As AvisoModal.KeyButton
    Private WithEvents keyButtonTilde As AvisoModal.KeyButton
    Private WithEvents keyButtonLControl As AvisoModal.KeyButton
    Private WithEvents keyButtonLShift As AvisoModal.KeyButton
    Private WithEvents keyButtonCapsLock As AvisoModal.KeyButton
    Private WithEvents keyButtonTab As AvisoModal.KeyButton
    Private WithEvents keyButtonEscape As AvisoModal.KeyButton
