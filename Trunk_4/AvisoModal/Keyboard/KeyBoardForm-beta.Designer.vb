...
Partial Class KeyBoardForm
    ...
    End Sub
    Private WithEvents keyButtonUp As KeyButton
    Private WithEvents keyButtonRControl As KeyButton
    Private WithEvents keyButtonProcess As KeyButton
    Private WithEvents keyButtonOpenBrackets As KeyButton
    Private WithEvents keyButtonF10 As KeyButton
    Private WithEvents keyButtonD0 As KeyButton
    Private WithEvents keyButtonRight As KeyButton
    Private WithEvents keyButtonRShift As KeyButton
    Private WithEvents keyButtonReturn As KeyButton
    Private WithEvents keyButtonDelete As KeyButton
    Private WithEvents keyButtonScrollLock As KeyButton
    Private WithEvents keyButtonPause As KeyButton
    Private WithEvents keyButtonPageDown As KeyButton
    Private WithEvents keyButtonPageUp As KeyButton
    Private WithEvents keyButtonPrintScreen As KeyButton
    Private WithEvents keyButtonInsert As KeyButton
    Private WithEvents keyButtonEnd As KeyButton
    Private WithEvents keyButtonHome As KeyButton
    Private WithEvents keyButtonBack As KeyButton
    Private WithEvents keyButtonDown As KeyButton
    Private WithEvents keyButtonOemPipe As KeyButton
    Private WithEvents keyButtonPlus As KeyButton
    Private WithEvents keyButtonLeft As KeyButton
    Private WithEvents keyButtonCloseBrackets As KeyButton
    Private WithEvents keyButtonMinus As KeyButton
    Private WithEvents keyButtonApps As KeyButton
    Private WithEvents keyButtonQuestion As KeyButton
    Private WithEvents keyButtonSemicolon As KeyButton
    Private WithEvents keyButtonP As KeyButton
    Private WithEvents keyButtonF9 As KeyButton
    Private WithEvents keyButtonD9 As KeyButton
    Private WithEvents keyButtonRAlt As KeyButton
    Private WithEvents keyButtonPeriod As KeyButton
    Private WithEvents keyButtonL As KeyButton
    Private WithEvents keyButtonO As KeyButton
    Private WithEvents keyButtonSubtract As KeyButton
    Private WithEvents keyButtonMultiply As KeyButton
    Private WithEvents keyButtonDivide As KeyButton
    Private WithEvents keyButtonF8 As KeyButton
    Private WithEvents keyButtonD8 As KeyButton
    Private WithEvents keyButtonComma As KeyButton
    Private WithEvents keyButtonK As KeyButton
    Private WithEvents keyButtonI As KeyButton
    Private WithEvents keyButtonAdd As KeyButton
    Private WithEvents keyButtonNumberPad3 As KeyButton
    Private WithEvents keyButtonNumberPad6 As KeyButton
    Private WithEvents keyButtonNumberPad9 As KeyButton
    Private WithEvents keyButtonF7 As KeyButton
    Private WithEvents keyButtonD7 As KeyButton
    Private WithEvents keyButtonM As KeyButton
    Private WithEvents keyButtonJ As KeyButton
    Private WithEvents keyButtonU As KeyButton
    Private WithEvents keyButtonNumLock As KeyButton
    Private WithEvents keyButtonDecimal As KeyButton
    Private WithEvents keyButtonNumberPad2 As KeyButton
    Private WithEvents keyButtonNumberPad5 As KeyButton
    Private WithEvents keyButtonNumberPad8 As KeyButton
    Private WithEvents keyButtonF6 As KeyButton
    Private WithEvents keyButtonD6 As KeyButton
    Private WithEvents keyButtonN As KeyButton
    Private WithEvents keyButtonH As KeyButton
    Private WithEvents keyButtonY As KeyButton
    Private WithEvents keyButtonNumReturn As KeyButton
    Private WithEvents keyButtonNumberPad0 As KeyButton
    Private WithEvents keyButtonNumberPad1 As KeyButton
    Private WithEvents keyButtonNumberPad4 As KeyButton
    Private WithEvents keyButtonNumberPad7 As KeyButton
    Private WithEvents keyButtonF5 As KeyButton
    Private WithEvents keyButtonD5 As KeyButton
    Private WithEvents keyButtonB As KeyButton
    Private WithEvents keyButtonG As KeyButton
    Private WithEvents keyButtonT As KeyButton
    Private WithEvents keyButtonF4 As KeyButton
    Private WithEvents keyButtonD4 As KeyButton
    Private WithEvents keyButtonV As KeyButton
    Private WithEvents keyButtonF As KeyButton
    Private WithEvents keyButtonR As KeyButton
    Private WithEvents keyButtonF3 As KeyButton
    Private WithEvents keyButtonD3 As KeyButton
    Private WithEvents keyButtonSpace As KeyButton
    Private WithEvents keyButtonC As KeyButton
    Private WithEvents keyButtonD As KeyButton
    Private WithEvents keyButtonE As KeyButton
    Private WithEvents keyButtonF12 As KeyButton
    Private WithEvents keyButtonF2 As KeyButton
    Private WithEvents keyButtonD2 As KeyButton
    Private WithEvents keyButtonLAlt As KeyButton
    Private WithEvents keyButtonX As KeyButton
    Private WithEvents keyButtonS As KeyButton
    Private WithEvents keyButtonW As KeyButton
    Private WithEvents keyButtonF11 As KeyButton
    Private WithEvents keyButtonF1 As KeyButton
    Private WithEvents keyButtonD1 As KeyButton
    Private WithEvents keyButtonWin As KeyButton
    Private WithEvents keyButtonZ As KeyButton
    Private WithEvents keyButtonA As KeyButton
    Private WithEvents keyButtonQ As KeyButton
    Private WithEvents keyButtonTilde As KeyButton
    Private WithEvents keyButtonLControl As KeyButton
    Private WithEvents keyButtonLShift As KeyButton
    Private WithEvents keyButtonCapsLock As KeyButton
    Private WithEvents keyButtonTab As KeyButton
    Private WithEvents keyButtonEscape As KeyButton
