Public Class frmLogin
    ...
    Dim mensaje2 As String = "Quedan menos de 10 piezas para terminar el lote... Recuerda que debes hacer TRES LECTURAS CORRECTAS con la pistola antes de cambiar de contenedor"
    Dim mensaje3 As String = "Has cambiado de contenedor pero aún no tienes las TRES LECTURAS CORRECTAS correspondientes al primer contenedor del lote..."
...
#Region "Carga del formulario"
    ...
    Public Sub Inicializar()
        ...
        'Traduccion()
        labelMensaje.Text = If(Modulo.Flag = 0, mensaje1, If(Modulo.Flag = 1, mensaje2, mensaje3))
    End Sub
