...
Partial Class KeyBoardForm
    Inherits AvisoForm.NoActivate.NoActivateWindow
    ...
    Private Sub InitializeComponent()
        Me.keyButtonUp = New AvisoForm.KeyButton()
        Me.keyButtonRControl = New AvisoForm.KeyButton()
        Me.keyButtonProcess = New AvisoForm.KeyButton()
        Me.keyButtonOpenBrackets = New AvisoForm.KeyButton()
        Me.keyButtonF10 = New AvisoForm.KeyButton()
        Me.keyButtonD0 = New AvisoForm.KeyButton()
        Me.keyButtonRight = New AvisoForm.KeyButton()
        Me.keyButtonRShift = New AvisoForm.KeyButton()
        Me.keyButtonReturn = New AvisoForm.KeyButton()
        Me.keyButtonDelete = New AvisoForm.KeyButton()
        Me.keyButtonScrollLock = New AvisoForm.KeyButton()
        Me.keyButtonPause = New AvisoForm.KeyButton()
        Me.keyButtonPageDown = New AvisoForm.KeyButton()
        Me.keyButtonPageUp = New AvisoForm.KeyButton()
        Me.keyButtonPrintScreen = New AvisoForm.KeyButton()
        Me.keyButtonInsert = New AvisoForm.KeyButton()
        Me.keyButtonEnd = New AvisoForm.KeyButton()
        Me.keyButtonHome = New AvisoForm.KeyButton()
        Me.keyButtonBack = New AvisoForm.KeyButton()
        Me.keyButtonDown = New AvisoForm.KeyButton()
        Me.keyButtonOemPipe = New AvisoForm.KeyButton()
        Me.keyButtonPlus = New AvisoForm.KeyButton()
        Me.keyButtonLeft = New AvisoForm.KeyButton()
        Me.keyButtonCloseBrackets = New AvisoForm.KeyButton()
        Me.keyButtonMinus = New AvisoForm.KeyButton()
        Me.keyButtonApps = New AvisoForm.KeyButton()
        Me.keyButtonQuestion = New AvisoForm.KeyButton()
        Me.keyButtonSemicolon = New AvisoForm.KeyButton()
        Me.keyButtonP = New AvisoForm.KeyButton()
        Me.keyButtonF9 = New AvisoForm.KeyButton()
        Me.keyButtonD9 = New AvisoForm.KeyButton()
        Me.keyButtonRAlt = New AvisoForm.KeyButton()
        Me.keyButtonPeriod = New AvisoForm.KeyButton()
        Me.keyButtonL = New AvisoForm.KeyButton()
        Me.keyButtonO = New AvisoForm.KeyButton()
        Me.keyButtonSubtract = New AvisoForm.KeyButton()
        Me.keyButtonMultiply = New AvisoForm.KeyButton()
        Me.keyButtonDivide = New AvisoForm.KeyButton()
        Me.keyButtonF8 = New AvisoForm.KeyButton()
        Me.keyButtonD8 = New AvisoForm.KeyButton()
        Me.keyButtonComma = New AvisoForm.KeyButton()
        Me.keyButtonK = New AvisoForm.KeyButton()
        Me.keyButtonI = New AvisoForm.KeyButton()
        Me.keyButtonAdd = New AvisoForm.KeyButton()
        Me.keyButtonNumberPad3 = New AvisoForm.KeyButton()
        Me.keyButtonNumberPad6 = New AvisoForm.KeyButton()
        Me.keyButtonNumberPad9 = New AvisoForm.KeyButton()
        Me.keyButtonF7 = New AvisoForm.KeyButton()
        Me.keyButtonD7 = New AvisoForm.KeyButton()
        Me.keyButtonM = New AvisoForm.KeyButton()
        Me.keyButtonJ = New AvisoForm.KeyButton()
        Me.keyButtonU = New AvisoForm.KeyButton()
        Me.keyButtonNumLock = New AvisoForm.KeyButton()
        Me.keyButtonDecimal = New AvisoForm.KeyButton()
        Me.keyButtonNumberPad2 = New AvisoForm.KeyButton()
        Me.keyButtonNumberPad5 = New AvisoForm.KeyButton()
        Me.keyButtonNumberPad8 = New AvisoForm.KeyButton()
        Me.keyButtonF6 = New AvisoForm.KeyButton()
        Me.keyButtonD6 = New AvisoForm.KeyButton()
        Me.keyButtonN = New AvisoForm.KeyButton()
        Me.keyButtonH = New AvisoForm.KeyButton()
        Me.keyButtonY = New AvisoForm.KeyButton()
        Me.keyButtonNumReturn = New AvisoForm.KeyButton()
        Me.keyButtonNumberPad0 = New AvisoForm.KeyButton()
        Me.keyButtonNumberPad1 = New AvisoForm.KeyButton()
        Me.keyButtonNumberPad4 = New AvisoForm.KeyButton()
        Me.keyButtonNumberPad7 = New AvisoForm.KeyButton()
        Me.keyButtonF5 = New AvisoForm.KeyButton()
        Me.keyButtonD5 = New AvisoForm.KeyButton()
        Me.keyButtonB = New AvisoForm.KeyButton()
        Me.keyButtonG = New AvisoForm.KeyButton()
        Me.keyButtonT = New AvisoForm.KeyButton()
        Me.keyButtonF4 = New AvisoForm.KeyButton()
        Me.keyButtonD4 = New AvisoForm.KeyButton()
        Me.keyButtonV = New AvisoForm.KeyButton()
        Me.keyButtonF = New AvisoForm.KeyButton()
        Me.keyButtonR = New AvisoForm.KeyButton()
        Me.keyButtonF3 = New AvisoForm.KeyButton()
        Me.keyButtonD3 = New AvisoForm.KeyButton()
        Me.keyButtonSpace = New AvisoForm.KeyButton()
        Me.keyButtonC = New AvisoForm.KeyButton()
        Me.keyButtonD = New AvisoForm.KeyButton()
        Me.keyButtonE = New AvisoForm.KeyButton()
        Me.keyButtonF12 = New AvisoForm.KeyButton()
        Me.keyButtonF2 = New AvisoForm.KeyButton()
        Me.keyButtonD2 = New AvisoForm.KeyButton()
        Me.keyButtonLAlt = New AvisoForm.KeyButton()
        Me.keyButtonX = New AvisoForm.KeyButton()
        Me.keyButtonS = New AvisoForm.KeyButton()
        Me.keyButtonW = New AvisoForm.KeyButton()
        Me.keyButtonF11 = New AvisoForm.KeyButton()
        Me.keyButtonF1 = New AvisoForm.KeyButton()
        Me.keyButtonD1 = New AvisoForm.KeyButton()
        Me.keyButtonWin = New AvisoForm.KeyButton()
        Me.keyButtonZ = New AvisoForm.KeyButton()
        Me.keyButtonA = New AvisoForm.KeyButton()
        Me.keyButtonQ = New AvisoForm.KeyButton()
        Me.keyButtonTilde = New AvisoForm.KeyButton()
        Me.keyButtonLControl = New AvisoForm.KeyButton()
        Me.keyButtonLShift = New AvisoForm.KeyButton()
        Me.keyButtonCapsLock = New AvisoForm.KeyButton()
        Me.keyButtonTab = New AvisoForm.KeyButton()
        Me.keyButtonEscape = New AvisoForm.KeyButton()
    ...
    End Sub
    Private WithEvents keyButtonUp As AvisoForm.KeyButton
    Private WithEvents keyButtonRControl As AvisoForm.KeyButton
    Private WithEvents keyButtonProcess As AvisoForm.KeyButton
    Private WithEvents keyButtonOpenBrackets As AvisoForm.KeyButton
    Private WithEvents keyButtonF10 As AvisoForm.KeyButton
    Private WithEvents keyButtonD0 As AvisoForm.KeyButton
    Private WithEvents keyButtonRight As AvisoForm.KeyButton
    Private WithEvents keyButtonRShift As AvisoForm.KeyButton
    Private WithEvents keyButtonReturn As AvisoForm.KeyButton
    Private WithEvents keyButtonDelete As AvisoForm.KeyButton
    Private WithEvents keyButtonScrollLock As AvisoForm.KeyButton
    Private WithEvents keyButtonPause As AvisoForm.KeyButton
    Private WithEvents keyButtonPageDown As AvisoForm.KeyButton
    Private WithEvents keyButtonPageUp As AvisoForm.KeyButton
    Private WithEvents keyButtonPrintScreen As AvisoForm.KeyButton
    Private WithEvents keyButtonInsert As AvisoForm.KeyButton
    Private WithEvents keyButtonEnd As AvisoForm.KeyButton
    Private WithEvents keyButtonHome As AvisoForm.KeyButton
    Private WithEvents keyButtonBack As AvisoForm.KeyButton
    Private WithEvents keyButtonDown As AvisoForm.KeyButton
    Private WithEvents keyButtonOemPipe As AvisoForm.KeyButton
    Private WithEvents keyButtonPlus As AvisoForm.KeyButton
    Private WithEvents keyButtonLeft As AvisoForm.KeyButton
    Private WithEvents keyButtonCloseBrackets As AvisoForm.KeyButton
    Private WithEvents keyButtonMinus As AvisoForm.KeyButton
    Private WithEvents keyButtonApps As AvisoForm.KeyButton
    Private WithEvents keyButtonQuestion As AvisoForm.KeyButton
    Private WithEvents keyButtonSemicolon As AvisoForm.KeyButton
    Private WithEvents keyButtonP As AvisoForm.KeyButton
    Private WithEvents keyButtonF9 As AvisoForm.KeyButton
    Private WithEvents keyButtonD9 As AvisoForm.KeyButton
    Private WithEvents keyButtonRAlt As AvisoForm.KeyButton
    Private WithEvents keyButtonPeriod As AvisoForm.KeyButton
    Private WithEvents keyButtonL As AvisoForm.KeyButton
    Private WithEvents keyButtonO As AvisoForm.KeyButton
    Private WithEvents keyButtonSubtract As AvisoForm.KeyButton
    Private WithEvents keyButtonMultiply As AvisoForm.KeyButton
    Private WithEvents keyButtonDivide As AvisoForm.KeyButton
    Private WithEvents keyButtonF8 As AvisoForm.KeyButton
    Private WithEvents keyButtonD8 As AvisoForm.KeyButton
    Private WithEvents keyButtonComma As AvisoForm.KeyButton
    Private WithEvents keyButtonK As AvisoForm.KeyButton
    Private WithEvents keyButtonI As AvisoForm.KeyButton
    Private WithEvents keyButtonAdd As AvisoForm.KeyButton
    Private WithEvents keyButtonNumberPad3 As AvisoForm.KeyButton
    Private WithEvents keyButtonNumberPad6 As AvisoForm.KeyButton
    Private WithEvents keyButtonNumberPad9 As AvisoForm.KeyButton
    Private WithEvents keyButtonF7 As AvisoForm.KeyButton
    Private WithEvents keyButtonD7 As AvisoForm.KeyButton
    Private WithEvents keyButtonM As AvisoForm.KeyButton
    Private WithEvents keyButtonJ As AvisoForm.KeyButton
    Private WithEvents keyButtonU As AvisoForm.KeyButton
    Private WithEvents keyButtonNumLock As AvisoForm.KeyButton
    Private WithEvents keyButtonDecimal As AvisoForm.KeyButton
    Private WithEvents keyButtonNumberPad2 As AvisoForm.KeyButton
    Private WithEvents keyButtonNumberPad5 As AvisoForm.KeyButton
    Private WithEvents keyButtonNumberPad8 As AvisoForm.KeyButton
    Private WithEvents keyButtonF6 As AvisoForm.KeyButton
    Private WithEvents keyButtonD6 As AvisoForm.KeyButton
    Private WithEvents keyButtonN As AvisoForm.KeyButton
    Private WithEvents keyButtonH As AvisoForm.KeyButton
    Private WithEvents keyButtonY As AvisoForm.KeyButton
    Private WithEvents keyButtonNumReturn As AvisoForm.KeyButton
    Private WithEvents keyButtonNumberPad0 As AvisoForm.KeyButton
    Private WithEvents keyButtonNumberPad1 As AvisoForm.KeyButton
    Private WithEvents keyButtonNumberPad4 As AvisoForm.KeyButton
    Private WithEvents keyButtonNumberPad7 As AvisoForm.KeyButton
    Private WithEvents keyButtonF5 As AvisoForm.KeyButton
    Private WithEvents keyButtonD5 As AvisoForm.KeyButton
    Private WithEvents keyButtonB As AvisoForm.KeyButton
    Private WithEvents keyButtonG As AvisoForm.KeyButton
    Private WithEvents keyButtonT As AvisoForm.KeyButton
    Private WithEvents keyButtonF4 As AvisoForm.KeyButton
    Private WithEvents keyButtonD4 As AvisoForm.KeyButton
    Private WithEvents keyButtonV As AvisoForm.KeyButton
    Private WithEvents keyButtonF As AvisoForm.KeyButton
    Private WithEvents keyButtonR As AvisoForm.KeyButton
    Private WithEvents keyButtonF3 As AvisoForm.KeyButton
    Private WithEvents keyButtonD3 As AvisoForm.KeyButton
    Private WithEvents keyButtonSpace As AvisoForm.KeyButton
    Private WithEvents keyButtonC As AvisoForm.KeyButton
    Private WithEvents keyButtonD As AvisoForm.KeyButton
    Private WithEvents keyButtonE As AvisoForm.KeyButton
    Private WithEvents keyButtonF12 As AvisoForm.KeyButton
    Private WithEvents keyButtonF2 As AvisoForm.KeyButton
    Private WithEvents keyButtonD2 As AvisoForm.KeyButton
    Private WithEvents keyButtonLAlt As AvisoForm.KeyButton
    Private WithEvents keyButtonX As AvisoForm.KeyButton
    Private WithEvents keyButtonS As AvisoForm.KeyButton
    Private WithEvents keyButtonW As AvisoForm.KeyButton
    Private WithEvents keyButtonF11 As AvisoForm.KeyButton
    Private WithEvents keyButtonF1 As AvisoForm.KeyButton
    Private WithEvents keyButtonD1 As AvisoForm.KeyButton
    Private WithEvents keyButtonWin As AvisoForm.KeyButton
    Private WithEvents keyButtonZ As AvisoForm.KeyButton
    Private WithEvents keyButtonA As AvisoForm.KeyButton
    Private WithEvents keyButtonQ As AvisoForm.KeyButton
    Private WithEvents keyButtonTilde As AvisoForm.KeyButton
    Private WithEvents keyButtonLControl As AvisoForm.KeyButton
    Private WithEvents keyButtonLShift As AvisoForm.KeyButton
    Private WithEvents keyButtonCapsLock As AvisoForm.KeyButton
    Private WithEvents keyButtonTab As AvisoForm.KeyButton
    Private WithEvents keyButtonEscape As AvisoForm.KeyButton
