...
Public MustInherit Class _RECURSOSADMINISTRADORES
	Inherits OracleClientEntity

		Public Sub New() 
			Me.SchemaGlobal = "SAB."
			Me.QuerySource = "RECURSOSADMINISTRADORES"
			Me.MappingName = "RECURSOSADMINISTRADORES"
		End Sub
	...
	Public Function LoadAll() As Boolean
    	...
    	Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PL_RECURSOSADMINISTRADORES", parameters)		
	End Function
	...
	'=================================================================
	Public Overridable Function LoadByPrimaryKey(ByVal IDRECURSOS As Decimal, ByVal IDUSUARIOS As Decimal) As Boolean

		Dim parameters As ListDictionary = New ListDictionary()
		parameters.Add(_RECURSOSADMINISTRADORES.Parameters.IDRECURSOS, IDRECURSOS)

parameters.Add(_RECURSOSADMINISTRADORES.Parameters.IDUSUARIOS, IDUSUARIOS)
		...
		Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PK_RECURSOSADMINISTRADORES", parameters)
	...
	Public class ColumnNames
		...
		Shared Public Function ToPropertyName(ByVal columnName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(IDUSUARIOS) = _RECURSOSADMINISTRADORES.PropertyNames.IDUSUARIOS
				ht(IDRECURSOS) = _RECURSOSADMINISTRADORES.PropertyNames.IDRECURSOS
	...
	Public class PropertyNames
		...
		Shared Public Function ToColumnName(ByVal propertyName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(IDUSUARIOS) = _RECURSOSADMINISTRADORES.ColumnNames.IDUSUARIOS
				ht(IDRECURSOS) = _RECURSOSADMINISTRADORES.ColumnNames.IDRECURSOS
...
#End Region	
	...
	Protected Overrides Function GetInsertCommand() As IDbCommand
		...
		cmd.CommandText = Me.SchemaStoredProcedure + "PI_RECURSOSADMINISTRADORES" 
	...
	Protected Overrides Function GetUpdateCommand() As IDbCommand
		...
		Dim cmd As OracleCommand = New OracleCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = Me.SchemaStoredProcedure + "PU_RECURSOSADMINISTRADORES" 
	...
	Protected Overrides Function GetDeleteCommand() As IDbCommand
		...
		Dim cmd As OracleCommand = New OracleCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = Me.SchemaStoredProcedure + "PD_RECURSOSADMINISTRADORES" 
