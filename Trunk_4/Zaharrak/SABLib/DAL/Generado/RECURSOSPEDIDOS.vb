...
Public MustInherit Class _RECURSOSPEDIDOS
	Inherits OracleClientEntity

		Public Sub New() 
			Me.SchemaGlobal = "SAB."
			Me.QuerySource = "RECURSOSPEDIDOS"
			Me.MappingName = "RECURSOSPEDIDOS"
		End Sub
	...
	Public Function LoadAll() As Boolean
    	...
    	Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PL_RECURSOSPEDIDOS", parameters)		
	End Function
	...
	Public Overridable Function LoadByPrimaryKey(ByVal IDRECURSOS As Decimal, ByVal IDUSUARIOS As Decimal) As Boolean
		...
		parameters.Add(_RECURSOSPEDIDOS.Parameters.IDRECURSOS, IDRECURSOS)

parameters.Add(_RECURSOSPEDIDOS.Parameters.IDUSUARIOS, IDUSUARIOS)
		...
		Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PK_RECURSOSPEDIDOS", parameters)
	...
	Public class ColumnNames
		...
		Shared Public Function ToPropertyName(ByVal columnName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(IDUSUARIOS) = _RECURSOSPEDIDOS.PropertyNames.IDUSUARIOS
				ht(IDRECURSOS) = _RECURSOSPEDIDOS.PropertyNames.IDRECURSOS
	...
	Public class PropertyNames
		...
		Shared Public Function ToColumnName(ByVal propertyName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(IDUSUARIOS) = _RECURSOSPEDIDOS.ColumnNames.IDUSUARIOS
				ht(IDRECURSOS) = _RECURSOSPEDIDOS.ColumnNames.IDRECURSOS
...
#End Region	
	...
	Protected Overrides Function GetInsertCommand() As IDbCommand
		...
		cmd.CommandText = Me.SchemaStoredProcedure + "PI_RECURSOSPEDIDOS" 
	...
	Protected Overrides Function GetUpdateCommand() As IDbCommand
		...
		Dim cmd As OracleCommand = New OracleCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = Me.SchemaStoredProcedure + "PU_RECURSOSPEDIDOS" 
	...
	Protected Overrides Function GetDeleteCommand() As IDbCommand
		...
		Dim cmd As OracleCommand = New OracleCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = Me.SchemaStoredProcedure + "PD_RECURSOSPEDIDOS" 
