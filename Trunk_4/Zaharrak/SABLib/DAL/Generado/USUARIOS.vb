...
Public MustInherit Class _USUARIOS
	...
	Protected class Parameters 
		...
		Public Shared ReadOnly Property NOMBREUSUARIO As OracleParameter
			Get
				Return New OracleParameter("p_NOMBREUSUARIO", OracleDbType.VARCHAR2, 50)
			End Get
		End Property
		...
		Public Shared ReadOnly Property APELLIDO1 As OracleParameter
			Get
				Return New OracleParameter("p_APELLIDO1", OracleDbType.VARCHAR2, 25)
			End Get
		End Property
		
		Public Shared ReadOnly Property APELLIDO2 As OracleParameter
			Get
				Return New OracleParameter("p_APELLIDO2", OracleDbType.VARCHAR2, 25)
			End Get
		End Property
		
		Public Shared ReadOnly Property IDMATRIX As OracleParameter
			Get
				Return New OracleParameter("p_IDMATRIX", OracleDbType.VARCHAR2, 25)
			End Get
		End Property
		...
		Public Shared ReadOnly Property EMAIL As OracleParameter
			Get
				Return New OracleParameter("p_EMAIL", OracleDbType.VARCHAR2, 50)
			End Get
		End Property
		
		Public Shared ReadOnly Property IDDEPARTAMENTO As OracleParameter
			Get
				Return New OracleParameter("p_IDDEPARTAMENTO", OracleDbType.VARCHAR2, 10)
			End Get
		End Property
		
		Public Shared ReadOnly Property NOMBRE As OracleParameter
			Get
				Return New OracleParameter("p_NOMBRE", OracleDbType.VARCHAR2, 40)
			End Get
		End Property
		
		Public Shared ReadOnly Property FOTO As OracleParameter
			Get
				Return New OracleParameter("p_FOTO", OracleDbType.Blob, 2147483647)
			End Get
		End Property
		
		Public Shared ReadOnly Property DNI As OracleParameter
			Get
				Return New OracleParameter("p_DNI", OracleDbType.VARCHAR2, 14)
			End Get
		End Property
	...
	Public class ColumnNames
        ...
        Public Const APELLIDO1 As String = "APELLIDO1"
        Public Const APELLIDO2 As String = "APELLIDO2"
        Public Const IDMATRIX As String = "IDMATRIX"
        Public Const IDFTP As String = "IDFTP"
        Public Const EMAIL As String = "EMAIL"
        Public Const IDDEPARTAMENTO As String = "IDDEPARTAMENTO"
        Public Const NOMBRE As String = "NOMBRE"
        Public Const FOTO As String = "FOTO"
        Public Const DNI As String = "DNI"
		...
		Shared Public Function ToPropertyName(ByVal columnName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(APELLIDO1) = _USUARIOS.PropertyNames.APELLIDO1
				ht(APELLIDO2) = _USUARIOS.PropertyNames.APELLIDO2
				ht(IDMATRIX) = _USUARIOS.PropertyNames.IDMATRIX
				ht(IDFTP) = _USUARIOS.PropertyNames.IDFTP
				ht(EMAIL) = _USUARIOS.PropertyNames.EMAIL
				ht(IDDEPARTAMENTO) = _USUARIOS.PropertyNames.IDDEPARTAMENTO
				ht(NOMBRE) = _USUARIOS.PropertyNames.NOMBRE
				ht(FOTO) = _USUARIOS.PropertyNames.FOTO
				ht(DNI) = _USUARIOS.PropertyNames.DNI
	...
	Public class PropertyNames
		...
		Shared Public Function ToColumnName(ByVal propertyName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(APELLIDO1) = _USUARIOS.ColumnNames.APELLIDO1
				ht(APELLIDO2) = _USUARIOS.ColumnNames.APELLIDO2
				ht(IDMATRIX) = _USUARIOS.ColumnNames.IDMATRIX
				ht(IDFTP) = _USUARIOS.ColumnNames.IDFTP
				ht(EMAIL) = _USUARIOS.ColumnNames.EMAIL
				ht(IDDEPARTAMENTO) = _USUARIOS.ColumnNames.IDDEPARTAMENTO
				ht(NOMBRE) = _USUARIOS.ColumnNames.NOMBRE
				ht(FOTO) = _USUARIOS.ColumnNames.FOTO
				ht(DNI) = _USUARIOS.ColumnNames.DNI
	...
	Public class StringPropertyNames
        ...
        Public Const APELLIDO1 As String = "s_APELLIDO1"
        Public Const APELLIDO2 As String = "s_APELLIDO2"
        Public Const IDMATRIX As String = "s_IDMATRIX"
        Public Const IDFTP As String = "s_IDFTP"
        Public Const EMAIL As String = "s_EMAIL"
        Public Const IDDEPARTAMENTO As String = "s_IDDEPARTAMENTO"
        Public Const NOMBRE As String = "s_NOMBRE"
        Public Const FOTO As String = "s_FOTO"
        Public Const DNI As String = "s_DNI"
	...
	#Region "Properties" 
		...
		Public Overridable Property APELLIDO1 As String
			Get
				Return MyBase.GetString(ColumnNames.APELLIDO1)
			End Get
			Set(ByVal Value As String)
				MyBase.SetString(ColumnNames.APELLIDO1, Value)
			End Set
		End Property

		Public Overridable Property APELLIDO2 As String
			Get
				Return MyBase.GetString(ColumnNames.APELLIDO2)
			End Get
			Set(ByVal Value As String)
				MyBase.SetString(ColumnNames.APELLIDO2, Value)
			End Set
		End Property
		...
		Public Overridable Property IDDEPARTAMENTO As String
			Get
				Return MyBase.GetString(ColumnNames.IDDEPARTAMENTO)
			End Get
			Set(ByVal Value As String)
				MyBase.SetString(ColumnNames.IDDEPARTAMENTO, Value)
			End Set
		End Property
		...
		Public Overridable Property FOTO As Byte()
			Get
				Return MyBase.GetByteArray(ColumnNames.FOTO)
			End Get
			Set(ByVal Value As Byte())
				MyBase.SetByteArray(ColumnNames.FOTO, Value)
			End Set
		End Property

		Public Overridable Property DNI As String
			Get
				Return MyBase.GetString(ColumnNames.DNI)
			End Get
			Set(ByVal Value As String)
				MyBase.SetString(ColumnNames.DNI, Value)
			End Set
		End Property
	...
	#Region "String Properties" 
		...
		Public Overridable Property s_APELLIDO1 As String
			Get
				If Me.IsColumnNull(ColumnNames.APELLIDO1) Then
					Return String.Empty
				Else
					Return MyBase.GetStringAsString(ColumnNames.APELLIDO1)
				End If
			End Get
			Set(ByVal Value As String)
				If String.Empty = value Then
					Me.SetColumnNull(ColumnNames.APELLIDO1)
				Else
					Me.APELLIDO1 = MyBase.SetStringAsString(ColumnNames.APELLIDO1, Value)
				End If
			End Set
		End Property

		Public Overridable Property s_APELLIDO2 As String
			Get
				If Me.IsColumnNull(ColumnNames.APELLIDO2) Then
					Return String.Empty
				Else
					Return MyBase.GetStringAsString(ColumnNames.APELLIDO2)
				End If
			End Get
			Set(ByVal Value As String)
				If String.Empty = value Then
					Me.SetColumnNull(ColumnNames.APELLIDO2)
				Else
					Me.APELLIDO2 = MyBase.SetStringAsString(ColumnNames.APELLIDO2, Value)
				End If
			End Set
		End Property
		...
		Public Overridable Property s_IDDEPARTAMENTO As String
			Get
				If Me.IsColumnNull(ColumnNames.IDDEPARTAMENTO) Then
					Return String.Empty
				Else
					Return MyBase.GetStringAsString(ColumnNames.IDDEPARTAMENTO)
				End If
			End Get
			Set(ByVal Value As String)
				If String.Empty = value Then
					Me.SetColumnNull(ColumnNames.IDDEPARTAMENTO)
				Else
					Me.IDDEPARTAMENTO = MyBase.SetStringAsString(ColumnNames.IDDEPARTAMENTO, Value)
				End If
			End Set
		End Property
		...
		Public Overridable Property s_DNI As String
			Get
				If Me.IsColumnNull(ColumnNames.DNI) Then
					Return String.Empty
				Else
					Return MyBase.GetStringAsString(ColumnNames.DNI)
				End If
			End Get
			Set(ByVal Value As String)
				If String.Empty = value Then
					Me.SetColumnNull(ColumnNames.DNI)
				Else
					Me.DNI = MyBase.SetStringAsString(ColumnNames.DNI, Value)
				End If
			End Set
		End Property
    ...
    Public Class WhereClause
		...
		Public class TearOffWhereParameter
			...
			Public ReadOnly Property APELLIDO1() As WhereParameter
				Get
					Dim where As WhereParameter = New WhereParameter(ColumnNames.APELLIDO1, Parameters.APELLIDO1)
					Me._clause._entity.Query.AddWhereParemeter(where)
					Return where
				End Get
			End Property

			Public ReadOnly Property APELLIDO2() As WhereParameter
				Get
					Dim where As WhereParameter = New WhereParameter(ColumnNames.APELLIDO2, Parameters.APELLIDO2)
					Me._clause._entity.Query.AddWhereParemeter(where)
					Return where
				End Get
			End Property
			...
			Public ReadOnly Property IDDEPARTAMENTO() As WhereParameter
				Get
					Dim where As WhereParameter = New WhereParameter(ColumnNames.IDDEPARTAMENTO, Parameters.IDDEPARTAMENTO)
					Me._clause._entity.Query.AddWhereParemeter(where)
					Return where
				End Get
			End Property
			...
			Public ReadOnly Property FOTO() As WhereParameter
				Get
					Dim where As WhereParameter = New WhereParameter(ColumnNames.FOTO, Parameters.FOTO)
					Me._clause._entity.Query.AddWhereParemeter(where)
					Return where
				End Get
			End Property

			Public ReadOnly Property DNI() As WhereParameter
				Get
					Dim where As WhereParameter = New WhereParameter(ColumnNames.DNI, Parameters.DNI)
					Me._clause._entity.Query.AddWhereParemeter(where)
					Return where
				End Get
			End Property
		...
		Public ReadOnly Property APELLIDO1() As WhereParameter 
			Get
				If _APELLIDO1_W Is Nothing Then
					_APELLIDO1_W = TearOff.APELLIDO1
				End If
				Return _APELLIDO1_W
			End Get
		End Property
		...
		Public ReadOnly Property APELLIDO2() As WhereParameter 
			Get
				If _APELLIDO2_W Is Nothing Then
					_APELLIDO2_W = TearOff.APELLIDO2
				End If
				Return _APELLIDO2_W
			End Get
		End Property
		...
		Public ReadOnly Property IDDEPARTAMENTO() As WhereParameter 
			Get
				If _IDDEPARTAMENTO_W Is Nothing Then
					_IDDEPARTAMENTO_W = TearOff.IDDEPARTAMENTO
				End If
				Return _IDDEPARTAMENTO_W
			End Get
		End Property
		...
		Private _APELLIDO1_W As WhereParameter = Nothing
		Private _APELLIDO2_W As WhereParameter = Nothing
		...
		Private _IDDEPARTAMENTO_W As WhereParameter = Nothing
		Private _NOMBRE_W As WhereParameter = Nothing
		Private _FOTO_W As WhereParameter = Nothing
		Private _DNI_W As WhereParameter = Nothing
			...
			_APELLIDO1_W = Nothing
			_APELLIDO2_W = Nothing
			_IDMATRIX_W = Nothing
			_IDFTP_W = Nothing
			_EMAIL_W = Nothing
			_IDDEPARTAMENTO_W = Nothing
			_NOMBRE_W = Nothing
			_FOTO_W = Nothing
			_DNI_W = Nothing
...
#Region "Aggregate Clause"
    Public Class AggregateClause
		...
		Public ReadOnly Property APELLIDO1() As AggregateParameter
			Get
				Dim where As AggregateParameter = New AggregateParameter(ColumnNames.APELLIDO1, Parameters.APELLIDO1)
				Me._clause._entity.Query.AddAggregateParameter(where)
				Return where
			End Get
		End Property

		Public ReadOnly Property APELLIDO2() As AggregateParameter
			Get
				Dim where As AggregateParameter = New AggregateParameter(ColumnNames.APELLIDO2, Parameters.APELLIDO2)
				Me._clause._entity.Query.AddAggregateParameter(where)
				Return where
			End Get
		End Property
		...
		Public ReadOnly Property IDDEPARTAMENTO() As AggregateParameter
			Get
				Dim where As AggregateParameter = New AggregateParameter(ColumnNames.IDDEPARTAMENTO, Parameters.IDDEPARTAMENTO)
				Me._clause._entity.Query.AddAggregateParameter(where)
				Return where
			End Get
		End Property
		...
		Public ReadOnly Property FOTO() As AggregateParameter
			Get
				Dim where As AggregateParameter = New AggregateParameter(ColumnNames.FOTO, Parameters.FOTO)
				Me._clause._entity.Query.AddAggregateParameter(where)
				Return where
			End Get
		End Property

		Public ReadOnly Property DNI() As AggregateParameter
			Get
				Dim where As AggregateParameter = New AggregateParameter(ColumnNames.DNI, Parameters.DNI)
				Me._clause._entity.Query.AddAggregateParameter(where)
				Return where
			End Get
		End Property
		...
		Private _APELLIDO1_W As AggregateParameter = Nothing
		Private _APELLIDO2_W As AggregateParameter = Nothing
		...
		Private _IDDEPARTAMENTO_W As AggregateParameter = Nothing
		Private _NOMBRE_W As AggregateParameter = Nothing
		Private _FOTO_W As AggregateParameter = Nothing
		Private _DNI_W As AggregateParameter = Nothing
...
#End Region	
	...
	Private Sub CreateParameters(ByVal cmd As OracleCommand)
		...
		p = cmd.Parameters.Add(Parameters.APELLIDO1)
		p.SourceColumn = ColumnNames.APELLIDO1
		p.SourceVersion = DataRowVersion.Current

		p = cmd.Parameters.Add(Parameters.APELLIDO2)
		p.SourceColumn = ColumnNames.APELLIDO2
		p.SourceVersion = DataRowVersion.Current
		...
		p = cmd.Parameters.Add(Parameters.IDDEPARTAMENTO)
		p.SourceColumn = ColumnNames.IDDEPARTAMENTO
		p.SourceVersion = DataRowVersion.Current
		...
		p = cmd.Parameters.Add(Parameters.DNI)
		p.SourceColumn = ColumnNames.DNI
		p.SourceVersion = DataRowVersion.Current
