...
Public MustInherit Class _TICKETS
	Inherits OracleClientEntity

		Public Sub New() 
			Me.SchemaGlobal = "SAB."
			Me.QuerySource = "TICKETS"
			Me.MappingName = "TICKETS"
		End Sub
	...
	Public Function LoadAll() As Boolean
    	...
    	Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PL_TICKETS", parameters)		
	End Function
	...
	Public Overridable Function LoadByPrimaryKey(ByVal ID As String) As Boolean
		...
		parameters.Add(_TICKETS.Parameters.ID, ID)
		...
		Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PK_TICKETS", parameters)
	...
	Protected class Parameters 
		...
		Public Shared ReadOnly Property ID As OracleParameter
			Get
				Return New OracleParameter("p_ID", OracleDbType.VARCHAR2, 100)
			End Get
		End Property
	...
	Public class ColumnNames
		...
		Shared Public Function ToPropertyName(ByVal columnName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(ID) = _TICKETS.PropertyNames.ID
				ht(IDUSUARIOS) = _TICKETS.PropertyNames.IDUSUARIOS
	...
	Public class PropertyNames
		...
		Shared Public Function ToColumnName(ByVal propertyName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(ID) = _TICKETS.ColumnNames.ID
				ht(IDUSUARIOS) = _TICKETS.ColumnNames.IDUSUARIOS
...
#End Region	
	...
	Protected Overrides Function GetInsertCommand() As IDbCommand
		...
		cmd.CommandText = Me.SchemaStoredProcedure + "PI_TICKETS" 
	...
	Protected Overrides Function GetUpdateCommand() As IDbCommand
		...
		Dim cmd As OracleCommand = New OracleCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = Me.SchemaStoredProcedure + "PU_TICKETS" 
	...
	Protected Overrides Function GetDeleteCommand() As IDbCommand
		...
		Dim cmd As OracleCommand = New OracleCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = Me.SchemaStoredProcedure + "PD_TICKETS" 
