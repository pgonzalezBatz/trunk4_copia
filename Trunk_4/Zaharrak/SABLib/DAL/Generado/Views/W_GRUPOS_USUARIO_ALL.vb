...
Namespace DAL.Views
	...
	Public Class W_GRUPOS_USUARIO_ALL
		Inherits OracleClientEntity

		Public Sub New()
			Me.SchemaGlobal = "SAB."
			Me.QuerySource = "W_GRUPOS_USUARIO_ALL"
			Me.MappingName = "W_GRUPOS_USUARIO_ALL"
...
#Region "Parameters"
		Protected Class Parameters
			...
			Public Shared ReadOnly Property GRUPO() As OracleParameter
				Get
					Return New OracleParameter("GRUPO", OracleDbType.Varchar2, 150)
				End Get
			End Property
		...
		Public Class ColumnNames
			...
			Public Shared Function ToPropertyName(ByVal columnName As String) As String
				...
				If ht Is Nothing Then
					...
					ht(IDUSUARIOS) = W_GRUPOS_USUARIO_ALL.PropertyNames.IDUSUARIOS
					ht(IDGRUPOS) = W_GRUPOS_USUARIO_ALL.PropertyNames.IDGRUPOS
					ht(IDCULTURAS) = W_GRUPOS_USUARIO_ALL.PropertyNames.IDCULTURAS
					ht(GRUPO) = W_GRUPOS_USUARIO_ALL.PropertyNames.GRUPO
		...
		Public Class PropertyNames
			...
			Public Shared Function ToColumnName(ByVal propertyName As String) As String
				...
				If ht Is Nothing Then
					...
					ht(IDUSUARIOS) = W_GRUPOS_USUARIO_ALL.ColumnNames.IDUSUARIOS
					ht(IDGRUPOS) = W_GRUPOS_USUARIO_ALL.ColumnNames.IDGRUPOS
					ht(IDCULTURAS) = W_GRUPOS_USUARIO_ALL.ColumnNames.IDCULTURAS
					ht(GRUPO) = W_GRUPOS_USUARIO_ALL.ColumnNames.GRUPO
