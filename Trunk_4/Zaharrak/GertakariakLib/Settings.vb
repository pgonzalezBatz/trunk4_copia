...
Namespace My
	...
	Partial Friend NotInheritable Class MySettings
        ...
        Property ConexionOracle As New Oracle.ManagedDataAccess.Client.OracleConnection

        Public Sub New()
			Dim CadenaConexion As New ConnectionStringSettings
#If DEBUG Then
			CadenaConexion = System.Configuration.ConfigurationManager.ConnectionStrings.Item("ConexionWeb_TEST")
			Conexion_BBDD = If(CadenaConexion Is Nothing, My.Settings.Conexion_Test, CadenaConexion.ConnectionString)
#Else
			CadenaConexion = System.Configuration.ConfigurationManager.ConnectionStrings.Item("ConexionWeb_LIVE")
