...
<div class="container-fluid">
    @If Not ViewData("existeBrain") Then
        @<div class="alert alert-danger" role="alert">
        <strong>@h.traducir("El proveedor no existe en BRAIN!!")</strong><br />
    @Html.ActionLink(h.traducir("Crear proveedor en BRAIN"), "createProveedorBrain", h.ToRouteValues(Request.QueryString, Nothing))
    </div>
    ...
    <form action="" method="post" class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-2">
                ...
                @If SimpleRoleProvider.IsUserAuthorised(Web.roles.cambiarCIF) Then
                ...
                Else
            @Html.HiddenFor(Function(model) model.cif)

            @<p>
                <strong class="text-primary">@Html.ValueFor(Function(model) model.cif)</strong>
            </p>
                End If
        ...
        <div class="form-group">
            <div class="col-sm-6">
                <label for="codpro">@h.traducir("Código de proveedor")</label>
                @Html.HiddenFor(Function(model) model.codpro)
                <p>
                    <strong class="text-primary">@Html.ValueFor(Function(model) model.codpro)</strong>
                </p>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <label for="email" class="">@h.traducir("Usuario Extranet")</label>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                ...
                @Html.DropDownListFor(Function(model) model.tipoProveedorSis, CType(ViewBag.tipoproveedorsisLst, IEnumerable(Of SelectListItem)), h.traducir("[Seleccionar]"), New With {.class = "form-control"})
