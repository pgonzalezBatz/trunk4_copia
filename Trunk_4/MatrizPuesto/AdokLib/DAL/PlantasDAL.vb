...
#Region "Consultas"
        ...
        Public Function CargarPlanta(ByVal idPlanta As Integer) As ELL.Plantas
            ...
            Return Memcached.OracleDirectAccess.seleccionar(Of ELL.Plantas)(Function(r As OracleDataReader) _
            New ELL.Plantas With {.Id = CInt(r("ID")), .Codigo = SabLib.BLL.Utils.stringNull(r("CODIGO")), .Nombre = SabLib.BLL.Utils.stringNull(r("NOMBRE"))}, query, CadenaConexionSAB, parameter).FirstOrDefault()
        End Function
