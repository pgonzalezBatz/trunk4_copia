...
#Region "Variables"
        ...
        Protected Shared ReadOnly Property Conexion As String
            Get
                If (Configuration.ConfigurationManager.AppSettings("CurrentStatus").ToLower = "live") Then
                    Return Configuration.ConfigurationManager.ConnectionStrings.Item("ADOKLIVE").ConnectionString
                Else
                    Return Configuration.ConfigurationManager.ConnectionStrings.Item("ADOKTEST").ConnectionString
                End If
        ...
        Protected ReadOnly Property CadenaConexionSQL As String
            Get
                Dim status As String = "ADOKSQL"
                If (Configuration.ConfigurationManager.AppSettings("CurrentStatus").ToLower = "live") Then status = "ADOKSQL"
        ...
        Protected ReadOnly Property CadenaConexion As String
            Get
                Dim status As String = "ADOKTEST"
                If (Configuration.ConfigurationManager.AppSettings("CurrentStatus").ToLower = "live") Then status = "ADOKLIVE"
                Return Configuration.ConfigurationManager.ConnectionStrings(status).ConnectionString
            End Get
        End Property
        ''' <summary>
