<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Adok_plantas.Master" CodeBehind="EstadoTrabajadorDocumentoMedico.aspx.vb" Inherits="AdokWeb.EstadoTrabajadorDocumentoMedico" %>
                            ...
                            <asp:RadioButtonList CssClass=" btn-group-justified " Width="80%" ID="rblCorrecto" runat="server" AutoPostBack="false" RepeatDirection="Horizontal">
                              ...
                              <asp:ListItem Text="No Validado." Value="2" enabled="true"/>
                                <asp:ListItem Text="NO CADUCA." Value="3" enabled="true"/>
                                  ...
                                  <br />
                            <asp:Label runat="server" ID="Label2" Text="Fecha de aviso para revisión " />:
