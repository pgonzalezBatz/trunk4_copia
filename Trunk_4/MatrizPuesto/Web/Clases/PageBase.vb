...
#Region "Variables compartidas"
    ...
    Public Shared log As log4net.ILog = log4net.LogManager.GetLogger("root.MatrizPuesto")
    Public Shared plantaAdmin As Int32 = 999
    Public Shared idDocHist As String = ""
    Public Shared intDependientes(900) As Integer ' As List(Of Integer)
    Public Shared Dependientes As List(Of Integer)
    Public Shared intPuestos(900) As Integer ' As List(Of Integer)
    Public Shared intPuesto As Integer = 0
    Public Shared intRol As Integer = 0

    Public Shared plantaAdminExt As Int32 = 999
    Public Shared empresaBusqueda As Int32 = 999
    Public Shared plantaAdminNombre As String = ""
    Public Shared plantaAdminNombre2 As String = ""
...
#Region "Ticket"
    ...
    '''' <returns></returns>
    '''' <remarks></remarks>
    Protected Overridable ReadOnly Property RolesAcceso As List(Of ELL.Roles.RolUsuario)
        Get
            Return Nothing
        End Get
    End Property
    ...
    '''' <value></value>
    '''' <returns></returns>
    Protected Property PerfilUsuario() As ELL.PerfilUsuario
        Get
