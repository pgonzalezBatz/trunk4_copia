<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Adok_plantas9.Master" CodeBehind="EmpresaDocumento9.aspx.vb" Inherits="AdokWeb.EmpresaDocumento9" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cuerpoPrincipal" runat="server">
    <div class="container-fluid" style="background-color: #ebebeb;">
        <div class="navbar-header">
            <a class="navbar-brand" href="#"><span class="glyphicon glyphicon-globe"></span>&nbsp;<asp:Label ID="Label2" runat="server" Text="Mantenimiento de Documentos por Puesto" /></a>
        </div>
    </div>
    <div class="container">
            ...
            <asp:View ID="viewListado" runat="server">
                ...
                <%--                <div class=" panel-header">
                    ...
                    <h2 class="text-center"><span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp; 
                        <asp:Label ID="Label1" runat="server" Text="Asignación de documentos a " /></h2>
                ...
                <div class="row">
                    ...
                    <div class="text-center">
                        <br />
                    <asp:Button ID="BtnMarcarEmpresas" runat="server" CausesValidation="false" class="btn btn-primary" OnClick="BtnMarcarEmpresas_Click" Text="Asignar Docs a Todos los Puestos" />
                        </div>
                </div>
                ...
                <asp:GridView ID="gvType" runat="Server" AutoGenerateColumns="False" AllowPaging="true" CssClass="table table-striped"
                    ...
                    OnRowCancelingEdit="gvType_RowCancelingEdit" OnRowEditing="gvType_RowEditing" OnRowUpdating="gvType_RowUpdating" PageSize="10">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Documentos por Puesto">
                            <ItemTemplate>
                                <asp:LinkButton ID="lbEditar" class="btn  bg-info" ToolTip="Asignar Documentos de Puesto" runat="server" Text="Asignar Documentos" CommandName="Edit" />
                            </ItemTemplate>

                        </asp:TemplateField>

  <%--                      <asp:TemplateField HeaderText="Documentos de Trabajadores">
                            <ItemTemplate>
                                <asp:LinkButton ID="lbTrabajadores" runat="server" class="btn  bg-info" ToolTip="Asignar Documentos de Trabajadores" Text="Asignar a Trabajadores" CommandName="Trabajadores" />
                            </ItemTemplate>
...
<%--                    <div  class="col-xs-3">
                    ...
                    <div class="col-xs-4">
                        ...
                        <asp:Label runat="server" ID="ex18" Text="Puesto" />:
                ...
                <asp:GridView ID="gvType2" runat="Server" AutoGenerateColumns="False" CssClass="table table-striped"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField Visible="false" HeaderText="Caducidad">
                            <ItemTemplate>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-lg-offset-2">
                            ...
                            <br />
                            <asp:Label runat="server" ID="txtfecrec3" Text="Puesto" />: <asp:TextBox ID="txtEmpCad" runat="server" class="form-control required" ReadOnly="True" />
