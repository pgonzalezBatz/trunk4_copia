Imports System.Xml
Imports LocalizationLib2
Imports System.Globalization

Public Class Adok_Plantas9
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If (Session("Cultura") Is Nothing) Then
            '        cultureInfo = System.Globalization.CultureInfo.CreateSpecificCulture("ES_es") 'Ticket.Culture
        Else
            cultureInfo = System.Globalization.CultureInfo.CreateSpecificCulture(Session("Cultura"))
            System.Threading.Thread.CurrentThread.CurrentCulture = cultureInfo
        End If
        PageBase.DirFicherosBajar = System.Configuration.ConfigurationManager.AppSettings("PathFicherosBajar").ToString()
        PageBase.DirFicherosSubir = System.Configuration.ConfigurationManager.AppSettings("PathFicherosSubir").ToString()
        'Menu 
...
#Region "Menu"
    ...
    Protected Sub menu_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles menu.DataBound
        ...
        If (mn IsNot Nothing AndAlso mn.Items.Count > 0) Then
            ...
            elementos = elementos & " </ul> <ul class='nav navbar-nav navbar-right'>             <li> <a href = '#' Class='dropdown-toggle' data-toggle='dropdown'>" & itzultzaileWeb.Itzuli("Contacto") & "<b Class='caret'></b></a>  <ul Class='dropdown-menu'> <li><a href='#'>Tel. 946305000</a></li> <li><a href='#'>email: MatrizPuesto@batz.es</a></li> </ul> </li>                                     <li><a href='" & System.Configuration.ConfigurationManager.AppSettings("LinkInicioIntranet").ToString & "'><span class='glyphicon glyphicon-off'></span>" & itzultzaileWeb.Itzuli("Salir") & " </a></li>     "
    ...
    Private Function TratarMenu() As XmlDocument
        ...
        xDoc.Load(Server.MapPath("~/App_Data/menu9.xml"))
    ...
    Private Sub TratarElementos(ByVal xDocCopia As XmlDocument, ByVal elemento As XmlElement, ByVal elementoCopia As XmlElement)
        ...
        Dim perfilUsuario As New ELL.PerfilUsuario
        ...
        If (Session("PerfilUsuario") IsNot Nothing) Then
            'If System.Configuration.ConfigurationManager.AppSettings("medico").ToString = Ticket.IdUser.ToString Then '"63690"


            If System.Configuration.ConfigurationManager.AppSettings("RRHH").ToString.Contains(Ticket.IdUser.ToString) Then
            ...
            Else
                ...
                If System.Configuration.ConfigurationManager.AppSettings("medico").ToString.Contains(Ticket.IdUser.ToString) Then '"63690"
                ...
                Else
                    ...
                    If listaType.Count > 0 Then
                        ...
                        For z = 0 To listaType.Count - 1
                            If listaType(z).rol = 1 Then  'igorre
                                ' puede ser 2 o 9
