<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Adok_plantas9.Master" CodeBehind="EstadoTrabajadorDocumentoResp9.aspx.vb" Inherits="AdokWeb.EstadoTrabajadorDocumentoResp9" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cuerpoPrincipal" runat="server">
    ...
    <div class="container">
        ...
        <asp:MultiView ID="mView" runat="server" ActiveViewIndex="0">
            ...
            <asp:View ID="viewListado" runat="server">
                ...
                <div class="row">
                    <div class="col-xs-4">
                        <asp:Label visible="false" runat="server" ID="ex177" Text="Trabajador" />:
   ...
   <%--                     <asp:TemplateField HeaderText="Hist." ItemStyle-HorizontalAlign="Center">
                        ...
                        <asp:TemplateField visible="false" HeaderText="Validar" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-lg-offset-2">
                            <asp:Label visible="false" runat="server" ID="Label1" Text="Trabajador" />

                            <asp:TextBox visible="false" ID="txtNombre2" runat="server" class="form-control" ReadOnly="True" />
            ...
            <asp:View ID="view3" runat="server">
                <div class=" panel-header">
                    ...
                    <div class="row">
                        <div class="col-xs-4">
                            <asp:Label visible="false" runat="server" ID="ex155" Text="Trabajador" />

                            <asp:TextBox visible="false" class="form-control" type="text" ID="txtNombreHis" runat="server" ReadOnly="True" />
                        </div>
                        <div class="col-xs-2">

                            <asp:Label visible="false" runat="server" ID="Cif" Text="Nif" />
                            <asp:TextBox visible="false" type="text" class="form-control" ID="txtCIFHis" runat="server" ReadOnly="True" />
                        </div>
                ...
                <div class="panel-footer">
                    <div class="text-center">
                        ...
                        <asp:Button class="btn btn-primary" ID="CancelVista" runat="server" Text="Volver" OnClick="Volver" />
