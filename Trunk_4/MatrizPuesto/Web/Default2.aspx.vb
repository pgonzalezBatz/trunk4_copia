...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If lista.Count > 0 Then
            ...
            For i = 0 To Trabajadores.Count - 1
                If Trabajadores(i).Idsab Is Nothing Then
                Else
        ...
        If PerfilUsuario.IdRol = 3 Then
            ...
            Response.Redirect("EstadoTrabajadorDocumentoResp.aspx", True)
        End If
    ...
    Public Function cargarTrabajadoresPKS(ByVal planta As Integer) As List(Of TrabajadorPKS) 'byval planta as integer
        ...
        Using webClient As New WebClient()
            ...
            'End If
            data = webClient.DownloadString("https://ganekozabal.batz.es/pks/json/GetPersonaPuesto?idplanta=" & planta) 'GetPuestosEnEstructuraPorPlanta?idplanta=1
        End Using
        Dim jss As New JavaScriptSerializer()
    ...
    Public Function cargarDependientesPKS(ByVal planta As Integer) As List(Of Integer) 'byval planta as integer
        ...
        Using webClient As New WebClient()
            ...
            'Else
            '    data = webClient.DownloadString("https://antsola.batz.es/pks/json/GetTrabajadoresDependientes?DNI=" & CType(Session("Ticket"), SabLib.ELL.Ticket).Dni) '  "30662423L") 'GetPuestosEnEstructuraPorPlanta?idplanta=1
            'End If
            data = webClient.DownloadString("https://ganekozabal.batz.es/pks/json/GetTrabajadoresDependientes?DNI=" & CType(Session("Ticket"), SabLib.ELL.Ticket).Dni) '  "30662423L") 'GetPuestosEnEstructuraPorPlanta?idplanta=1 
