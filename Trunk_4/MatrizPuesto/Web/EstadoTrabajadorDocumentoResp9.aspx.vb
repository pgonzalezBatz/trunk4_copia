...
Public Class EstadoTrabajadorDocumentoResp9
    Inherits PageBase
...
#End Region
    ...
    Protected Sub btoVolver_click(sender As Object, e As EventArgs) Handles btoVolver.Click
        Try
            If idTrabajadorParam > 0 Then
                Response.Redirect("~/EstadoTrabajadorDocumentoResp9.aspx?empresa=" & idTrabajadorParam & "&pagina=" & gvType.PageIndex, False)
            End If
