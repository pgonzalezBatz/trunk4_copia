...
Public Class MatrizFormacionSolicitud
    Inherits PageBase
        ...
        Try
            ...
            If hfEmpresa.Value <> "" Then
                ...
                If (listaType3.Count > 0) Then
                    listaTrabajadores = oDocBLL.CargarListaMatrizTraEmp(PageBase.plantaAdmin, listaType3(0).Id)
                Else
            ...
            listaType2 = oDocBLL.CargarListaMatriz(PageBase.plantaAdmin, plantaAdmin)
            If (listaType2.Count > 0) Then
                ...
                For i = 0 To listaType2.Count - 1
                    ...
                    lista = oDocBLL.CargarTiposTrabajadorActivos(PageBase.plantaAdmin, listaType2(i).codtra)
                    ...
                    'por cada documento pasa por aqui, tendre que poner si bueno o malo en listaTrabajadores segun sea el tra y el doc
                    'Tra es listaType2(i).codtra
                    'doc es  listaType2(i).coddoc
                    For j = 0 To listaTrabajadores.Count - 1
                        If listaTrabajadores(j).codtra = listaType2(i).codtra Then

                            listaTrabajadores(j).nomtra = listaType2(i).nomtra
                            listaTrabajadores(j).Comentario = listaType2(i).Comentario
                            listaTrabajadores(j).NIF = listaType2(i).NIF
                            listaTrabajadores(j).nomtra = listaType2(i).nomtra
                            listaTrabajadores(j).Abrev = listaType2(i).Abrev
                            listaTrabajadores(j).txtcorrecto = listaType2(i).txtcorrecto
                            listaTrabajadores(j).ubicacion = listaType2(i).ubicacion
                            ...
                            'listaTrabajadores(j).doc11 = 3

                            For h = 0 To listaDocumentos.Count - 1
                                If listaDocumentos(h).Id = listaType2(i).coddoc Then
                                    If h = 0 Then
                                        listaTrabajadores(j).doc1 = no_correcto 'le asigno el estado a ese doc 1 es error, 2 aviso otro correcto
                                    End If
                                    If h = 1 Then
                                        listaTrabajadores(j).doc2 = no_correcto 'le asigno el estado a ese doc 1 es error, 2 aviso otro correcto                                        
                                    End If
                                    If h = 2 Then
                                        listaTrabajadores(j).doc3 = no_correcto 'le asigno el estado a ese doc 1 es error, 2 aviso otro correcto
                                    End If
                                    If h = 3 Then
                                        listaTrabajadores(j).doc4 = no_correcto 'le asigno el estado a ese doc 1 es error, 2 aviso otro correcto
                                    End If
                                    If h = 4 Then
                                        listaTrabajadores(j).doc5 = no_correcto 'le asigno el estado a ese doc 1 es error, 2 aviso otro correcto
                                    End If
                                    If h = 5 Then
                                        listaTrabajadores(j).doc6 = no_correcto 'le asigno el estado a ese doc 1 es error, 2 aviso otro correcto
                                    End If
                                    If h = 6 Then
                                        listaTrabajadores(j).doc7 = no_correcto 'le asigno el estado a ese doc 1 es error, 2 aviso otro correcto
                                    End If
                                    If h = 7 Then
                                        listaTrabajadores(j).doc8 = no_correcto 'le asigno el estado a ese doc 1 es error, 2 aviso otro correcto
                                    End If
                                    If h = 8 Then
                                        listaTrabajadores(j).doc9 = no_correcto 'le asigno el estado a ese doc 1 es error, 2 aviso otro correcto
                                    End If
                                    If h = 9 Then
                                        listaTrabajadores(j).doc10 = no_correcto 'le asigno el estado a ese doc 1 es error, 2 aviso otro correcto
                                    End If
                            ...
                            Next
                            'aqui la excepcion 1
                            If listaTrabajadores(j).doc4 = 1 And listaTrabajadores(j).doc2 = 0 Then
                                listaTrabajadores(j).doc2 = 1
                            End If
                            'aqui la excepcion 2
                            If listaTrabajadores(j).doc5 = 1 And listaTrabajadores(j).doc6 = 0 Then
                                listaTrabajadores(j).doc6 = 1
                            End If
...
#End Region
    ...
    Private Sub gvType2_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles gvType2.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            '    Dim ibModificar As LinkButton = CType(e.Row.FindControl("ibModificar"), LinkButton)
