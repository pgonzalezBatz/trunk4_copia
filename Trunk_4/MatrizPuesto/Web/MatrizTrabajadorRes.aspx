<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Adok_plantas.Master" CodeBehind="MatrizTrabajadorRes.aspx.vb" Inherits="AdokWeb.MatrizTrabajadorRes" %>
...
<%--                        <asp:Label  runat="server"  ID="ex177" Text="Puesto"  />:
                       ...
                       <asp:Label runat="server" ID="Label8" Text="Trabajador" />:
     ...
     <asp:LinkButton visible='<%# If(Eval("xdoc7") = "", "false", "True") %>'  ID="imgDoc6" Text='<%# Eval("xdoc7")%>' runat="server" CommandName="Curso2" CommandArgument='<%# Eval("fdoc7")%>' />           
             ...
             <h4 >             <span  style="text-align: left;" class="label label-primary"><asp:Label ID="Label10" runat="server" Text="Total cursos" />: </span>&nbsp;
