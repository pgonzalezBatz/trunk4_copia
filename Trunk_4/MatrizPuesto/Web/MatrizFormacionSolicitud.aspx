<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MPLogin.Master" CodeBehind="MatrizFormacionSolicitud.aspx.vb" Inherits="AdokWeb.MatrizFormacionSolicitud" %>
...
<%--                <div class=" panel-header">
                ...
                <div class="row">
                    <div class="col-xs-3">
                        <asp:Label  runat="server"  ID="ex177" Text="Empresa"  />:
             ...
             <div class="row" style="margin-top: 20px;">
                    ...
                    <asp:TemplateField HeaderText="Grúa">
                            <ItemTemplate>
     <asp:LinkButton  OnClick="ibVer_Click"  ID="imgDoc1"  runat="server"    ToolTip='<%# If(Eval("doc1") = "0", "Correcto", (If(Eval("doc1") = "1", "No Correcto", ""))) %>'
    class='<%# If(Eval("doc1") = "0", "btn alert-success", (If(Eval("doc1") = "1", "btn alert-danger", "btn btn-default"))) %>'
     ><span   class='<%# If(Eval("doc1") = "0", "glyphicon glyphicon-check", (If(Eval("doc1") = "1", "glyphicon glyphicon-ban-circle", ""))) %>'         
         ></span></asp:LinkButton>     
                            </ItemTemplate>
                        </asp:TemplateField>

                         
                    <asp:TemplateField HeaderText="PEM">
                            <ItemTemplate>
     <asp:LinkButton  OnClick="ibVer_Click2"  ID="imgDoc2"  runat="server"    ToolTip='<%# If(Eval("doc2") = "0", "Correcto", (If(Eval("doc2") = "1", "No Correcto", ""))) %>'
    class='<%# If(Eval("doc2") = "0", "btn alert-success", (If(Eval("doc2") = "1", "btn alert-danger", "btn btn-default"))) %>'
     ><span   class='<%# If(Eval("doc2") = "0", "glyphicon glyphicon-check", (If(Eval("doc2") = "1", "glyphicon glyphicon-ban-circle", ""))) %>'         
         ></span></asp:LinkButton>     
                            </ItemTemplate>
                        </asp:TemplateField>

                    <asp:TemplateField HeaderText="Carretilla">
                            <ItemTemplate>
     <asp:LinkButton  OnClick="ibVer_Click3"  ID="imgDoc3"  runat="server"    ToolTip='<%# If(Eval("doc3") = "0", "Correcto", (If(Eval("doc3") = "1", "No Correcto", ""))) %>'
    class='<%# If(Eval("doc3") = "0", "btn alert-success", (If(Eval("doc3") = "1", "btn alert-danger", "btn btn-default"))) %>'
    ...
    class='<%# If(Eval("doc4") = "0", "btn alert-success", (If(Eval("doc4") = "1", "btn alert-danger", "btn btn-default"))) %>'
     ><span   class='<%# If(Eval("doc4") = "0", "glyphicon glyphicon-check", (If(Eval("doc4") = "1", "glyphicon glyphicon-ban-circle", ""))) %>'         
         ></span></asp:LinkButton>     
                     ...
                     <asp:TemplateField HeaderText="Curso Básico">
                            <ItemTemplate>
     <asp:LinkButton  OnClick="ibVer_Click5"  ID="imgDoc5"  runat="server"  ToolTip='<%# If(Eval("doc5") = "0", "Correcto", (If(Eval("doc5") = "1", "No Correcto", ""))) %>'
    class='<%# If(Eval("doc5") = "0", "btn alert-success", (If(Eval("doc5") = "1", "btn alert-danger", "btn btn-default"))) %>'
     ><span   class='<%# If(Eval("doc5") = "0", "glyphicon glyphicon-check", (If(Eval("doc5") = "1", "glyphicon glyphicon-ban-circle", ""))) %>'         
         ></span></asp:LinkButton>     
                    ...
                    <asp:TemplateField HeaderText="Nom. Recurso preventivo">
                            <ItemTemplate>
     <asp:LinkButton  OnClick="ibVer_Click6" ID="imgDoc6"  runat="server"    ToolTip='<%# If(Eval("doc6") = "0", "Correcto", (If(Eval("doc6") = "1", "No Correcto", ""))) %>'
    class='<%# If(Eval("doc6") = "0", "btn alert-success", (If(Eval("doc6") = "1", "btn alert-danger", "btn btn-default"))) %>'
