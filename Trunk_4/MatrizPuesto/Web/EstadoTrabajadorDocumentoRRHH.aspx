<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Adok_plantas.Master" CodeBehind="EstadoTrabajadorDocumentoRRHH.aspx.vb" Inherits="AdokWeb.EstadoTrabajadorDocumentoRRHH" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cuerpoPrincipal" runat="server">
            ...
            <asp:View ID="view1" runat="server">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-3">
                     ...
                     <asp:Button class="btn btn-primary" runat="server" OnClick="btoVolverEmpresa_click" ID="btnVolverEmpresa" Text="Volver a Buscar Trabajador" />
                        ...
                        <asp:TemplateField HeaderText="Estado">
                            <ItemTemplate>
                                <asp:LinkButton  ID="imgEstado" runat="server" ToolTip='<%# Eval("txtcorrecto")%>'
                                    class='<%# If(Eval("txtcorrecto") = "Apto", "btn alert-success", (If(Eval("txtcorrecto") = "No Apto", "btn alert-danger", "btn alert-warning"))) %>'><span 
    class='<%# If(Eval("txtcorrecto") = "Apto", "glyphicon glyphicon-check", (If(Eval("txtcorrecto") = "No Apto", "glyphicon glyphicon-ban-circle", "glyphicon glyphicon-warning-sign"))) %>'
    ...
    class='<%# If(Eval("txtcorrecto") = "Apto", "", (If(Eval("txtcorrecto") = "No Apto", "glyphicon glyphicon-arrow-right", ""))) %>'         
         '></span></asp:LinkButton>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-lg-offset-2">
                            ...
                            <asp:Label visible="false" runat="server" ID="Label331" Width="20%" Text="Periodicidad" />&nbsp;&nbsp;&nbsp;
                            <br />

                            <asp:DropDownList  visible="false" class="form-control" ID="ddlCaducidad2" runat="server" AutoPostBack="True">
                            </asp:DropDownList>
                            ...
                            <asp:Label  visible="false" runat="server" ID="Label3" Text="Subido por" />

                            <asp:TextBox  visible="false" class="form-control" ID="txtUbicacion" runat="server" ReadOnly="True" />
                            ...
                            <asp:RadioButtonList Enabled="false" CssClass=" btn-group-justified " Width="80%" ID="rblCorrecto" runat="server" AutoPostBack="false" RepeatDirection="Horizontal">
                                <asp:ListItem Text="Apto" Value="0" Selected="True" enabled="true"/>
                                <asp:ListItem Text="No Apto" Value="1" enabled="true"/>
                              <asp:ListItem Text="No Validado." Value="2" enabled="true"/>
                                <asp:ListItem Text="NO CADUCA." Value="3" enabled="true"/>
                            </asp:RadioButtonList>

<%--                                  <br />
                            <asp:Label visible="false" runat="server" ID="Label2" Text="Fecha de aviso para revisión " />:
     ...
     <span class="input-group-addon">
         <span class="glyphicon glyphicon-calendar"></span>
                            ...
                            <%--<act:CalendarExtender ID="imgCalendarioResolucionDesde3_CalendarExtender" runat="server" TargetControlID="TxtFechaIni" PopupButtonID="imgCalendarioResolucionDesde3" />--%>
                                    ...
                                    <br />
                            <asp:Label runat="server" ID="Label5" Text="Comentario " />:
