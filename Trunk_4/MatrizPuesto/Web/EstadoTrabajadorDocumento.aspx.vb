...
Public Class EstadoTrabajadorDocumento
    Inherits PageBase
...
#End Region
    ...
    Protected Sub btoVolverEmpresa_click(sender As Object, e As EventArgs) Handles btnVolverEmpresa.Click
        Try
            If Request.QueryString("empresa") <> "" Then
                If idTrabajadorParam > 0 Then
                    Response.Redirect("~/EstadoEmpresaDocumento.aspx?empresa=" & idTrabajadorParam & "&pagina=" & gvType.PageIndex, False)
                Else
