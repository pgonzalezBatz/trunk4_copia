        ...
        Try
            ...
            For j = 0 To listaTrabajadores.Count - 1
              ...
              '          listaTrabajadores(j).doc1 = no_correcto
                ...
                'ultimo
                'para el segundo doc, poner todo lo de arriba
                If listaType4.Count > 12 Then
                    cab12 = listaType4(12).Nombre
                End If

                If listaType4.Count > 12 Then 'And listaTrabajadores(j).doc6 >= 0
                    i = 12 ' por ser el primer doc
                    ...
                    If listaType2.Count > 0 Then
                        ...
                        i = 0 'siempre 0
                        listaTrabajadores(j).nec13 = listaType2(i).necesario
                        ...
                        'mostramos un icono u otro en función de si es ok o no, o no es obligatorio
                        If no_correcto = 1 Then
                            listaTrabajadores(j).doc13 = no_correcto
                        ...
                        Else
                            If no_correcto = 2 Then
                                ...
                                listaTrabajadores(j).doc13 = 2
                                listaType2(i).txtcorrecto = "Avisos"
                            Else

                                listaTrabajadores(j).doc13 = 0
                ...
                'el 13
                'para el segundo doc, poner todo lo de arriba
                If listaType4.Count > 13 Then
                    cab13 = listaType4(13).Nombre
                End If

                If listaType4.Count > 13 Then 'And listaTrabajadores(j).doc6 >= 0
                    i = 13 ' por ser el primer doc
                    ...
                    If listaType2.Count > 0 Then
                        ...
                        i = 0 'siempre 0
                        listaTrabajadores(j).nec14 = listaType2(i).necesario
                        ...
                        'mostramos un icono u otro en función de si es ok o no, o no es obligatorio
                        If no_correcto = 1 Then
                            listaTrabajadores(j).doc14 = no_correcto
                        ...
                        Else
                            If no_correcto = 2 Then
                                ...
                                listaTrabajadores(j).doc14 = 2
                                listaType2(i).txtcorrecto = "Avisos"
                            Else

                                listaTrabajadores(j).doc14 = 0
                ...
                'el 11
                'para el segundo doc, poner todo lo de arriba
                If listaType4.Count > 14 Then
                    cab14 = listaType4(14).Nombre
                End If

                If listaType4.Count > 14 Then 'And listaTrabajadores(j).doc6 >= 0
                    i = 14 ' por ser el primer doc
                    ...
                    If listaType2.Count > 0 Then
                        ...
                        i = 0 'siempre 0
                        listaTrabajadores(j).nec15 = listaType2(i).necesario
                        ...
                        'mostramos un icono u otro en función de si es ok o no, o no es obligatorio
                        If no_correcto = 1 Then
                            listaTrabajadores(j).doc15 = no_correcto
                        ...
                        Else
                            If no_correcto = 2 Then
                                ...
                                listaTrabajadores(j).doc15 = 2
                                listaType2(i).txtcorrecto = "Avisos"
                            Else

                                listaTrabajadores(j).doc15 = 0
                ...
                'el 11
                'para el segundo doc, poner todo lo de arriba
                If listaType4.Count > 15 Then
                    cab15 = listaType4(15).Nombre
                End If

                If listaType4.Count > 15 Then 'And listaTrabajadores(j).doc6 >= 0
                    i = 15 ' por ser el primer doc
                    ...
                    If listaType2.Count > 0 Then
                        ...
                        i = 0 'siempre 0
                        listaTrabajadores(j).nec16 = listaType2(i).necesario
                        ...
                        'mostramos un icono u otro en función de si es ok o no, o no es obligatorio
                        If no_correcto = 1 Then
                            listaTrabajadores(j).doc16 = no_correcto
                        ...
                        Else
                            If no_correcto = 2 Then
                                ...
                                listaTrabajadores(j).doc16 = 2
                                listaType2(i).txtcorrecto = "Avisos"
                            Else

                                listaTrabajadores(j).doc16 = 0
...
#End Region
    ...
    Protected Sub btnMarcarTodos_Click(sender As Object, e As EventArgs) Handles btnMarcarTodos.Click
        Try
            ...
            For j = 0 To gvType2.Rows.Count - 1
                ...
                Dim CheckBoxElim13 As CheckBox = CType(gvType2.Rows(j).FindControl("imgDoc13"), CheckBox)
                If CheckBoxElim13 IsNot Nothing Then
                    CheckBoxElim13.Checked = True
                End If
                Dim CheckBoxElim14 As CheckBox = CType(gvType2.Rows(j).FindControl("imgDoc14"), CheckBox)
                If CheckBoxElim14 IsNot Nothing Then
                    CheckBoxElim14.Checked = True
                End If
                Dim CheckBoxElim15 As CheckBox = CType(gvType2.Rows(j).FindControl("imgDoc15"), CheckBox)
                If CheckBoxElim15 IsNot Nothing Then
                    CheckBoxElim15.Checked = True
                End If
            Next
            '''''''''    chkMarcados.Value = 1
    ...
    Protected Sub gvType2_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvType2.RowCommand
        ...
        If e.CommandName = "Edit" Then
            ...
            'Dim IdEmpre2 As Int32 = DirectCast(DirectCast(e.CommandSource, System.Web.UI.Control).DataItemContainer.DataKeysContainer, System.Web.UI.WebControls.BaseDataBoundControl).DataSource(CInt(DirectCast(DirectCast(e.CommandSource, System.Web.UI.Control).NamingContainer, System.Web.UI.WebControls.GridViewRow).DataItemIndex)).NIF
            'listaType = oDocBLL.CargarListaTrabajadorestexto(PageBase.plantaAdmin, hfTra.Value)

            Response.Redirect("~/EstadoTrabajadorDocumento.aspx?link=" & trabajadores(0).Id, False)
        End If
    ...
    Private Sub gvType2_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles gvType2.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            End If
            Dim imgDoc13 As CheckBox = CType(e.Row.FindControl("imgDoc13"), CheckBox)
            If cab12 <> "" Then
                imgDoc13.Visible = True
            End If
            Dim imgDoc14 As CheckBox = CType(e.Row.FindControl("imgDoc14"), CheckBox)
            If cab13 <> "" Then
                imgDoc14.Visible = True
            End If
            Dim imgDoc15 As CheckBox = CType(e.Row.FindControl("imgDoc15"), CheckBox)
            If cab14 <> "" Then
                imgDoc15.Visible = True
            End If
            Dim imgDoc16 As CheckBox = CType(e.Row.FindControl("imgDoc16"), CheckBox)
            If cab15 <> "" Then
                imgDoc16.Visible = True
            End If
        End If
    End Sub
    ...
    Private Sub gvType2_PreRender(sender As Object, e As EventArgs) Handles gvType2.PreRender
        ...
        gvType2.Columns(29).HeaderText = cab12
        gvType2.Columns(31).HeaderText = cab13
        gvType2.Columns(33).HeaderText = cab14
        gvType2.Columns(35).HeaderText = cab15
        If cab0 = "" Then
        ...
        Else
            gvType2.Columns(28).Visible = True
        End If
        If cab13 = "" Then
            gvType2.Columns(30).Visible = False
        Else
            gvType2.Columns(30).Visible = True
        End If
        If cab14 = "" Then
            gvType2.Columns(32).Visible = False
        Else
            gvType2.Columns(32).Visible = True
        End If
        gvType2.Columns(34).Visible = False
