...
#Region "Eventos de pagina"
    ...
    Protected Sub Page_Render(ByVal sender As Object, ByVal e As EventArgs) Handles Me.PreRender
        ...
        lblMensaje.Text = m_Mensaje : pnlMensaje.Visible = True
...
#Region "Menu"
    ...
    Protected Sub menu_DataBound(ByVal sender As Object, ByVal e As EventArgs) Handles menu.DataBound
        ...
        If (mn IsNot Nothing AndAlso mn.Items.Count > 0) Then
            ...
            For i = mn.Items.Count - 1 To 0 Step -1
                ...
                If (Session("Admin") Is Nothing AndAlso mnItem.Value = "admin") Then
                    mn.Items.Remove(mnItem)
                    bConstruirMenu = False
                End If
                If (mnItem.Value = "inf") Then
                    mnItem.Target = "_blank"
                    mnItem.NavigateUrl = GetUrlInforme("KPI_REPORT")
                End If
    ...
    Private Sub ConstruirMenu(ByVal mnItem As MenuItem)
        ...
        For i = mnItem.ChildItems.Count - 1 To 0 Step -1
            ...
            If (Session("Admin") Is Nothing AndAlso mnItem1.Value = "admin") Then
                mnItem.ChildItems.RemoveAt(i)
                bConstruirMenu = False
            ElseIf (mnItem1.Value = "help") Then
                mnItem1.Target = "_blank"
            End If                 
    ...
    ''' <summary>
    ''' Obtiene la url del informe parametrizado
    ''' </summary>
    ''' <param name="nombreInforme">Nombre del informe</param>		
    Public Function GetUrlInforme(ByVal nombreInforme As String) As String
