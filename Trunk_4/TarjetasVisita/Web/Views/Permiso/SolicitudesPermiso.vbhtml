...
<script type="text/javascript">
    $(function () {
        $(".autorizar").click(function () {
            return confirm('@Html.Raw(Utils.Traducir("¿Desea autorizar la solicitud seleccionada?"))');
        });

        $(".rechazar").click(function () {
            return confirm('@Html.Raw(Utils.Traducir("¿Desea rechazar la solicitud seleccionada?"))');
        });
    })
</script>

<h3>@Utils.Traducir("Solicitudes permiso")</h3>
<hr />
