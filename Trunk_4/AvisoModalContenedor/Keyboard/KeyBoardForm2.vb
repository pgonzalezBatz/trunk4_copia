...
Public Class KeyBoardForm2
    Inherits NoActivate.NoActivateWindow

    Public Event TeclaContenidoPulsada(ByVal key As String)
    ...
    Private _showNumericKeyboard As Boolean = True
    ''' <summary>
    ''' Indica si se mostrara el teclado numerico o no
    ''' </summary>
    ''' <value></value>
    ''' <returns></returns>    
    Public Property ShowNumericKeyboard() As Boolean
        Get
...
#Region "Handle key board event"
    ...
    Private Sub KeyBoardForm_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        Try
            ...
            'pnlNumericKeyboard.Visible = ShowNumericKeyboard
    ...
    Private Sub InitializeKeyButtons()
        ...
        Dim keysMappingDoc = XDocument.Load(Modulo.KeyboardPathConfig & "Resources\KeysMapping.xml")
        For Each key In keysMappingDoc.Root.Elements()
            ...
            For Each btn As KeyButton In btns
                ...
                '                      keyButtonCapsLock.IsPressed)
                btn.UpdateDisplayText(False, False, False)
            Next btn
