<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="SeleccionUsuarios.ascx.vb" Inherits="IstrikuWebRaiz.SeleccionUsuarios" %>
				...
				<tr>
					<td style="width: 675px;">
						...
						<table style="border: 0; width: 100%">
							...
							<tr>
								<td style="width: 99%">
									<asp:TextBox ID="txtResponsable" runat="server" AutoPostBack="false" Width="99%" />
								...
								<td>
									<asp:ImageButton ID="btnBilatu" runat="server" ImageUrl="~/App_Themes/Tema1/IconosAcciones/Buscador/Filtrar24.png" ToolTip="Buscar" AlternateText="Buscar" />
								</td>
							</tr>
						</table>
