...
Public Class BatzException
	...
	Private log As ILog = LogManager.GetLogger("root.IstrikuLib")
	...
	Public Sub LogError()
		Try
			'Dim loc As New AccesoGenerico
			'_termino = loc.GetTermino(_key, System.Threading.Thread.CurrentThread.CurrentCulture.Name)
			'log.Error(_termino, _excepcion)

			log.Error(_key, _excepcion)
		Catch
