<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MPWeb.Master" CodeBehind="Documento.aspx.vb" Inherits="GertakariakMSWeb_Raiz.Documento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cp" runat="server">
	<%--<asp:UpdatePanel ID="upDocumento" runat="server" UpdateMode="Conditional">
		<ContentTemplate>--%>
	<table class="GridViewASP" border="1">
			...
			<td>
				<table>
					<tr>
						...
						<td style="text-align: left" class="ListSearchExtenderPrompt">
							(<asp:Label ID="Label6" runat="server" Text="Tamaño Maximo"/>: <asp:Label ID="lblMaxRequestLength" runat="server" Text="?" />)
						</td>
					</tr>
				</table>
			</td>
