<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Mensajes.ascx.vb" Inherits="GTK_Troqueleria.Mensajes" %>
<asp:UpdatePanel ID="upMensaje" runat="server">
    <ContentTemplate>        
        <%--<asp:HiddenField ID="hfOculto" runat="server" />--%>
        <div style="display: none;"><asp:TextBox ID="hfOculto" runat="server"></asp:TextBox></div>
        ...
        <asp:Panel ID="pnlMensaje" runat="server" CssClass="modalBox" Style="display: none;">
            <table style="border-collapse:collapse; margin:5px;">
                <tr class="BarraTitulo">
                    <th style="text-align:left"><asp:Image ID="imgVentana" runat="server" ImageUrl="~/App_Themes/Batz/IconosAjaxControl/VentanaMensajes/info-icon24.png" ImageAlign="Middle"/></th>
                    ...
                    <td colspan="2">
                        <table>
                            <tr>
                                ...
                                <td><asp:Label ID="lblMensaje" runat="server" Text="lblMensaje" CssClass="MensajeError"></asp:Label></td>
                            </tr>
                        </table>
                    </td>
                </tr>
