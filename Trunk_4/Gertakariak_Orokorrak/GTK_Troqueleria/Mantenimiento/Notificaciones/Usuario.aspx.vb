...
#Region "Eventos de Objetos"
    Private Sub btnAceptar_Click(sender As Object, e As ImageClickEventArgs) Handles btnAceptar.Click
        Try
            ...
            Dim Estructura = (From Reg As BatzBBDD.ESTRUCTURA In BBDD.ESTRUCTURA Where Reg.ID = My.Settings.IdNotificaciones Select Reg).SingleOrDefault
            ...
            If lUsr.Any Then
                ...
                Dim UG As BatzBBDD.ESTRUCTURA = (From Reg As BatzBBDD.ESTRUCTURA In BBDD.ESTRUCTURA Where Reg.IDITURRIA = My.Settings.IdNotificaciones And Reg.ID = ddl.SelectedValue Select Reg).SingleOrDefault

                If UG Is Nothing Then
                    UG = New BatzBBDD.ESTRUCTURA With {.IDITURRIA = My.Settings.IdNotificaciones, .ID = ddl.SelectedValue, .DESCRIPCION = ddl.SelectedItem.Text}
            ...
            Response.Redirect("~/Mantenimiento/Notificaciones/ListadoNotificaciones.aspx", True)
...
#Region "Funciones y Procesos"
    Sub CargarDatos()
        'ddl.DataSource = BBDD.CPLANTEGI.OrderBy(Function(o) o.DESCRI).ToList.Select(Function(o) New ListItem(o.DESCRI, o.LANTEGI))
        ddl.DataSource = BBDD.ESTRUCTURA.Where(Function(f) f.IDITURRIA = My.Settings.IdNotificaciones).OrderBy(Function(o) o.ORDEN).ToList.Select(Function(o) New ListItem(o.DESCRIPCION, o.ID))
        ddl.DataBind()
        lvOtros.DataBind()
    End Sub
#End Region
