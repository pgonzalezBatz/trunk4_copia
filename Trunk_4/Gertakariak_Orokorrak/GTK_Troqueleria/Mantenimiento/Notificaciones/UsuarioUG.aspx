<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="UsuarioUG.aspx.vb" Inherits="GTK_Troqueleria.UsuarioUG" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder_FORM" runat="server">
    <table class="GridViewASP">
        <thead class="HeaderStyle">
            <tr>
                <th>
                    <asp:Label ID="Label7" runat="server" Text="Unidad de Negocio" ToolTip="UG"></asp:Label>
                    (<asp:Label ID="Label1" runat="server" Text="Lantegi"></asp:Label>)</th>
                <th>
        ...
        <tbody class="RowStyle">
            <tr>
                <td style="width: 1%;" valign="top">
                    <asp:DropDownList runat="server" ID="ddlUG" AppendDataBoundItems="true" DataTextField="Text" DataValueField="Value">
    ...
    <!------------------------------------------------------------------------------------------------------>
    <asp:RequiredFieldValidator ID="rfv_ddlUG" runat="server" ErrorMessage="Campo obligatorio" ControlToValidate="ddlUG" Display="None" ValidationGroup="btnGuardar" />
	<act:ValidatorCalloutExtender ID="vce_rfv_ddlUG" runat="server" TargetControlID="rfv_ddlUG" />
    <!------------------------------------------------------------------------------------------------------>
</asp:Content>
