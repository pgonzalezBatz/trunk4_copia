...
Namespace DAL
    ...
    Public MustInherit Class _CAUSASNCKUKTURA
        Inherits OracleClientEntity

        Public Sub New()
            Me.SchemaGlobal = "INCIDENCIAS."
            Me.QuerySource = "CAUSASNCKUKTURA"
            Me.MappingName = "CAUSASNCKUKTURA"
        End Sub
        ...
        Public Function LoadAll() As Boolean
            ...
            Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PL_CAUSASNCKUKTURA", parameters)
        End Function
        ...
        Public Overridable Function LoadByPrimaryKey(ByVal ID As Decimal, ByVal IDCULTURA As String) As Boolean
            ...
            parameters.Add(_CAUSASNCKUKTURA.Parameters.ID, ID)

            parameters.Add(_CAUSASNCKUKTURA.Parameters.IDCULTURA, IDCULTURA)
            ...
            Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PK_CAUSASNCKUKTURA", parameters)
        ...
        Public Class ColumnNames
            ...
            Public Shared Function ToPropertyName(ByVal columnName As String) As String
                ...
                If ht Is Nothing Then
                    ...
                    ht(ID) = _CAUSASNCKUKTURA.PropertyNames.ID
                    ht(IDCULTURA) = _CAUSASNCKUKTURA.PropertyNames.IDCULTURA
                    ht(DESCRIPCION) = _CAUSASNCKUKTURA.PropertyNames.DESCRIPCION
        ...
        Public Class PropertyNames
            ...
            Public Shared Function ToColumnName(ByVal propertyName As String) As String
                ...
                If ht Is Nothing Then
                    ...
                    ht(ID) = _CAUSASNCKUKTURA.ColumnNames.ID
                    ht(IDCULTURA) = _CAUSASNCKUKTURA.ColumnNames.IDCULTURA
                    ht(DESCRIPCION) = _CAUSASNCKUKTURA.ColumnNames.DESCRIPCION
...
#End Region
        ...
        Protected Overrides Function GetInsertCommand() As IDbCommand
            ...
            cmd.CommandText = Me.SchemaStoredProcedure + "PI_CAUSASNCKUKTURA"
        ...
        Protected Overrides Function GetUpdateCommand() As IDbCommand
            ...
            Dim cmd As OracleCommand = New OracleCommand
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = Me.SchemaStoredProcedure + "PU_CAUSASNCKUKTURA"
        ...
        Protected Overrides Function GetDeleteCommand() As IDbCommand
            ...
            Dim cmd As OracleCommand = New OracleCommand
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = Me.SchemaStoredProcedure + "PD_CAUSASNCKUKTURA"
