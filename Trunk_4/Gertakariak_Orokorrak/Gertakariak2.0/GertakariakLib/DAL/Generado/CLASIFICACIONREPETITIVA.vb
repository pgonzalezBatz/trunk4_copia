...
Namespace DAL
    ...
    Public MustInherit Class _CLASIFICACIONREPETITIVA
        Inherits OracleClientEntity

        Public Sub New()
            Me.SchemaGlobal = "INCIDENCIAS."
            Me.QuerySource = "CLASIFICACIONREPETITIVA"
            Me.MappingName = "CLASIFICACIONREPETITIVA"
        End Sub
        ...
        Public Function LoadAll() As Boolean
            ...
            Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PL_CLASIFICACIONREPETITIVA", parameters)
        End Function
        ...
        Public Overridable Function LoadByPrimaryKey(ByVal ID As Decimal) As Boolean
            ...
            parameters.Add(_CLASIFICACIONREPETITIVA.Parameters.ID, ID)
            ...
            Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PK_CLASIFICACIONREPETITIVA", parameters)
        ...
        Public Class ColumnNames
            ...
            Public Shared Function ToPropertyName(ByVal columnName As String) As String
                ...
                If ht Is Nothing Then
                    ...
                    ht(ID) = _CLASIFICACIONREPETITIVA.PropertyNames.ID
                    ht(ORDEN) = _CLASIFICACIONREPETITIVA.PropertyNames.ORDEN
                    ht(OBSOLETO) = _CLASIFICACIONREPETITIVA.PropertyNames.OBSOLETO
        ...
        Public Class PropertyNames
            ...
            Public Shared Function ToColumnName(ByVal propertyName As String) As String
                ...
                If ht Is Nothing Then
                    ...
                    ht(ID) = _CLASIFICACIONREPETITIVA.ColumnNames.ID
                    ht(ORDEN) = _CLASIFICACIONREPETITIVA.ColumnNames.ORDEN
                    ht(OBSOLETO) = _CLASIFICACIONREPETITIVA.ColumnNames.OBSOLETO
...
#End Region
        ...
        Protected Overrides Function GetInsertCommand() As IDbCommand
            ...
            cmd.CommandText = Me.SchemaStoredProcedure + "PI_CLASIFICACIONREPETITIVA"
        ...
        Protected Overrides Function GetUpdateCommand() As IDbCommand
            ...
            Dim cmd As OracleCommand = New OracleCommand
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = Me.SchemaStoredProcedure + "PU_CLASIFICACIONREPETITIVA"
        ...
        Protected Overrides Function GetDeleteCommand() As IDbCommand
            ...
            Dim cmd As OracleCommand = New OracleCommand
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = Me.SchemaStoredProcedure + "PD_CLASIFICACIONREPETITIVA"
