...
Namespace DAL
    ...
    Public MustInherit Class _TIPOREPETITIVA
        Inherits OracleClientEntity

        Public Sub New()
            Me.SchemaGlobal = "INCIDENCIAS."
            Me.QuerySource = "TIPOREPETITIVA"
            Me.MappingName = "TIPOREPETITIVA"
        End Sub
        ...
        Public Function LoadAll() As Boolean
            ...
            Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PL_TIPOREPETITIVA", parameters)
        End Function
        ...
        Public Overridable Function LoadByPrimaryKey(ByVal ID As Decimal) As Boolean
            ...
            parameters.Add(_TIPOREPETITIVA.Parameters.ID, ID)
            ...
            Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PK_TIPOREPETITIVA", parameters)
...
#Region "Parameters"
        Protected Class Parameters
            ...
            Public Shared ReadOnly Property ORDEN As OracleParameter
                Get
                    Return New OracleParameter("p_ORDEN", Oracle.ManagedDataAccess.Client.OracleDbType.Int32, 0)
                End Get
            End Property
        ...
        Public Class ColumnNames
            ...
            Public Shared Function ToPropertyName(ByVal columnName As String) As String
                ...
                If ht Is Nothing Then
                    ...
                    ht(ID) = _TIPOREPETITIVA.PropertyNames.ID
                    ht(ORDEN) = _TIPOREPETITIVA.PropertyNames.ORDEN
                    ht(IDFAMILIAREPETITIVA) = _TIPOREPETITIVA.PropertyNames.IDFAMILIAREPETITIVA
                    ht(OBSOLETO) = _TIPOREPETITIVA.PropertyNames.OBSOLETO
        ...
        Public Class PropertyNames
            ...
            Public Shared Function ToColumnName(ByVal propertyName As String) As String
                ...
                If ht Is Nothing Then
                    ...
                    ht(ID) = _TIPOREPETITIVA.ColumnNames.ID
                    ht(ORDEN) = _TIPOREPETITIVA.ColumnNames.ORDEN
                    ht(IDFAMILIAREPETITIVA) = _TIPOREPETITIVA.ColumnNames.IDFAMILIAREPETITIVA
                    ht(OBSOLETO) = _TIPOREPETITIVA.ColumnNames.OBSOLETO
...
#End Region
        ...
        Protected Overrides Function GetInsertCommand() As IDbCommand
            ...
            cmd.CommandText = Me.SchemaStoredProcedure + "PI_TIPOREPETITIVA"
        ...
        Protected Overrides Function GetUpdateCommand() As IDbCommand
            ...
            Dim cmd As OracleCommand = New OracleCommand
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = Me.SchemaStoredProcedure + "PU_TIPOREPETITIVA"
        ...
        Protected Overrides Function GetDeleteCommand() As IDbCommand
            ...
            Dim cmd As OracleCommand = New OracleCommand
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = Me.SchemaStoredProcedure + "PD_TIPOREPETITIVA"
