...
Namespace DAL
    ...
    Public MustInherit Class _FAMILIAREPETITIVA
        Inherits OracleClientEntity

        Public Sub New()
            Me.SchemaGlobal = "INCIDENCIAS."
            Me.QuerySource = "FAMILIAREPETITIVA"
            Me.MappingName = "FAMILIAREPETITIVA"
        End Sub
        ...
        Public Function LoadAll() As Boolean
            ...
            Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PL_FAMILIAREPETITIVA", parameters)
        End Function
        ...
        Public Overridable Function LoadByPrimaryKey(ByVal ID As Decimal) As Boolean
            ...
            parameters.Add(_FAMILIAREPETITIVA.Parameters.ID, ID)
            ...
            Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PK_FAMILIAREPETITIVA", parameters)
        ...
        Public Class ColumnNames
            ...
            Public Shared Function ToPropertyName(ByVal columnName As String) As String
                ...
                If ht Is Nothing Then
                    ...
                    ht(ID) = _FAMILIAREPETITIVA.PropertyNames.ID
                    ht(ORDEN) = _FAMILIAREPETITIVA.PropertyNames.ORDEN
                    ht(IDCLASIFICACIONFAMILIA) = _FAMILIAREPETITIVA.PropertyNames.IDCLASIFICACIONFAMILIA
                    ht(OBSOLETO) = _FAMILIAREPETITIVA.PropertyNames.OBSOLETO
        ...
        Public Class PropertyNames
            ...
            Public Shared Function ToColumnName(ByVal propertyName As String) As String
                ...
                If ht Is Nothing Then
                    ...
                    ht(ID) = _FAMILIAREPETITIVA.ColumnNames.ID
                    ht(ORDEN) = _FAMILIAREPETITIVA.ColumnNames.ORDEN
                    ht(IDCLASIFICACIONFAMILIA) = _FAMILIAREPETITIVA.ColumnNames.IDCLASIFICACIONFAMILIA
                    ht(OBSOLETO) = _FAMILIAREPETITIVA.ColumnNames.OBSOLETO
...
#End Region
        ...
        Protected Overrides Function GetInsertCommand() As IDbCommand
            ...
            cmd.CommandText = Me.SchemaStoredProcedure + "PI_FAMILIAREPETITIVA"
        ...
        Protected Overrides Function GetUpdateCommand() As IDbCommand
            ...
            Dim cmd As OracleCommand = New OracleCommand
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = Me.SchemaStoredProcedure + "PU_FAMILIAREPETITIVA"
        ...
        Protected Overrides Function GetDeleteCommand() As IDbCommand
            ...
            Dim cmd As OracleCommand = New OracleCommand
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = Me.SchemaStoredProcedure + "PD_FAMILIAREPETITIVA"
