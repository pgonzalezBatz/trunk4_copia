...
Namespace DAL
    ...
    Public MustInherit Class _TIPONOCONFORMIDAD
        Inherits OracleClientEntity

        Public Sub New()
            Me.SchemaGlobal = "INCIDENCIAS."
            Me.QuerySource = "TIPONOCONFORMIDAD"
            Me.MappingName = "TIPONOCONFORMIDAD"
        End Sub
        ...
        Public Function LoadAll() As Boolean
            ...
            Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PL_TIPONOCONFORMIDAD", parameters)
        ...
        Public Overridable Function LoadByPrimaryKey(ByVal ID As Decimal) As Boolean
            ...
            parameters.Add(_TIPONOCONFORMIDAD.Parameters.ID, ID)
            ...
            Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PK_TIPONOCONFORMIDAD", parameters)
        ...
        Public Class ColumnNames
            ...
            Public Shared Function ToPropertyName(ByVal columnName As String) As String
                ...
                If ht Is Nothing Then
                    ...
                    ht(ID) = _TIPONOCONFORMIDAD.PropertyNames.ID
                    ht(ORDEN) = _TIPONOCONFORMIDAD.PropertyNames.ORDEN
        ...
        Public Class PropertyNames
            ...
            Public Shared Function ToColumnName(ByVal propertyName As String) As String
                ...
                If ht Is Nothing Then
                    ...
                    ht(ID) = _TIPONOCONFORMIDAD.ColumnNames.ID
                    ht(ORDEN) = _TIPONOCONFORMIDAD.ColumnNames.ORDEN
...
#End Region
        ...
        Protected Overrides Function GetInsertCommand() As IDbCommand
            ...
            cmd.CommandText = Me.SchemaStoredProcedure + "PI_TIPONOCONFORMIDAD"
        ...
        Protected Overrides Function GetUpdateCommand() As IDbCommand
            ...
            Dim cmd As OracleCommand = New OracleCommand
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = Me.SchemaStoredProcedure + "PU_TIPONOCONFORMIDAD"
        ...
        Protected Overrides Function GetDeleteCommand() As IDbCommand
            ...
            Dim cmd As OracleCommand = New OracleCommand
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = Me.SchemaStoredProcedure + "PD_TIPONOCONFORMIDAD"
