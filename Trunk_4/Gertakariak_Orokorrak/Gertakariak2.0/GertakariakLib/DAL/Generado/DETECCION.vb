...
Namespace DAL
    ...
    Public MustInherit Class _DETECCION
        Inherits OracleClientEntity

        Public Sub New()
            Me.SchemaGlobal = "INCIDENCIAS."
            Me.QuerySource = "DETECCION"
            Me.MappingName = "DETECCION"
        End Sub
        ...
        Public Function LoadAll() As Boolean
            ...
            Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PL_DETECCION", parameters)
        End Function
        ...
        Public Overridable Function LoadByPrimaryKey(ByVal ID As Decimal) As Boolean
            ...
            parameters.Add(_DETECCION.Parameters.ID, ID)
            ...
            Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PK_DETECCION", parameters)
...
#Region "Parameters"
        Protected Class Parameters
            ...
            Public Shared ReadOnly Property IDDEPARTAMENTO As OracleParameter
                Get
                    Return New OracleParameter("p_IDDEPARTAMENTO", OracleDbType.Int32, 0)
                End Get
            End Property
        ...
        Public Class ColumnNames
            ...
            Public Shared Function ToPropertyName(ByVal columnName As String) As String
                ...
                If ht Is Nothing Then
                    ...
                    ht(IDINCIDENCIA) = _DETECCION.PropertyNames.IDINCIDENCIA
                    ht(IDUSUARIO) = _DETECCION.PropertyNames.IDUSUARIO
                    ht(IDDEPARTAMENTO) = _DETECCION.PropertyNames.IDDEPARTAMENTO
                    ht(ID) = _DETECCION.PropertyNames.ID
        ...
        Public Class PropertyNames
            ...
            Public Shared Function ToColumnName(ByVal propertyName As String) As String
                ...
                If ht Is Nothing Then
                    ...
                    ht(IDINCIDENCIA) = _DETECCION.ColumnNames.IDINCIDENCIA
                    ht(IDUSUARIO) = _DETECCION.ColumnNames.IDUSUARIO
                    ht(IDDEPARTAMENTO) = _DETECCION.ColumnNames.IDDEPARTAMENTO
                    ht(ID) = _DETECCION.ColumnNames.ID
...
#Region "Properties"
        ...
        Public Overridable Property IDDEPARTAMENTO As Decimal
            Get
                Return MyBase.GetDecimal(ColumnNames.IDDEPARTAMENTO)
            End Get
            Set(ByVal Value As Decimal)
                MyBase.SetDecimal(ColumnNames.IDDEPARTAMENTO, Value)
            End Set
        End Property
        ...
        Public Overridable Property s_IDDEPARTAMENTO As String
            Get
                If Me.IsColumnNull(ColumnNames.IDDEPARTAMENTO) Then
                    Return String.Empty
                Else
                    Return MyBase.GetDecimalAsString(ColumnNames.IDDEPARTAMENTO)
                End If
            End Get
            Set(ByVal Value As String)
                If String.Empty = Value Then
                ...
                Else
                    Me.IDDEPARTAMENTO = MyBase.SetDecimalAsString(ColumnNames.IDDEPARTAMENTO, Value)
                End If
            End Set
        End Property
...
#End Region
        ...
        Protected Overrides Function GetInsertCommand() As IDbCommand
            ...
            cmd.CommandText = Me.SchemaStoredProcedure + "PI_DETECCION"
        ...
        Protected Overrides Function GetUpdateCommand() As IDbCommand
            ...
            Dim cmd As OracleCommand = New OracleCommand
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = Me.SchemaStoredProcedure + "PU_DETECCION"
        ...
        Protected Overrides Function GetDeleteCommand() As IDbCommand
            ...
            Dim cmd As OracleCommand = New OracleCommand
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = Me.SchemaStoredProcedure + "PD_DETECCION"
