...
Namespace DAL
    ...
    Public MustInherit Class _ACCIONES_USUARIOS
        Inherits OracleClientEntity

        Public Sub New()
            Me.SchemaGlobal = "INCIDENCIAS."
            Me.QuerySource = "ACCIONES_USUARIOS"
            Me.MappingName = "ACCIONES_USUARIOS"
        End Sub
        ...
        Public Function LoadAll() As Boolean
            ...
            Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PL_ACCIONES_USUARIOS", parameters)
        End Function
        ...
        Public Overridable Function LoadByPrimaryKey(ByVal IDACCION As Decimal, ByVal IDUSUARIO As Decimal) As Boolean
            ...
            parameters.Add(_ACCIONES_USUARIOS.Parameters.IDACCION, IDACCION)

            parameters.Add(_ACCIONES_USUARIOS.Parameters.IDUSUARIO, IDUSUARIO)
            ...
            Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PK_ACCIONES_USUARIOS", parameters)
        ...
        Public Class ColumnNames
            ...
            Public Shared Function ToPropertyName(ByVal columnName As String) As String
                ...
                If ht Is Nothing Then
                    ...
                    ht(IDACCION) = _ACCIONES_USUARIOS.PropertyNames.IDACCION
                    ht(IDUSUARIO) = _ACCIONES_USUARIOS.PropertyNames.IDUSUARIO
        ...
        Public Class PropertyNames
            ...
            Public Shared Function ToColumnName(ByVal propertyName As String) As String
                ...
                If ht Is Nothing Then
                    ...
                    ht(IDACCION) = _ACCIONES_USUARIOS.ColumnNames.IDACCION
                    ht(IDUSUARIO) = _ACCIONES_USUARIOS.ColumnNames.IDUSUARIO
...
#End Region
        ...
        Protected Overrides Function GetInsertCommand() As IDbCommand
            ...
            cmd.CommandText = Me.SchemaStoredProcedure + "PI_ACCIONES_USUARIOS"
        ...
        Protected Overrides Function GetUpdateCommand() As IDbCommand
            ...
            Dim cmd As OracleCommand = New OracleCommand
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = Me.SchemaStoredProcedure + "PU_ACCIONES_USUARIOS"
        ...
        Protected Overrides Function GetDeleteCommand() As IDbCommand
            ...
            Dim cmd As OracleCommand = New OracleCommand
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = Me.SchemaStoredProcedure + "PD_ACCIONES_USUARIOS"
