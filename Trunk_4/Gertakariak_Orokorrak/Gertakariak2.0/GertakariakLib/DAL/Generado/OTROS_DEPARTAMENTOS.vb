...
Namespace DAL
    ...
    Public MustInherit Class _OTROS_DEPARTAMENTOS
        Inherits OracleClientEntity

        Public Sub New()
            Me.SchemaGlobal = "INCIDENCIAS."
            Me.QuerySource = "OTROS_DEPARTAMENTOS"
            Me.MappingName = "OTROS_DEPARTAMENTOS"
        End Sub
        ...
        Public Function LoadAll() As Boolean
            ...
            Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PL_OTROS_DEPARTAMENTOS", parameters)
        End Function
        ...
        '=================================================================
        Public Overridable Function LoadByPrimaryKey(ByVal CODARE As String, ByVal CODPROC As String, ByVal CODSEC As String) As Boolean

            Dim parameters As ListDictionary = New ListDictionary()
            parameters.Add(_OTROS_DEPARTAMENTOS.Parameters.CODARE, CODARE)

            parameters.Add(_OTROS_DEPARTAMENTOS.Parameters.CODPROC, CODPROC)

            parameters.Add(_OTROS_DEPARTAMENTOS.Parameters.CODSEC, CODSEC)
            ...
            Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PK_OTROS_DEPARTAMENTOS", parameters)
...
#Region "Parameters"
        Protected Class Parameters
            ...
            Public Shared ReadOnly Property CODARE As OracleParameter
                Get
                    Return New OracleParameter("p_CODARE", OracleDbType.Varchar2, 1)
                End Get
            End Property

            Public Shared ReadOnly Property DESCRI As OracleParameter
                Get
                    Return New OracleParameter("p_DESCRI", OracleDbType.Varchar2, 30)
                End Get
            End Property

            Public Shared ReadOnly Property CODSEC As OracleParameter
                Get
                    Return New OracleParameter("p_CODSEC", OracleDbType.Char, 4)
                End Get
            End Property

            Public Shared ReadOnly Property DESCSECCIO As OracleParameter
                Get
                    Return New OracleParameter("p_DESCSECCIO", OracleDbType.Varchar2, 30)
                End Get
            End Property
            ...
            Public Shared ReadOnly Property DESCPROC As OracleParameter
                Get
                    Return New OracleParameter("p_DESCPROC", OracleDbType.Varchar2, 30)
                End Get
            End Property
        ...
        Public Class ColumnNames
            ...
            Public Shared Function ToPropertyName(ByVal columnName As String) As String
                ...
                If ht Is Nothing Then
                    ...
                    ht(CODARE) = _OTROS_DEPARTAMENTOS.PropertyNames.CODARE
                    ht(DESCRI) = _OTROS_DEPARTAMENTOS.PropertyNames.DESCRI
                    ht(CODSEC) = _OTROS_DEPARTAMENTOS.PropertyNames.CODSEC
                    ht(DESCSECCIO) = _OTROS_DEPARTAMENTOS.PropertyNames.DESCSECCIO
                    ht(CODPROC) = _OTROS_DEPARTAMENTOS.PropertyNames.CODPROC
                    ht(DESCPROC) = _OTROS_DEPARTAMENTOS.PropertyNames.DESCPROC
                    ht(OBSOLETO) = _OTROS_DEPARTAMENTOS.PropertyNames.OBSOLETO
        ...
        Public Class PropertyNames
            ...
            Public Shared Function ToColumnName(ByVal propertyName As String) As String
                ...
                If ht Is Nothing Then
                    ...
                    ht(CODARE) = _OTROS_DEPARTAMENTOS.ColumnNames.CODARE
                    ht(DESCRI) = _OTROS_DEPARTAMENTOS.ColumnNames.DESCRI
                    ht(CODSEC) = _OTROS_DEPARTAMENTOS.ColumnNames.CODSEC
                    ht(DESCSECCIO) = _OTROS_DEPARTAMENTOS.ColumnNames.DESCSECCIO
                    ht(CODPROC) = _OTROS_DEPARTAMENTOS.ColumnNames.CODPROC
                    ht(DESCPROC) = _OTROS_DEPARTAMENTOS.ColumnNames.DESCPROC
                    ht(OBSOLETO) = _OTROS_DEPARTAMENTOS.ColumnNames.OBSOLETO
...
#End Region
        ...
        Protected Overrides Function GetInsertCommand() As IDbCommand
            ...
            cmd.CommandText = Me.SchemaStoredProcedure + "PI_OTROS_DEPARTAMENTOS"
        ...
        Protected Overrides Function GetUpdateCommand() As IDbCommand
            ...
            Dim cmd As OracleCommand = New OracleCommand
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = Me.SchemaStoredProcedure + "PU_OTROS_DEPARTAMENTOS"
        ...
        Protected Overrides Function GetDeleteCommand() As IDbCommand
            ...
            Dim cmd As OracleCommand = New OracleCommand
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = Me.SchemaStoredProcedure + "PD_OTROS_DEPARTAMENTOS"

            Dim p As OracleParameter
            p = cmd.Parameters.Add(Parameters.CODARE)
            p.SourceColumn = ColumnNames.CODARE
            ...
            p = cmd.Parameters.Add(Parameters.CODSEC)
            p.SourceColumn = ColumnNames.CODSEC
            p.SourceVersion = DataRowVersion.Current
        ...
        Private Sub CreateParameters(ByVal cmd As OracleCommand)
            ...
            p = cmd.Parameters.Add(Parameters.DESCSECCIO)
            p.SourceColumn = ColumnNames.DESCSECCIO
            p.SourceVersion = DataRowVersion.Current
            ...
            p = cmd.Parameters.Add(Parameters.DESCPROC)
            p.SourceColumn = ColumnNames.DESCPROC
            p.SourceVersion = DataRowVersion.Current
