...
Namespace DAL
    ...
    Public MustInherit Class _W_GCLINPED
        Inherits OracleClientEntity

        Public Sub New()
            Me.SchemaGlobal = "INCIDENCIAS."
            Me.QuerySource = "W_GCLINPED"
            Me.MappingName = "W_GCLINPED"
        End Sub
...
#Region "Parameters"
        Protected Class Parameters
            ...
            Public Shared ReadOnly Property NUMPEDLIN As OracleParameter
                Get
                    Return New OracleParameter("NUMPEDLIN", OracleDbType.Int32, 0)
                End Get
            End Property

            Public Shared ReadOnly Property NUMLINLIN As OracleParameter
                Get
                    Return New OracleParameter("NUMLINLIN", OracleDbType.Int32, 0)
                End Get
            End Property

            Public Shared ReadOnly Property CODPROLIN As OracleParameter
                Get
                    Return New OracleParameter("CODPROLIN", OracleDbType.Char, 12)
                End Get
            End Property
            ...
            Public Shared ReadOnly Property DESCART As OracleParameter
                Get
                    Return New OracleParameter("DESCART", OracleDbType.Char, 30)
                End Get
            End Property

            Public Shared ReadOnly Property DESCLISTA As OracleParameter
                Get
                    Return New OracleParameter("DESCLISTA", OracleDbType.Char, 20)
                End Get
            End Property

            Public Shared ReadOnly Property NUMORDF As OracleParameter
                Get
                    Return New OracleParameter("NUMORDF", OracleDbType.Int32, 0)
                End Get
            End Property
            ...
            Public Shared ReadOnly Property CANREC As OracleParameter
                Get
                    Return New OracleParameter("CANREC", OracleDbType.Int32, 0)
                End Get
            End Property

            Public Shared ReadOnly Property CANFAC As OracleParameter
                Get
                    Return New OracleParameter("CANFAC", OracleDbType.Int32, 0)
                End Get
            End Property

            Public Shared ReadOnly Property PREUNI As OracleParameter
                Get
                    Return New OracleParameter("PREUNI", OracleDbType.Int32, 0)
                End Get
            End Property

            Public Shared ReadOnly Property DESCTO As OracleParameter
                Get
                    Return New OracleParameter("DESCTO", OracleDbType.Int32, 0)
                End Get
            End Property

            Public Shared ReadOnly Property ALEACION As OracleParameter
                Get
                    Return New OracleParameter("ALEACION", OracleDbType.Int32, 0)
                End Get
            End Property

            Public Shared ReadOnly Property IMPPED As OracleParameter
                Get
                    Return New OracleParameter("IMPPED", OracleDbType.Int32, 0)
                End Get
            End Property

            Public Shared ReadOnly Property IMPREC As OracleParameter
                Get
                    Return New OracleParameter("IMPREC", OracleDbType.Int32, 0)
                End Get
            End Property

            Public Shared ReadOnly Property IMPFAC As OracleParameter
                Get
                    Return New OracleParameter("IMPFAC", OracleDbType.Int32, 0)
                End Get
            End Property

            Public Shared ReadOnly Property FECENTSOL As OracleParameter
                Get
                    Return New OracleParameter("FECENTSOL", OracleDbType.Date, 0)
                End Get
            End Property

            Public Shared ReadOnly Property FECENTVIG As OracleParameter
                Get
                    Return New OracleParameter("FECENTVIG", OracleDbType.Date, 0)
                End Get
            End Property

            Public Shared ReadOnly Property CODARPRO As OracleParameter
                Get
                    Return New OracleParameter("CODARPRO", OracleDbType.Char, 15)
                End Get
            End Property

            Public Shared ReadOnly Property NUMNECES As OracleParameter
                Get
                    Return New OracleParameter("NUMNECES", OracleDbType.Int32, 0)
                End Get
            End Property

            Public Shared ReadOnly Property PDTE_PREC As OracleParameter
                Get
                    Return New OracleParameter("PDTE_PREC", OracleDbType.Char, 1)
                End Get
            End Property
            ...
            Public Shared ReadOnly Property LANTEGI_H As OracleParameter
                Get
                    Return New OracleParameter("LANTEGI_H", OracleDbType.Int32, 0)
                End Get
            End Property

            Public Shared ReadOnly Property EPREUNI As OracleParameter
                Get
                    Return New OracleParameter("EPREUNI", OracleDbType.Int32, 0)
                End Get
            End Property

            Public Shared ReadOnly Property EDIMPRE As OracleParameter
                Get
                    Return New OracleParameter("EDIMPRE", OracleDbType.Int32, 0)
                End Get
            End Property

            Public Shared ReadOnly Property EALEACION As OracleParameter
                Get
                    Return New OracleParameter("EALEACION", OracleDbType.Int32, 0)
                End Get
            End Property

            Public Shared ReadOnly Property EIMPPED As OracleParameter
                Get
                    Return New OracleParameter("EIMPPED", OracleDbType.Int32, 0)
                End Get
            End Property

            Public Shared ReadOnly Property EIMPREC As OracleParameter
                Get
                    Return New OracleParameter("EIMPREC", OracleDbType.Int32, 0)
                End Get
            End Property

            Public Shared ReadOnly Property EIMPFAC As OracleParameter
                Get
                    Return New OracleParameter("EIMPFAC", OracleDbType.Int32, 0)
                End Get
            End Property

            Public Shared ReadOnly Property FECPDTEPRE As OracleParameter
                Get
                    Return New OracleParameter("FECPDTEPRE", OracleDbType.Date, 0)
                End Get
            End Property

            Public Shared ReadOnly Property FECCALIDAD As OracleParameter
                Get
                    Return New OracleParameter("FECCALIDAD", OracleDbType.Date, 0)
                End Get
            End Property

            Public Shared ReadOnly Property ID_ESTADO As OracleParameter
                Get
                    Return New OracleParameter("ID_ESTADO", OracleDbType.Int32, 0)
                End Get
            End Property
        ...
        Public Class ColumnNames
            ...
            Public Shared Function ToPropertyName(ByVal columnName As String) As String
                ...
                If ht Is Nothing Then
                    ...
                    ht(NUMPEDLIN) = _W_GCLINPED.PropertyNames.NUMPEDLIN
                    ht(NUMLINLIN) = _W_GCLINPED.PropertyNames.NUMLINLIN
                    ht(CODPROLIN) = _W_GCLINPED.PropertyNames.CODPROLIN
                    ht(CODART) = _W_GCLINPED.PropertyNames.CODART
                    ht(DESCART) = _W_GCLINPED.PropertyNames.DESCART
                    ht(DESCLISTA) = _W_GCLINPED.PropertyNames.DESCLISTA
                    ht(NUMORDF) = _W_GCLINPED.PropertyNames.NUMORDF
                    ht(NUMOPE) = _W_GCLINPED.PropertyNames.NUMOPE
                    ht(NUMMAR) = _W_GCLINPED.PropertyNames.NUMMAR
                    ht(CANPED) = _W_GCLINPED.PropertyNames.CANPED
                    ht(CANREC) = _W_GCLINPED.PropertyNames.CANREC
                    ht(CANFAC) = _W_GCLINPED.PropertyNames.CANFAC
                    ht(PREUNI) = _W_GCLINPED.PropertyNames.PREUNI
                    ht(DESCTO) = _W_GCLINPED.PropertyNames.DESCTO
                    ht(ALEACION) = _W_GCLINPED.PropertyNames.ALEACION
                    ht(IMPPED) = _W_GCLINPED.PropertyNames.IMPPED
                    ht(IMPREC) = _W_GCLINPED.PropertyNames.IMPREC
                    ht(IMPFAC) = _W_GCLINPED.PropertyNames.IMPFAC
                    ht(FECENTSOL) = _W_GCLINPED.PropertyNames.FECENTSOL
                    ht(FECENTVIG) = _W_GCLINPED.PropertyNames.FECENTVIG
                    ht(CODARPRO) = _W_GCLINPED.PropertyNames.CODARPRO
                    ht(NUMNECES) = _W_GCLINPED.PropertyNames.NUMNECES
                    ht(PDTE_PREC) = _W_GCLINPED.PropertyNames.PDTE_PREC
                    ht(LANTEGI) = _W_GCLINPED.PropertyNames.LANTEGI
                    ht(LANTEGI_H) = _W_GCLINPED.PropertyNames.LANTEGI_H
                    ht(EPREUNI) = _W_GCLINPED.PropertyNames.EPREUNI
                    ht(EDIMPRE) = _W_GCLINPED.PropertyNames.EDIMPRE
                    ht(EALEACION) = _W_GCLINPED.PropertyNames.EALEACION
                    ht(EIMPPED) = _W_GCLINPED.PropertyNames.EIMPPED
                    ht(EIMPREC) = _W_GCLINPED.PropertyNames.EIMPREC
                    ht(EIMPFAC) = _W_GCLINPED.PropertyNames.EIMPFAC
                    ht(FECPDTEPRE) = _W_GCLINPED.PropertyNames.FECPDTEPRE
                    ht(FECCALIDAD) = _W_GCLINPED.PropertyNames.FECCALIDAD
                    ht(ID_ESTADO) = _W_GCLINPED.PropertyNames.ID_ESTADO
        ...
        Public Class PropertyNames
            ...
            Public Shared Function ToColumnName(ByVal propertyName As String) As String
                ...
                If ht Is Nothing Then
                    ...
                    ht(NUMPEDLIN) = _W_GCLINPED.ColumnNames.NUMPEDLIN
                    ht(NUMLINLIN) = _W_GCLINPED.ColumnNames.NUMLINLIN
                    ht(CODPROLIN) = _W_GCLINPED.ColumnNames.CODPROLIN
                    ht(CODART) = _W_GCLINPED.ColumnNames.CODART
                    ht(DESCART) = _W_GCLINPED.ColumnNames.DESCART
                    ht(DESCLISTA) = _W_GCLINPED.ColumnNames.DESCLISTA
                    ht(NUMORDF) = _W_GCLINPED.ColumnNames.NUMORDF
                    ht(NUMOPE) = _W_GCLINPED.ColumnNames.NUMOPE
                    ht(NUMMAR) = _W_GCLINPED.ColumnNames.NUMMAR
                    ht(CANPED) = _W_GCLINPED.ColumnNames.CANPED
                    ht(CANREC) = _W_GCLINPED.ColumnNames.CANREC
                    ht(CANFAC) = _W_GCLINPED.ColumnNames.CANFAC
                    ht(PREUNI) = _W_GCLINPED.ColumnNames.PREUNI
                    ht(DESCTO) = _W_GCLINPED.ColumnNames.DESCTO
                    ht(ALEACION) = _W_GCLINPED.ColumnNames.ALEACION
                    ht(IMPPED) = _W_GCLINPED.ColumnNames.IMPPED
                    ht(IMPREC) = _W_GCLINPED.ColumnNames.IMPREC
                    ht(IMPFAC) = _W_GCLINPED.ColumnNames.IMPFAC
                    ht(FECENTSOL) = _W_GCLINPED.ColumnNames.FECENTSOL
                    ht(FECENTVIG) = _W_GCLINPED.ColumnNames.FECENTVIG
                    ht(CODARPRO) = _W_GCLINPED.ColumnNames.CODARPRO
                    ht(NUMNECES) = _W_GCLINPED.ColumnNames.NUMNECES
                    ht(PDTE_PREC) = _W_GCLINPED.ColumnNames.PDTE_PREC
                    ht(LANTEGI) = _W_GCLINPED.ColumnNames.LANTEGI
                    ht(LANTEGI_H) = _W_GCLINPED.ColumnNames.LANTEGI_H
                    ht(EPREUNI) = _W_GCLINPED.ColumnNames.EPREUNI
                    ht(EDIMPRE) = _W_GCLINPED.ColumnNames.EDIMPRE
                    ht(EALEACION) = _W_GCLINPED.ColumnNames.EALEACION
                    ht(EIMPPED) = _W_GCLINPED.ColumnNames.EIMPPED
                    ht(EIMPREC) = _W_GCLINPED.ColumnNames.EIMPREC
                    ht(EIMPFAC) = _W_GCLINPED.ColumnNames.EIMPFAC
                    ht(FECPDTEPRE) = _W_GCLINPED.ColumnNames.FECPDTEPRE
                    ht(FECCALIDAD) = _W_GCLINPED.ColumnNames.FECCALIDAD
                    ht(ID_ESTADO) = _W_GCLINPED.ColumnNames.ID_ESTADO
