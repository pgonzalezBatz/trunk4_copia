...
Namespace DAL
    ...
    Public Class TIPOREPETITIVA
        Inherits _TIPOREPETITIVA
        ...
        Public Sub New()
            ...
            End Try
        End Sub
        Public Function fgTiposRepetitivasContador(ByVal ID As Integer) As IDataReader
            ...
            Return MyBase.LoadFromSqlReader("GTK_S_TIPOSREP_CONTADOR", parameters, CommandType.StoredProcedure)
        End Function
        ''' <summary>
        ''' Contador de Registros que existen relacionados con alguna Incidencia.
        ''' </summary>
        ''' <param name="Id">Identificador de Tipo de Repetitiva.</param>
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function Contador(ByVal Id As Integer) As Integer
            ...
            Return CInt(MyBase.LoadFromSqlScalar("GTK_S_TIPREP_CONTADOR", parameters, CommandType.StoredProcedure))
            'Return CInt(MyBase.LoadFromSqlScalar("GTK_S_TIPOSREP_CONTADOR", parameters, CommandType.StoredProcedure))
        ...
        Public Function FiltrarPor(ByVal SQL As String) As IDataReader
            Try
                'Return MyBase.LoadFromSqlReader(Filtro.SelectFromWhere("TIPOREPETITIVA"), Nothing, CommandType.Text)
