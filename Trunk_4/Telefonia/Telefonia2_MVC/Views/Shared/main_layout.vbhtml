        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li><a href="@Url.Action("Index", "busqueda")" class="nav-link">@h.traducir("Personas")</a></li>
                   @If SimpleRoleProvider.IsUserAuthorised(role.redirecion) Then
                       @<li><a href = "//intranet2.batz.es/telefonia/default.aspx" Class="nav-link">@h.traducir("Administración")</a></li>
                   End If
                </ul>
