<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MPTelefonia.Master" CodeBehind="Otros.aspx.vb" Inherits="Telefonia.Otros" %>
                    ...
                    <td>
                        <fieldset>
                            <table>
                                <tr>
                                    <td colspan="2">
                                        <asp:Label runat="server" ID="lblTitPopPup"></asp:Label>  
                                    </td>
                                </tr>
