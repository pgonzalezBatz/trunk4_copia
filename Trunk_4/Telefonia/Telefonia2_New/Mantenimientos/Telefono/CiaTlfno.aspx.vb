...
#Region "Page Load"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not Page.IsPostBack Then
                Master.SetTitle = "Listado de compañias"
                cargarCompañias()
            End If
            ConfigurarEventos()
        ...
        Try
            ...
            If (btn.CommandName = "modificar") Then
                If (lbLista.SelectedIndex = -1) Then
                    Master.MensajeAdvertencia = "seleccioneCompañia"
                    Exit Sub
                Else
    ...
    Private Sub mostrarDetalle(ByVal idCia As Integer)
        Try
            ...
            If (idCia = Integer.MinValue) Then  'nuevo
                Master.SetTitle = "Nueva compañia"
...
#Region "Guardar Datos"
    ...
    Private Sub btnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        Try
            ...
            If (bSave) Then
                ciaComp.Save(oCia)
                Master.MensajeInfo = "compañiaGuardada"
                ...
                cargarCompañias()
            Else
                Master.MensajeAdvertencia = "noSePuedeBorrarEstaRelacionadoConTelefono"
            End If
        Catch batzEx As BatzException
            mpeCia.Show()
            WriteTitulo()
