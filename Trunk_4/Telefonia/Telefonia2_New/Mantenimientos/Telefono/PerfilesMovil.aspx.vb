...
#Region "Page Load"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not Page.IsPostBack Then
                Master.SetTitle = "Perfiles movil"
                cargarPerfiles()
            End If
            ConfigurarEventos()
        ...
        Try
            ...
            If (btn.CommandName = "modificar") Then
                If (lbLista.SelectedIndex = -1) Then
                    Master.MensajeAdvertencia = "porFavorSeleccioneUnElementoDeLaLista"
                    Exit Sub
                Else
...
#Region "Volver"
    ...
    ''' </summary>
    Private Sub volver()
        Master.SetTitle = "Perfiles moviles"
        mvPerfiles.ActiveViewIndex = 0
        cargarPerfiles()
    End Sub
