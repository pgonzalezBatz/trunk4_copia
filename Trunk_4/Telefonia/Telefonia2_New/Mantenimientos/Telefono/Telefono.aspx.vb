    ...
    Private Sub mostrarDetalle(ByVal idTlfno As Integer)
        Try
            ...
            If (idTlfno = Integer.MinValue) Then  'nuevo
                Master.SetTitle = "Nuevo telefono"
            ...
            Else
                ...
                If (bSave) Then
                    ...
                    If (bSave) Then
                        ...
                        End If
                        volver()
                        Master.MensajeInfo = "telefonoGuardado"
                    Else
                        Master.MensajeAdvertencia = smsSinGuardar
                    End If
                Else
                    Master.MensajeAdvertencia = "noSePuedeBorrarEstaRelacionadoConPersonaOExtension"
                End If
            End If
            WriteTitulo()
        Catch batzEx As BatzException
