...
Partial Public Class GrupoExtension
    ...
    Private Const NUEVO As String = "nuevoGrupoExtension"
    Private Const INFO As String = "infoGrupoExtension"
    ...
    Private Sub btnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        Try
            If (Page.IsValid) Then
                ...
                End If
                Master.MensajeInfoKey = "grupoGuardado"
                cargarGrupos()
            Else
                mpeGrupoExt.Show()
            End If
...
#Region "Eliminar"
    ...
    Private Sub btnEliminar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        Try
            ...
            Master.MensajeInfoKey = "grupoBorrado"
    ...
    Private Sub WriteTitulo()
        titPopPup.Texto = If(txtGrupo.Visible, NUEVO, INFO)
    End Sub
