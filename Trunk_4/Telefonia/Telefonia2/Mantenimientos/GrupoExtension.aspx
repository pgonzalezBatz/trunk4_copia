<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Mantenimientos/MPTelefoniaAdm.Master" CodeBehind="GrupoExtension.aspx.vb" Inherits="Telefonia.GrupoExtension" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cp" runat="server">
   ...
   <asp:UpdatePanel ID="UpdatePanel1" runat="server">
           <ContentTemplate>
                <tit:Titulo ID="Titulo1" runat="server" Texto="listadoGrupoExtensiones" />                                            
                 ...
                 <tr>
                    <td>
                        <fieldset>
                            <table>
                                <tr>
                                    <td colspan="2"><tit:Titulo runat="server" ID="titPopPup"></tit:Titulo></td>
                                </tr>
