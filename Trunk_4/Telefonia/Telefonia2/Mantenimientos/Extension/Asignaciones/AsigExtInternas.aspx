<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Mantenimientos/MPTelefoniaAdm.Master" CodeBehind="AsigExtInternas.aspx.vb" Inherits="Telefonia.AsigExtInternas"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cp" runat="server">    
    ...
    <script language="javascript">
       ...
       <asp:UpdatePanel runat="server">
           <ContentTemplate>
                <tit:Titulo runat="server" Texto="asignacionExtensionesInternas" />                                            
