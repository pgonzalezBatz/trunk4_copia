...
#Region "Constantes"
    ...
    Private Const NUEVA_EXTENSION As String = "nuevaExtension"
    Private Const INFO_EXTENSION As String = "infoExtension"
    Private Const LISTADO As String = "listadoExtensiones"
    ...
    Private Sub btnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        Try
            ...
            If (CType(ViewState("Obsoleta"), Boolean) And chkObsoleto.Checked) Then
                Master.MensajeAdvertenciaKey = "No se pueden realizar cambios estando la extension obsoleta. Marquela como no obsoleta para que los cambios se realicen"
                Exit Sub
            End If
            ...
            If (Not oExt.Obsoleto AndAlso CType(ViewState("Obsoleta"), Boolean) AndAlso oExt.IdAlveolo <> Integer.MinValue) Then
                ...
                If (lExt IsNot Nothing AndAlso lExt.Count > 0) Then
                    ...
                    Next
                    If (extension > 0) Then
                        Master.MensajeAdvertenciaKey = "No se puede marcar como activa porque el alveolo ya existe para la extension " & extension
                        Exit Sub
                    End If
                End If
            End If
            ...
            If (bSave) Then
                ...
                If (bSave) Then
                    ...
                    End If
                    volver()
                    Master.MensajeInfoKey = "extensionGuardada"
                Else
                    Master.MensajeAdvertenciaKey = "extensionExistente"
                End If
            Else
                Master.MensajeAdvertenciaKey = "noSePuedeBorrarPorEstarRelacionadoConTelefonosOPersonas"
            End If
            WriteTitulo()
        Catch batzEx As BatzException
            WriteTitulo()
...
#Region "Write Titulo"
    ...
    Private Sub WriteTitulo()
        If (lblNumero.Visible) Then
            titPopPup.Texto = INFO_EXTENSION
        Else
            titPopPup.Texto = NUEVA_EXTENSION
        End If
    End Sub
