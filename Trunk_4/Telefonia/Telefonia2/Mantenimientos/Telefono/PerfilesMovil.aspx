<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Mantenimientos/MPTelefoniaAdm.Master" CodeBehind="PerfilesMovil.aspx.vb" Inherits="Telefonia.PerfilesMovil" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cp" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <tit:Titulo ID="titulo" runat="server" Texto="Perfiles movil" />
            <asp:MultiView ID="mvPerfiles" runat="server" ActiveViewIndex="0">    
              <asp:View runat="server" ID="vListado">                               
                <asp:Panel ID="pnlBusqueda" runat="server" DefaultButton="btnVerDatos">
                     <table width="25%">
                        <tr>
                            <td width="10%">
                                 <asp:Label runat="server" ID="labelPerfil" Text="Perfil"></asp:Label>
                            </td>
                            <td nowrap>
            ...
            <asp:View runat="server" ID="vDetalle">                                                                   
                  <fieldset style="width:50%">
                   <table> 
                    <tr>
                        <td>
                             <asp:Label runat="server" ID="labelPerfil2" Text="Perfil"></asp:Label>    
                        </td>
                        <td>  
                            <asp:TextBox runat="server" ID="txtPerfil"></asp:TextBox>                                                                
                        </td>
                    </tr>
                    <tr>
                        <td>
                             <asp:Label runat="server" ID="labelTope" Text="Tope"></asp:Label>    
                        </td>
                        <td>
                            <asp:Textbox runat="server" ID="txtTope" MaxLength="10" Columns="10" onkeydown="return soloNumeros(event);"></asp:Textbox>
                        </td>
                    </tr>                   
