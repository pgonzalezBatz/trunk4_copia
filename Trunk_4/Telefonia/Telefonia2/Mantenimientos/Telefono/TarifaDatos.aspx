<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Mantenimientos/MPTelefoniaAdm.Master" CodeBehind="TarifaDatos.aspx.vb" Inherits="Telefonia.TarifaDatos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cp" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <tit:Titulo ID="titulo" runat="server" Texto="Tarifa datos" />
