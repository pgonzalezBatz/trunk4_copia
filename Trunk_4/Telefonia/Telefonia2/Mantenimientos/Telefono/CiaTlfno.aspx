<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Mantenimientos/MPTelefoniaAdm.Master" CodeBehind="CiaTlfno.aspx.vb" Inherits="Telefonia.CiaTlfno" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cp" runat="server">
    ...
    <script language="javascript">
       ...
       <asp:UpdatePanel runat="server">
           <ContentTemplate>
                <tit:Titulo runat="server" Texto="listadoCompañias" />                                            
