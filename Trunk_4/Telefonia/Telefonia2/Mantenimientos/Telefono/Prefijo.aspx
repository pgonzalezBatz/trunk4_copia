<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Mantenimientos/MPTelefoniaAdm.Master" CodeBehind="Prefijo.aspx.vb" Inherits="Telefonia.Prefijo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cp" runat="server">
   ...
   <tit:Titulo runat="server" Texto="Prefijo" /> 
