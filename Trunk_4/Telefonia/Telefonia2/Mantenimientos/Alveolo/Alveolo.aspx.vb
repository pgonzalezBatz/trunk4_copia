...
#Region "Constantes"
    ...
    Private Const LISTADO As String = "listadoAlveolos"
    Private Const NUEVO As String = "nuevoAlveolo"
    Private Const INFO As String = "infoAlveolo"
        ...
        Try
            ...
            If (btn.CommandName = "modificar") Then
                If (lbLista.SelectedIndex = -1) Then
                    Master.MensajeAdvertenciaKey = "seleccioneRuta"
                    Exit Sub
                Else
        ...
        Try
            ...
            Else
                ...
                If (oAlv.PosicionColumna < 1 Or oAlv.PosicionColumna > 10) Then
                    Master.MensajeAdvertenciaKey = "El valor de la columna tiene que estar entre 1 y 10"
                ElseIf (oAlv.PosicionFila < 1) Then
                    Master.MensajeAdvertenciaKey = "El valor de la fila tiene que ser mayor que 1"
                Else
                    ...
                    If (bSave) Then
                        ...
                        If (alvExist Is Nothing OrElse (alvExist IsNot Nothing AndAlso alvExist.Id = oAlv.Id)) Then 'Si no existe o existe uno pero es el mismo, se sigue
                            alvComp.Save(oAlv)
                            Master.MensajeInfoKey = "alveoloGuardado"
                        ...
                        End If
                    Else
                        Master.MensajeAdvertenciaKey = "alveoloNoBorrarAsociadoExtensiones"
                    End If
                End If
            End If
        Catch batzEx As BatzException
