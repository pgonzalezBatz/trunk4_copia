<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Mantenimientos/MPTelefoniaAdm.Master" CodeBehind="TipoAlveolo.aspx.vb" Inherits="Telefonia.TipoAlveolo"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cp" runat="server">    
    ...
    <script language="javascript">
       ...
       <asp:UpdatePanel runat="server">
           <ContentTemplate>
                <tit:Titulo runat="server" ID="titulo" Texto="listadoTiposAlveolos" />                                            
