<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Mantenimientos/MPTelefoniaAdm.Master" CodeBehind="Alveolo.aspx.vb" Inherits="Telefonia.Alveolo"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cp" runat="server">    
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <tit:Titulo ID="titulo" runat="server" Texto="listadoAlveolos" />
