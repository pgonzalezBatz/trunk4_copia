' NOTA: puede usar el comando "Cambiar nombre" del menú contextual para cambiar el nombre de clase "ServiceTelefonia" en el código, en svc y en el archivo de configuración a la vez.
' NOTA: para iniciar el Cliente de prueba WCF para probar este servicio, seleccione ServiceTelefonia.svc o ServiceTelefonia.svc.vb en el Explorador de soluciones e inicie la depuración.
Imports Telefonia
Imports TelefoniaLib

Public Class ServiceTelefonia
    Implements IServiceTelefonia
    ...
    Public Function getTelefonos(idUser As Integer) As List(Of Telephone) Implements IServiceTelefonia.getTelefonos
