...
Public MustInherit Class _EXTENSION_PERSONAS
	Inherits OracleClientEntity

		Public Sub New() 
			Me.SchemaGlobal = "TELEFONIA."
			Me.QuerySource = "EXTENSION_PERSONAS"
			Me.MappingName = "EXTENSION_PERSONAS"
		End Sub
	...
	Public Function LoadAll() As Boolean
    	...
    	Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PL_EXTENSION_PERSONAS", parameters)		
	End Function
	...
	'=================================================================
	Public Overridable Function LoadByPrimaryKey(ByVal F_DESDE As DateTime, ByVal ID_EXTENSION As Decimal, ByVal ID_TELEFONO As Decimal, ByVal ID_USUARIO As Decimal) As Boolean

		Dim parameters As ListDictionary = New ListDictionary()
		parameters.Add(_EXTENSION_PERSONAS.Parameters.F_DESDE, F_DESDE)

parameters.Add(_EXTENSION_PERSONAS.Parameters.ID_EXTENSION, ID_EXTENSION)

parameters.Add(_EXTENSION_PERSONAS.Parameters.ID_TELEFONO, ID_TELEFONO)

parameters.Add(_EXTENSION_PERSONAS.Parameters.ID_USUARIO, ID_USUARIO)
		...
		Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PK_EXTENSION_PERSONAS", parameters)
	...
	Public class ColumnNames
		...
		Shared Public Function ToPropertyName(ByVal columnName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(ID_EXTENSION) = _EXTENSION_PERSONAS.PropertyNames.ID_EXTENSION
				ht(F_DESDE) = _EXTENSION_PERSONAS.PropertyNames.F_DESDE
				ht(F_HASTA) = _EXTENSION_PERSONAS.PropertyNames.F_HASTA
				ht(ID_USUARIO) = _EXTENSION_PERSONAS.PropertyNames.ID_USUARIO
				ht(ID_TELEFONO) = _EXTENSION_PERSONAS.PropertyNames.ID_TELEFONO
	...
	Public class PropertyNames
		...
		Shared Public Function ToColumnName(ByVal propertyName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(ID_EXTENSION) = _EXTENSION_PERSONAS.ColumnNames.ID_EXTENSION
				ht(F_DESDE) = _EXTENSION_PERSONAS.ColumnNames.F_DESDE
				ht(F_HASTA) = _EXTENSION_PERSONAS.ColumnNames.F_HASTA
				ht(ID_USUARIO) = _EXTENSION_PERSONAS.ColumnNames.ID_USUARIO
				ht(ID_TELEFONO) = _EXTENSION_PERSONAS.ColumnNames.ID_TELEFONO
...
#End Region	
	...
	Protected Overrides Function GetInsertCommand() As IDbCommand
		...
		cmd.CommandText = Me.SchemaStoredProcedure + "PI_EXTENSION_PERSONAS" 
	...
	Protected Overrides Function GetUpdateCommand() As IDbCommand
		...
		Dim cmd As OracleCommand = New OracleCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = Me.SchemaStoredProcedure + "PU_EXTENSION_PERSONAS" 
	...
	Protected Overrides Function GetDeleteCommand() As IDbCommand
		...
		Dim cmd As OracleCommand = New OracleCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = Me.SchemaStoredProcedure + "PD_EXTENSION_PERSONAS" 
