...
Public MustInherit Class _TIPOLINEA_CULTURA
	Inherits OracleClientEntity

		Public Sub New() 
			Me.SchemaGlobal = "TELEFONIA."
			Me.QuerySource = "TIPOLINEA_CULTURA"
			Me.MappingName = "TIPOLINEA_CULTURA"
		End Sub
	...
	Public Function LoadAll() As Boolean
    	...
    	Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PL_TIPOLINEA_CULTURA", parameters)		
	End Function
	...
	'=================================================================
	Public Overridable Function LoadByPrimaryKey(ByVal ID_CULTURA As String, ByVal ID_TIPOLINEA As Decimal) As Boolean

		Dim parameters As ListDictionary = New ListDictionary()
		parameters.Add(_TIPOLINEA_CULTURA.Parameters.ID_CULTURA, ID_CULTURA)

parameters.Add(_TIPOLINEA_CULTURA.Parameters.ID_TIPOLINEA, ID_TIPOLINEA)
		...
		Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PK_TIPOLINEA_CULTURA", parameters)
	...
	Public class ColumnNames
		...
		Shared Public Function ToPropertyName(ByVal columnName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(ID_TIPOLINEA) = _TIPOLINEA_CULTURA.PropertyNames.ID_TIPOLINEA
				ht(ID_CULTURA) = _TIPOLINEA_CULTURA.PropertyNames.ID_CULTURA
				ht(NOMBRE) = _TIPOLINEA_CULTURA.PropertyNames.NOMBRE
				ht(DESCRIPCION) = _TIPOLINEA_CULTURA.PropertyNames.DESCRIPCION
	...
	Public class PropertyNames
		...
		Shared Public Function ToColumnName(ByVal propertyName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(ID_TIPOLINEA) = _TIPOLINEA_CULTURA.ColumnNames.ID_TIPOLINEA
				ht(ID_CULTURA) = _TIPOLINEA_CULTURA.ColumnNames.ID_CULTURA
				ht(NOMBRE) = _TIPOLINEA_CULTURA.ColumnNames.NOMBRE
				ht(DESCRIPCION) = _TIPOLINEA_CULTURA.ColumnNames.DESCRIPCION
...
#End Region	
	...
	Protected Overrides Function GetInsertCommand() As IDbCommand
		...
		cmd.CommandText = Me.SchemaStoredProcedure + "PI_TIPOLINEA_CULTURA" 
	...
	Protected Overrides Function GetUpdateCommand() As IDbCommand
		...
		Dim cmd As OracleCommand = New OracleCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = Me.SchemaStoredProcedure + "PU_TIPOLINEA_CULTURA" 
	...
	Protected Overrides Function GetDeleteCommand() As IDbCommand
		...
		Dim cmd As OracleCommand = New OracleCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = Me.SchemaStoredProcedure + "PD_TIPOLINEA_CULTURA" 
