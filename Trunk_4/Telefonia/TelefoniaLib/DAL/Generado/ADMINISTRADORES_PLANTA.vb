...
Public MustInherit Class _ADMINISTRADORES_PLANTA
	Inherits OracleClientEntity

		Public Sub New() 
			Me.SchemaGlobal = "TELEFONIA."
			Me.QuerySource = "ADMINISTRADORES_PLANTA"
			Me.MappingName = "ADMINISTRADORES_PLANTA"
		End Sub
	...
	Public Function LoadAll() As Boolean
    	...
    	Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PL_ADMINISTRADORES_PLANTA", parameters)		
	End Function
	...
	Public Overridable Function LoadByPrimaryKey(ByVal ID_PLANTA As Decimal, ByVal ID_USUARIO As Decimal) As Boolean
		...
		parameters.Add(_ADMINISTRADORES_PLANTA.Parameters.ID_PLANTA, ID_PLANTA)

parameters.Add(_ADMINISTRADORES_PLANTA.Parameters.ID_USUARIO, ID_USUARIO)
		...
		Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PK_ADMINISTRADORES_PLANTA", parameters)
	...
	Public class ColumnNames
		...
		Shared Public Function ToPropertyName(ByVal columnName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(ID_USUARIO) = _ADMINISTRADORES_PLANTA.PropertyNames.ID_USUARIO
				ht(ID_PLANTA) = _ADMINISTRADORES_PLANTA.PropertyNames.ID_PLANTA
	...
	Public class PropertyNames
		...
		Shared Public Function ToColumnName(ByVal propertyName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(ID_USUARIO) = _ADMINISTRADORES_PLANTA.ColumnNames.ID_USUARIO
				ht(ID_PLANTA) = _ADMINISTRADORES_PLANTA.ColumnNames.ID_PLANTA
...
#End Region	
	...
	Protected Overrides Function GetInsertCommand() As IDbCommand
		...
		cmd.CommandText = Me.SchemaStoredProcedure + "PI_ADMINISTRADORES_PLANTA" 
	...
	Protected Overrides Function GetUpdateCommand() As IDbCommand
		...
		Dim cmd As OracleCommand = New OracleCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = Me.SchemaStoredProcedure + "PU_ADMINISTRADORES_PLANTA" 
	...
	Protected Overrides Function GetDeleteCommand() As IDbCommand
		...
		Dim cmd As OracleCommand = New OracleCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = Me.SchemaStoredProcedure + "PD_ADMINISTRADORES_PLANTA" 
