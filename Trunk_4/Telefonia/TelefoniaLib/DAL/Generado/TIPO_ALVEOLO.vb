...
Public MustInherit Class _TIPO_ALVEOLO
	Inherits OracleClientEntity

		Public Sub New() 
			Me.SchemaGlobal = "TELEFONIA."
			Me.QuerySource = "TIPO_ALVEOLO"
			Me.MappingName = "TIPO_ALVEOLO"
		End Sub
	...
	Public Function LoadAll() As Boolean
    	...
    	Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PL_TIPO_ALVEOLO", parameters)		
	End Function
	...
	Public Overridable Function LoadByPrimaryKey(ByVal ID As Decimal) As Boolean
		...
		parameters.Add(_TIPO_ALVEOLO.Parameters.ID, ID)
		...
		Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PK_TIPO_ALVEOLO", parameters)
	...
	Public class ColumnNames
		...
		Shared Public Function ToPropertyName(ByVal columnName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(ID) = _TIPO_ALVEOLO.PropertyNames.ID
				ht(OBSOLETO) = _TIPO_ALVEOLO.PropertyNames.OBSOLETO
	...
	Public class PropertyNames
		...
		Shared Public Function ToColumnName(ByVal propertyName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(ID) = _TIPO_ALVEOLO.ColumnNames.ID
				ht(OBSOLETO) = _TIPO_ALVEOLO.ColumnNames.OBSOLETO
...
#End Region	
	...
	Protected Overrides Function GetInsertCommand() As IDbCommand
		...
		cmd.CommandText = Me.SchemaStoredProcedure + "PI_TIPO_ALVEOLO" 
	...
	Protected Overrides Function GetUpdateCommand() As IDbCommand
		...
		Dim cmd As OracleCommand = New OracleCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = Me.SchemaStoredProcedure + "PU_TIPO_ALVEOLO" 
	...
	Protected Overrides Function GetDeleteCommand() As IDbCommand
		...
		Dim cmd As OracleCommand = New OracleCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = Me.SchemaStoredProcedure + "PD_TIPO_ALVEOLO" 
