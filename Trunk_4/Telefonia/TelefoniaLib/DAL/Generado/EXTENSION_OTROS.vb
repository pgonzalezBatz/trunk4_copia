...
Public MustInherit Class _EXTENSION_OTROS
	Inherits OracleClientEntity

		Public Sub New() 
			Me.SchemaGlobal = "TELEFONIA."
			Me.QuerySource = "EXTENSION_OTROS"
			Me.MappingName = "EXTENSION_OTROS"
		End Sub
	...
	Public Function LoadAll() As Boolean
    	...
    	Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PL_EXTENSION_OTROS", parameters)		
	End Function
	...
	'=================================================================
	Public Overridable Function LoadByPrimaryKey(ByVal F_DESDE As DateTime, ByVal ID_EXTENSION As Decimal, ByVal ID_OTRO As Decimal, ByVal ID_TELEFONO As Decimal) As Boolean

		Dim parameters As ListDictionary = New ListDictionary()
		parameters.Add(_EXTENSION_OTROS.Parameters.F_DESDE, F_DESDE)

parameters.Add(_EXTENSION_OTROS.Parameters.ID_EXTENSION, ID_EXTENSION)

parameters.Add(_EXTENSION_OTROS.Parameters.ID_OTRO, ID_OTRO)

parameters.Add(_EXTENSION_OTROS.Parameters.ID_TELEFONO, ID_TELEFONO)
		...
		Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "PK_EXTENSION_OTROS", parameters)
	...
	Protected class Parameters 
		...
		Public Shared ReadOnly Property ID_OTRO As OracleParameter
			Get
				Return New OracleParameter("p_ID_OTRO", OracleDbType.Int32, 0)
			End Get
		End Property
	...
	Public class ColumnNames
        ...
        Public Const ID_OTRO As String = "ID_OTRO"
		...
		Shared Public Function ToPropertyName(ByVal columnName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(ID_EXTENSION) = _EXTENSION_OTROS.PropertyNames.ID_EXTENSION
				ht(ID_OTRO) = _EXTENSION_OTROS.PropertyNames.ID_OTRO
				ht(F_DESDE) = _EXTENSION_OTROS.PropertyNames.F_DESDE
				ht(F_HASTA) = _EXTENSION_OTROS.PropertyNames.F_HASTA
				ht(ID_TELEFONO) = _EXTENSION_OTROS.PropertyNames.ID_TELEFONO
	...
	Public class PropertyNames
		...
		Shared Public Function ToColumnName(ByVal propertyName As String) As String
			...
			If ht Is Nothing Then
				...
				ht(ID_EXTENSION) = _EXTENSION_OTROS.ColumnNames.ID_EXTENSION
				ht(ID_OTRO) = _EXTENSION_OTROS.ColumnNames.ID_OTRO
				ht(F_DESDE) = _EXTENSION_OTROS.ColumnNames.F_DESDE
				ht(F_HASTA) = _EXTENSION_OTROS.ColumnNames.F_HASTA
				ht(ID_TELEFONO) = _EXTENSION_OTROS.ColumnNames.ID_TELEFONO
	...
	Public class StringPropertyNames
        ...
        Public Const ID_OTRO As String = "s_ID_OTRO"
	...
	#Region "Properties" 
		...
		Public Overridable Property ID_OTRO As Decimal
			Get
				Return MyBase.GetDecimal(ColumnNames.ID_OTRO)
			End Get
			Set(ByVal Value As Decimal)
				MyBase.SetDecimal(ColumnNames.ID_OTRO, Value)
			End Set
		End Property
	...
	#Region "String Properties" 
		...
		Public Overridable Property s_ID_OTRO As String
			Get
				If Me.IsColumnNull(ColumnNames.ID_OTRO) Then
					Return String.Empty
				Else
					Return MyBase.GetDecimalAsString(ColumnNames.ID_OTRO)
				End If
			End Get
			Set(ByVal Value As String)
				If String.Empty = value Then
					Me.SetColumnNull(ColumnNames.ID_OTRO)
				Else
					Me.ID_OTRO = MyBase.SetDecimalAsString(ColumnNames.ID_OTRO, Value)
				End If
			End Set
		End Property
    ...
    Public Class WhereClause
		...
		Public class TearOffWhereParameter
			...
			Public ReadOnly Property ID_OTRO() As WhereParameter
				Get
					Dim where As WhereParameter = New WhereParameter(ColumnNames.ID_OTRO, Parameters.ID_OTRO)
					Me._clause._entity.Query.AddWhereParemeter(where)
					Return where
				End Get
			End Property
		...
		Public ReadOnly Property ID_OTRO() As WhereParameter 
			Get
				If _ID_OTRO_W Is Nothing Then
					_ID_OTRO_W = TearOff.ID_OTRO
				End If
				Return _ID_OTRO_W
			End Get
		End Property
		...
		Private _ID_OTRO_W As WhereParameter = Nothing
...
#Region "Aggregate Clause"
    Public Class AggregateClause
		...
		Public ReadOnly Property ID_OTRO() As AggregateParameter
			Get
				Dim where As AggregateParameter = New AggregateParameter(ColumnNames.ID_OTRO, Parameters.ID_OTRO)
				Me._clause._entity.Query.AddAggregateParameter(where)
				Return where
			End Get
		End Property
		...
		Private _ID_OTRO_W As AggregateParameter = Nothing
...
#End Region	
	...
	Protected Overrides Function GetInsertCommand() As IDbCommand
		...
		cmd.CommandText = Me.SchemaStoredProcedure + "PI_EXTENSION_OTROS" 
	...
	Protected Overrides Function GetUpdateCommand() As IDbCommand
		...
		Dim cmd As OracleCommand = New OracleCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = Me.SchemaStoredProcedure + "PU_EXTENSION_OTROS" 
	...
	Protected Overrides Function GetDeleteCommand() As IDbCommand
		...
		Dim cmd As OracleCommand = New OracleCommand
		cmd.CommandType = CommandType.StoredProcedure    
		cmd.CommandText = Me.SchemaStoredProcedure + "PD_EXTENSION_OTROS" 
		...
		p = cmd.Parameters.Add(Parameters.ID_OTRO)
		p.SourceColumn = ColumnNames.ID_OTRO
		p.SourceVersion = DataRowVersion.Current
