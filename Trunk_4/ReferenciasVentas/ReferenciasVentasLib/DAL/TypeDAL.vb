...
#Region "Consultas"
        ...
        Public Function loadList() As List(Of ELL.Type)
            ...
            New ELL.Type With {.Id = CInt(r("ID")), .Nombre = SabLib.BLL.Utils.stringNull(r("NOMBRE")), .Descripcion = SabLib.BLL.Utils.stringNull(r("DESCRIPCION")), .Obsoleto = SabLib.BLL.Utils.booleanNull(r("OBSOLETO"))}, query, CadenaConexionReferenciasVenta)
        End Function
        ...
        Public Function CargarTiposProducto(ByVal idProducto As Integer) As List(Of ELL.Type)
            ...
            Return Memcached.OracleDirectAccess.seleccionar(Of ELL.Type)(Function(r As OracleDataReader) _
            New ELL.Type With {.Id = CInt(r("ID")), .Nombre = SabLib.BLL.Utils.stringNull(r("NOMBRE")), .Descripcion = SabLib.BLL.Utils.stringNull(r("DESCRIPCION")), .Obsoleto = SabLib.BLL.Utils.booleanNull(r("OBSOLETO"))}, query, CadenaConexionReferenciasVenta, parameter)
        End Function
        ...
        Public Function CargarTipo(ByVal id As Integer) As ELL.Type
            ...
            Return Memcached.OracleDirectAccess.seleccionar(Of ELL.Type)(Function(r As OracleDataReader) _
            New ELL.Type With {.Id = CInt(r("ID")), .Nombre = SabLib.BLL.Utils.stringNull(r("NOMBRE")), .Descripcion = SabLib.BLL.Utils.stringNull(r("DESCRIPCION")), .Obsoleto = SabLib.BLL.Utils.booleanNull(r("OBSOLETO"))}, query, CadenaConexionReferenciasVenta, parameter).FirstOrDefault
        End Function
