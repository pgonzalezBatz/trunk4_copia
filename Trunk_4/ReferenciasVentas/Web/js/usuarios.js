...
function BusquedaUsuarios(text, hidden, div, urlBuscar, bDoPostback, controlPostback, divImage, culture) {
            ...
            $(this).data('timer', setTimeout(function () {
                if (texto.length > 3) {
                    if (e.keyCode == 40 || e.keyCode == 38) {  //flecha abajo, flecha arriba                    
                        ...
                        $.getJSON(UsuarioBuscar + texto, function (json) {
                            ...
                            if (json.length == 0) {
                                if (cultura == "es-ES") {
                                    divUsuarios.append('<h4>No se pudo encontrar ningun usuario</h4>');
                                }
                                else if (cultura == "eu-ES") {
                                    divUsuarios.append('<h4>Ez da erabiltzailerik aurkitu</h4>');
                                }
                                else {
                                    divUsuarios.append('<h4>No users found</h4>');
                                }
                            }
                            else {
                                var index = 0;
...
//function initBusquedaUsuarios(text, hidden, div, urlBuscar, bDoPostback, controlPostback, divImage, culture) {
...
//                                    if (index == 0)
//                                        style = "style=\"background-color: #ffff66\"";                                    
//                                    divUsuarios.append("<a " + style + " id=" + val.id + " href=\"javascript:addUser(" + val.id + ",'" + val.nombre + "'," + bDoPostback + ",'" + controlPostback + "','" + text + "','" + hidden + "','" + div + "','" + divImage + "','" + aceptar + "');\">" + val.nombre.toUpperCase() + "</a><br>");
//                                }
//                                index += 1;
//                            });
//                        };
