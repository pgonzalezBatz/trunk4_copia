<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="SelectorProyectoBrain.ascx.vb" Inherits="ReferenciasVentas.SelectorProyectoBrain" %>
...
<table class="table2" style="width:100%; border-width:0px">
    <tr>
        <td style="width:90%">
            ...
            <act:AutoCompleteExtender ID="aceCustProjectName" ServiceMethod="CargarProyectosBrain"
                runat="server" MinimumPrefixLength="2" Enabled="True" FirstRowSelected="true"
                CompletionInterval="100" EnableCaching="false" OnClientItemSelected="ProyectoBrainElegido"
        ...
        <tr>
            <td>
                <asp:UpdatePanel ID="pnlProyecto" runat="server" EnableViewState="true" UpdateMode="Always">
                    <ContentTemplate>
                        <fieldset>                                    
							<asp:GridView ID="gv_Proyectos" runat="server"  AllowSorting="True" AutoGenerateColumns="False" Caption="PROJECTS"
                                CellPadding="4" CssClass="GridViewASP" DataKeyNames="ELTO, DENO_S" EmptyDataText="No projects found" GridLines="None" >
                                ...
                                <Columns>
                                    <asp:BoundField DataField="ELTO" HeaderText="CODE" Visible="false" ReadOnly="True" SortExpression="ID" />
                                    <asp:BoundField DataField="DENO_S" HeaderText="NAME" SortExpression="NOMBRE" />
                                </Columns>
                            </asp:GridView>
                        </fieldset>                            
                    </ContentTemplate>
