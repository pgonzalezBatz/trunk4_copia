...
Partial Public Class SelectorProyectoBrain
...
#Region "Eventos de Pagina"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'aceCustProjectName.OnClientItemSelected = "comprobarReferencia_" & Me.ID
...
#Region "GridView Articulos"
    ...
    Private Sub gv_Proyectos_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gv_Proyectos.RowDataBound
        Try
            'e.Row.Attributes("OnClick") = Page.ClientScript.GetPostBackClientHyperlink(Me.gv_Proyectos, "Select$" + e.Row.RowIndex.ToString)
            e.Row.Attributes.Add("onclick", String.Format("ProyectoElegidoCliente('{0}', '{1}')", e.Row.Cells(1).Text, gv_Proyectos.DataKeys(e.Row.RowIndex).Values(0).ToString())) 'e.row.rowindex
    ...
    Sub CargarGridView()
        ...
        listaProyectos = oBrainBLL.CargarProyectosBrain()
...
#Region "Orden"
    ...
    '''' <remarks></remarks>
    Private Sub Ordenar(ByRef listaProyectosBrain As List(Of ELL.BrainBase), ByVal sortExpr As String, ByVal sortDir As SortDirection)
...
#Region "Botones"
        ...
        Try
            ...
            Else  ' Se ha lanzado este evento, al perder el foco del cuadro de texto de la referencia
                ...
                If (txtCustProjectName.Text <> String.Empty) Then
                    ...
                    pro = oBrainBLL.CargarProyectoBrain(Proyecto.ToLower)
    ...
    '''' <summary>
    '''' Buscar proyecto en lugar de escribirlo
    '''' </summary>
    '''' <param name="sender"></param>
    '''' <param name="e"></param>
    '''' <remarks></remarks>
