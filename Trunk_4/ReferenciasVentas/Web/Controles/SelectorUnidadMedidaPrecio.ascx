<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="SelectorUnidadMedidaPrecio.ascx.vb" Inherits="ReferenciasVentas.SelectorUnidadMedidaPrecio" %>
        ...
        <table class="table2" style="width:100%; border-width:0px">
            <tr>
                ...
                <td style="text-align:center; width:10%">
                    <asp:ImageButton ID="btnBuscar" runat="server" AlternateText="Find" ImageUrl="~/App_Themes/Batz/IconosAcciones/Buscador/Filtrar24.png" ToolTip="Find price" />
                </td>
            </tr>
        </table>
