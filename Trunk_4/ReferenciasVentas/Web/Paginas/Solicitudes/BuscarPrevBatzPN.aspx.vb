...
Public Class BuscarPrevBatzPN
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim referencia As String = Request.QueryString("ref")
        'Dim plantas As String = Request.QueryString("pl")

        'Dim prevBatzPN As ELL.MaestroPiezasBrainResumen = BLL.BusquedaJsonBLL.CargarPrevBatzPN(referencia, plantas)
        Dim prevBatzPN As ELL.MaestroPiezasBrainResumen = BLL.BusquedaJsonBLL.CargarPrevBatzPN(referencia)
