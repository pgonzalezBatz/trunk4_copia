...
Public Class BuscarTiposProducto
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim types As List(Of ELL.Type) = BLL.BusquedaJsonBLL.CargarTiposProducto(idProducto)
        Dim resultado As String = JsonSerializer(types)
