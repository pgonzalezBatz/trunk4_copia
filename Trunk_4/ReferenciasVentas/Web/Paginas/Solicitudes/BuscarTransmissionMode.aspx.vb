...
Public Class BuscarTransmissionMode
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim tm As List(Of ELL.TransmissionMode) = BLL.BusquedaJsonBLL.CargarTransmissionMode()
        Dim resultado As String = JsonSerializer(tm)
