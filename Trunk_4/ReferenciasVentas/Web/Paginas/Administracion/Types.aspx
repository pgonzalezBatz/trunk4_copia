<%@ Page Language="vb" CodeBehind="Types.aspx.vb"  Inherits="ReferenciasVentas.Types" MasterPageFile="~/RefSis.Master"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cuerpoPrincipal" runat="server">
    ...
    <Titulo:Titulo ID="titMantenimientoType" Texto="Types maintenance" runat="server" />
    
    <asp:UpdatePanel ID="upType" runat="server">
        <ContentTemplate>
            <asp:GridView ID="gvType" runat="Server" AutoGenerateColumns="False" CssClass="GridViewASP"         
                GridLines="None" Width="80%" OnRowCommand="gvType_OnRowCommand" DataKeyNames="Id" ShowFooter="true"
                ...
                <EmptyDataTemplate>                                        
                    ...
                    <asp:Label ID="lblDescripcion" runat="server" Text="Description" />&nbsp
