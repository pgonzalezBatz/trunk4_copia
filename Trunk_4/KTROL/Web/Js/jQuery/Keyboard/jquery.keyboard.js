...
; (function ($) {
    ...
    $.keyboard.defaultOptions = {
        ...
        //},
        display: {
            'a': 'Aceptar:Aceptar (Shift-Intro)', //\u2714 check mark - same action as accept
            'accept': 'Aceptar:Aceptar (Shift-Intro)',
            'alt': 'Alt:\u2325 AltGr',        // other alternatives \u2311 
            'b': '\u232b:Borrar',    // Left arrow (same as &larr;)
            'bksp': '<-:Borrar',
            'c': 'Salir:Cancel (Esc)', // \u2716 big X, close - same action as cancel
            'cancel': 'Salir:Cancelar (Esc)',
            'clear': 'C:Clear',             // clear num pad
            'combo': '\u00f6:Toggle Combo Keys',
            'dec': '.:Decimal',           // decimal point for num pad (optional), change '.' to ',' for European format
            'e': '\u23ce:Enter',        // down, then left arrow - enter symbol
        ...
        wheelMessage: 'Usa el ratón para ver el resto de claves',
