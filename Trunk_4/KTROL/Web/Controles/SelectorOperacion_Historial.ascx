<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="SelectorOperacion_Historial.ascx.vb" Inherits="WebRaiz.SelectorOperacion_Historial" %>
			...
			<tbody>
				<tr>
					<td>
						...
						<asp:TextBox ID="txtOperacion" runat="server" Columns="30" MaxLength="25" Font-Size="18px"></asp:TextBox>
						<act:AutoCompleteExtender ID="ace_txtOperacion" runat="server" Enabled="True" ServicePath="~/Servicio/ServiciosWeb.asmx" ServiceMethod="BuscarOperaciones" TargetControlID="txtOperacion" UseContextKey="True" MinimumPrefixLength="1" CompletionInterval="100" EnableCaching="true" CompletionSetCount="0" CompletionListCssClass="CompletionListCssClass" CompletionListItemCssClass="CompletionListItemCssClass" CompletionListHighlightedItemCssClass="CompletionListHighlightedItemCssClass" FirstRowSelected="true" ></act:AutoCompleteExtender>
					</td>
					<td style="vertical-align:middle" >
						<asp:ImageButton ID="btnBuscar" runat="server" ImageUrl="~/App_Themes/Tema1/IconosAcciones/PanelExtensible/Contraer.png" ToolTip="Buscar" AlternateText="Buscar" />
					</td>
				</tr>
			</tbody>
			<tfoot>
