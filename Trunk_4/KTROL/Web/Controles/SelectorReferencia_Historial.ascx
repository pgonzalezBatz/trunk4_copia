<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="SelectorReferencia_Historial.ascx.vb" Inherits="WebRaiz.SelectorReferencia_Historial" %>
            ...
            <tbody>
                <tr>
                    <td>                        
                        ...
                        <AjaxControl:AutoCompleteExtender ID="ace_txtReferencia" runat="server" CompletionInterval="100" CompletionListCssClass="CompletionListCssClass" CompletionListHighlightedItemCssClass="CompletionListHighlightedItemCssClass" CompletionListItemCssClass="CompletionListItemCssClass" CompletionSetCount="0" EnableCaching="true" Enabled="True" FirstRowSelected="true" MinimumPrefixLength="1" ServiceMethod="BuscarReferencias" ServicePath="~/Servicio/ServiciosWeb.asmx" TargetControlID="txtReferencia" UseContextKey="True">
