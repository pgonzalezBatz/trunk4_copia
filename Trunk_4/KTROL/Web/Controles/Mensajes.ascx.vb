...
#Region "Funciones y Procesos"
    Public Sub MensajeError(ex As Exception)
		imgVentana.ImageUrl = "~/App_Themes/Tema1/IconosAjaxControl/VentanaMensajes/warning-icon24.png"
		imgVentana.ToolTip = "Error critico"
		Mensaje(ex.Message)
	End Sub
	Public Sub MensajeError(ex As ApplicationException)
		imgVentana.ImageUrl = "~/App_Themes/Tema1/IconosAjaxControl/VentanaMensajes/info-icon24.png"
