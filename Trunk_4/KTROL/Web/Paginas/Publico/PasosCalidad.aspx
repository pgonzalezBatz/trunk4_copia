<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PasosCalidad.aspx.vb" Inherits="WebRaiz.PasosCalidad" %>
...
<head runat="server">
    ...
    <%--<script type="text/javascript" src="/js/jQuery/jquery.numeric-1.4.1.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function funcKeyPress() {
            ...
            { event.returnValue = false; this.value = this.value + ','; }
        }
    ...
    <form id="form1" runat="server">
        <asp:ScriptManager ID="actScriptManager" runat="server">
            <Scripts>
                ...
                <asp:ScriptReference Path="~/js/jQuery/jquery.numeric-1.4.1.js" />
            </Scripts>
        </asp:ScriptManager>
        <asp:Wizard ID="wizard_Ktrol" CellPadding="0" CellSpacing="0" BorderStyle="Solid" BorderWidth="0px" runat="server" Width="100%" DisplaySideBar="false">
            <HeaderTemplate>
            ...
            <StartNavigationTemplate>
                <!--<div class="NavigationTemplate" style=" margin-left: 93%;">-->
                <div>
