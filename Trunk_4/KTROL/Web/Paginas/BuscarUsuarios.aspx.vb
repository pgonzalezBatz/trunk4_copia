Public Class BuscarUsuarios
    ...
    ''' <summary>
    ''' Busca los proveedores que coincidan con el texto escrito en su parte del nombre
    ''' </summary>
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        For Each usuario As Sablib.ELL.Usuario In usuarios
            If Not (usuario.DadoBaja) Then
                resultado &= "{""id"":""" & usuario.Id & """,""nombre"":""" & usuario.NombreCompleto & """}," ' & """,""c"":""" & usuario.CodPersona & """,""d"":""" & usuario.FechaAlta.ToShortDateString 
            End If
        Next
        resultado &= "]"
